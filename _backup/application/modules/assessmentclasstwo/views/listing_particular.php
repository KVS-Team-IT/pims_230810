            ...
            "columns": [ 
                ...
                {"data": "parent_email_id"},     
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        '<a href="<?php echo site_url('assessmentclasstwo/middle/'); ?>'+ row.id + '" data-toggle="tooltip" title="Details" class="btn btn-primary btn-xs"><i class="fa fa-edit" aria-hidden="true"></i> Update</a>'+                           
                      '</div>';
                    }
                },
                {
