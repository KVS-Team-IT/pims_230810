            ...
            <div class="card-body" style="padding: 0px!important;" id="Personal_PDF">              	
                ...
                <div class="table-responsive">  
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	...
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryData->oral_eng1A); ?></td>
					    		<td><?php echo number_format($EntryData->oral_eng1B); ?></td>
					    		<td><?php echo number_format($EntryData->oral_eng1C); ?></td>
					    		<td><?php echo number_format($EntryData->oral_eng1D); ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalOral->oral_converseA); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseB); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseC); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalOral->oral_talksA); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksB); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksC); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalOral->oral_recitesA); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_recitesB); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_recitesC); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_recitesD); ?></td> 
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of READING ABILITIES (ENGLISH).</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryData->read_eng1A); ?></td>
					    		<td><?php echo number_format($EntryData->read_eng1B); ?></td>
					    		<td><?php echo number_format($EntryData->read_eng1C); ?></td>
					    		<td><?php echo number_format($EntryData->read_eng1D); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalReading->read_partA); ?></td>
					    		<td><?php echo number_format($FinalReading->read_partB); ?></td>
					    		<td><?php echo number_format($FinalReading->read_partC); ?></td>
					    		<td><?php echo number_format($FinalReading->read_partD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalReading->read_usesA); ?></td>
					    		<td><?php echo number_format($FinalReading->read_usesB); ?></td>
					    		<td><?php echo number_format($FinalReading->read_usesC); ?></td>
					    		<td><?php echo number_format($FinalReading->read_usesD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalReading->read_tenceA); ?></td>
					    		<td><?php echo number_format($FinalReading->read_tenceB); ?></td>
					    		<td><?php echo number_format($FinalReading->read_tenceC); ?></td>
					    		<td><?php echo number_format($FinalReading->read_tenceD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WRITING ABILITIES (ENGLISH).</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryData->write_eng1A); ?></td>
					    		<td><?php echo number_format($EntryData->write_eng1B); ?></td>
					    		<td><?php echo number_format($EntryData->write_eng1C); ?></td>
					    		<td><?php echo number_format($EntryData->write_eng1D); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalWriting->write_wordA); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_wordB); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_wordC); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_wordD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalWriting->write_conveyA); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_conveyB); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_conveyC); ?></td>
					    		<td><?php echo number_format($FinalWriting->write_conveyD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of NUMERACY ABILITIES.</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryData->numeric1A); ?></td>
					    		<td><?php echo number_format($EntryData->numeric1B); ?></td>
					    		<td><?php echo number_format($EntryData->numeric1C); ?></td>
					    		<td><?php echo number_format($EntryData->numeric1D); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_countA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_countB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_countC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_countD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_readA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_readB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_readC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_readD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_addA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_addB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_addC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_addD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_obsrA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_obsrB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_obsrC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_obsrD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_unitA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_unitB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_unitC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_unitD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNumeracy->num_reciteA); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_reciteB); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_reciteC); ?></td>
					    		<td><?php echo number_format($FinalNumeracy->num_reciteD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of ORAL ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryHindi->oral_hindiA); ?></td>
					    		<td><?php echo number_format($EntryHindi->oral_hindiB); ?></td>
					    		<td><?php echo number_format($EntryHindi->oral_hindiC); ?></td>
					    		<td><?php echo number_format($EntryHindi->oral_hindiD); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->oral_frndhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_frndhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_frndhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_frndhD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->oral_conveyhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_conveyhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_conveyhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_conveyhs); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->oral_storyhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_storyhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_storyhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->oral_storyhD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of READING ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryHindi->read_hindiA); ?></td>
					    		<td><?php echo number_format($EntryHindi->read_hindiB); ?></td>
					    		<td><?php echo number_format($EntryHindi->read_hindiC); ?></td>
					    		<td><?php echo number_format($EntryHindi->read_hindiD); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->read_storyhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_storyhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_storyhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_storyhD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->read_soundhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_soundhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_soundhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_soundhD); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->read_wordhA); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_wordhB); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_wordhC); ?></td>
					    		<td><?php echo number_format($FinalHindi->read_wordhD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WRITING ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryHindi->write_hindiA); ?></td>
					    		<td><?php echo number_format($EntryHindi->write_hindiB); ?></td>
					    		<td><?php echo number_format($EntryHindi->write_hindiC); ?></td>
					    		<td><?php echo number_format($EntryHindi->write_hindiD); ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->writing_hindihA); ?></td>
					    		<td><?php echo number_format($FinalHindi->writing_hindihB); ?></td>
					    		<td><?php echo number_format($FinalHindi->writing_hindihC); ?></td>
					    		<td><?php echo number_format($FinalHindi->writing_hindihD); ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo number_format($FinalHindi->hindi_drawinghA); ?></td>
					    		<td><?php echo number_format($FinalHindi->hindi_drawinghB); ?></td>
					    		<td><?php echo number_format($FinalHindi->hindi_drawinghC); ?></td>
					    		<td><?php echo number_format($FinalHindi->hindi_drawinghD); ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WITH Pre Schooling.</th>
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataPre->oral_PreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->oral_PreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->oral_PreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->oral_PreD) ; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_converseA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_converseB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_converseC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_converseD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo number_format($FinalPreSchl->oralpre_talksA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_talksB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_talksC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_talksD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_recitesA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_recitesB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_recitesC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->oralpre_recitesD) ; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataPre->read_PreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->read_PreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->read_PreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->read_PreD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_partA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_partB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_partC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_partD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo number_format($FinalPreSchl->readpre_usesA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_usesB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_usesC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_usesD) ; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalPreSchl->readpre_tenceA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_tenceB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_tenceC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->readpre_tenceD) ; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataPre->write_PreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->write_PreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->write_PreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->write_PreD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_wordA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_wordB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_wordC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_wordD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_conveyA) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_conveyB) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_conveyC) ; ?></td>
					    		<td><?php echo number_format($FinalPreSchl->writepre_conveyD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataPre->numeric_preA) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->numeric_preB) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->numeric_preC) ; ?></td>
					    		<td><?php echo number_format($EntryDataPre->numeric_preD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_countA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_countB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_countC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_countD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_readA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_readB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_readC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_readD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_addA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_addB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_addC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_addD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_obsrA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_obsrB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_obsrC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_obsrD) ; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalPreNumSchl->pre_unitA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_unitB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_unitC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_unitD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_reciteA) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_reciteB) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_reciteC) ; ?></td>
					    		<td><?php echo number_format($FinalPreNumSchl->pre_reciteD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryPreHindi->oral_hindipreA) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->oral_hindipreB) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->oral_hindipreC) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->oral_hindipreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_preA) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_preB) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_preC) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_preD) ; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_conveypre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_conveypre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_conveypre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_conveypre_s) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_storypre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_storypre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_storypre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->oral_storypre_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryPreHindi->read_hindipreA) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->read_hindipreB) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->read_hindipreC) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->read_hindipreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_storypre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_storypre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_storypre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_storypre_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_soundpre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_soundpre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_soundpre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_soundpre_D) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_wordpre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_wordpre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_wordpre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->read_wordpre_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryPreHindi->write_hindipreA) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->write_hindipreB) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->write_hindipreC) ; ?></td>
					    		<td><?php echo number_format($EntryPreHindi->write_hindipreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo number_format($FinalPreHindiSchl->writing_hindipre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->writing_hindipre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->writing_hindipre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->writing_hindipre_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo number_format($FinalPreHindiSchl->hindi_drawingpre_A) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->hindi_drawingpre_B) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->hindi_drawingpre_C) ; ?></td>
					    		<td><?php echo number_format($FinalPreHindiSchl->hindi_drawingpre_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoPre->oral_NoPreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->oral_NoPreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->oral_NoPreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->oral_NoPreD) ; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_converseA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_converseB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_converseC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_converseD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo number_format($FinalNonSchl->oralnon_talksA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_talksB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_talksC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_talksD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_recitesA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_recitesB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_recitesC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->oralnon_recitesD) ; ?></td> 
...
<td> <?php  echo number_format(($oralor_A+$oralor_B+$oralor_C)/3,2)-number_format(($EntryDataNoPre->oral_NoPreA  + $EntryDataNoPre->oral_NoPreB*2+ $EntryDataNoPre->oral_NoPreC*3 + $EntryDataNoPre->oral_NoPreD*4)/$EntryDataNoPre->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoPre->read_NoPreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->read_NoPreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->read_NoPreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->read_NoPreD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_partA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_partB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_partC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_partD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo number_format($FinalNonSchl->read_usesA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->read_usesB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->read_usesC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->read_usesD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_tenceA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_tenceB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_tenceC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->readnon_tenceD) ; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoPre->write_NoPreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->write_NoPreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->write_NoPreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->write_NoPreD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_wordA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_wordB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_wordC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_wordD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_conveyA) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_conveyB) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_conveyC) ; ?></td>
					    		<td><?php echo number_format($FinalNonSchl->writenon_conveyD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoPre->numeric_NoPreA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->numeric_NoPreB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->numeric_NoPreC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoPre->numeric_NoPreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo number_format($FinalNonNumSchl->noncountA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->noncountB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->noncountC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->noncountD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreadA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreadB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreadC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreadD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonaddA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonaddB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonaddC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonaddD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonobsrA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonobsrB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonobsrC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonobsrD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(v). Estimates and verifies length using non-standard non-uniform units like hand span, footstep, fingers, etc and capacity using nonstandard uniform units like cup, spoon, mug etc.</td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonunitA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonunitB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonunitC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonunitD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreciteA) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreciteB) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreciteC) ; ?></td>
					    		<td><?php echo number_format($FinalNonNumSchl->nonreciteD) ; ?></td>
...
<td> <?php  echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2)-number_format(($EntryDataNoPre->numeric_NoPreA  + $EntryDataNoPre->numeric_NoPreB*2+ $EntryDataNoPre->numeric_NoPreC*3 + $EntryDataNoPre->numeric_NoPreD*4)/$EntryDataNoPre->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoPreHindi->oral_hindinopreA) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->oral_hindinopreB) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->oral_hindinopreC) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->oral_hindinopreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_nonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_nonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_nonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_nonD) ; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_conveynonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_conveynonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_conveynonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_conveynons) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_storynonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_storynonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_storynonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->oral_storynonD) ; ?></td>
	...
	<td> <?php  echo number_format(($oral_non1+$oral_conveynon2+$oral_storynon3)/3,2)-number_format(($EntryNoPreHindi->oral_hindinopreA  + $EntryNoPreHindi->oral_hindinopreB*2+ $EntryNoPreHindi->oral_hindinopreC*3 + $EntryNoPreHindi->oral_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoPreHindi->read_hindinopreA) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->read_hindinopreB) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->read_hindinopreC) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->read_hindinopreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_storynonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_storynonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_storynonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_storynonD) ; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_soundnonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_soundnonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_soundnonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_soundnonD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_wordnonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_wordnonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_wordnonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->read_wordnonD) ; ?></td>
...
<td> <?php  echo number_format(($read_storynon1+$read_soundnon2+$read_wordnon3)/3,2)-number_format(($EntryNoPreHindi->read_hindinopreA  + $EntryNoPreHindi->read_hindinopreB*2+ $EntryNoPreHindi->read_hindinopreC*3 + $EntryNoPreHindi->read_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoPreHindi->write_hindinopreA) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->write_hindinopreB) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->write_hindinopreC) ; ?></td>
					    		<td><?php echo number_format($EntryNoPreHindi->write_hindinopreD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo number_format($FinalNonHindiSchl->writing_hindinonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->writing_hindinonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->writing_hindinonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->writing_hindinonD) ; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo number_format($FinalNonHindiSchl->hindi_drawingnonA) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->hindi_drawingnonB) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->hindi_drawingnonC) ; ?></td>
					    		<td><?php echo number_format($FinalNonHindiSchl->hindi_drawingnonD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataEdu->oral_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->oral_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->oral_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->oral_EduD) ; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_converseA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_converseB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_converseC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_converseD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo number_format($FinalParentSchl->oralparent_talksA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_talksB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_talksC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_talksD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_recitesA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_recitesB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_recitesC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->oralparent_recitesD) ; ?></td> 
...
<td> <?php  echo number_format(($oralorp_A+$oralorp_B+$oralorp_C)/3,2)- number_format(($EntryDataEdu->oral_EduA  + $EntryDataEdu->oral_EduB*2+ $EntryDataEdu->oral_EduC*3 + $EntryDataEdu->oral_EduD*4)/$EntryDataEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataEdu->read_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->read_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->read_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->read_EduD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_partA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_partB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_partC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_partD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo number_format($FinalParentSchl->readparent_usesA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_usesB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_usesC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_usesD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_tenceA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_tenceB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_tenceC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->readparent_tenceD) ; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataEdu->write_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->write_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->write_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->write_EduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_wordA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_wordB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_wordC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_wordD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_conveyA) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_conveyB) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_conveyC) ; ?></td>
					    		<td><?php echo number_format($FinalParentSchl->writeparent_conveyD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataEdu->numeric_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->numeric_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->numeric_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataEdu->numeric_EduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_countA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_countB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_countC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_countD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_readA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_readB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_readC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_readD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_addA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_addB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_addC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_addD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_obsrA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_obsrB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_obsrC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_obsrD) ; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalParentNumSchl->parent_unitA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_unitB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_unitC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_unitD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_reciteA) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_reciteB) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_reciteC) ; ?></td>
					    		<td><?php echo number_format($FinalParentNumSchl->parent_reciteD) ; ?></td>
...
<td> <?php  echo number_format(($parent_count1+$parent_read1+$parent_add3+$parent_obsr4+$parent_unit5+$parent_recite6)/6,2)-number_format(($EntryDataEdu->numeric_EduA  + $EntryDataEdu->numeric_EduB*2+ $EntryDataEdu->numeric_EduC*3 + $EntryDataEdu->numeric_EduD*4)/$EntryDataEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryEduHindi->oral_hindi_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->oral_hindi_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->oral_hindi_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->oral_hindi_EduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_parent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_parent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_parent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_parent_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_conveyparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_conveyparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_conveyparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_conveyparent_s) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_storyparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_storyparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_storyparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->oral_storyparent_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryEduHindi->read_hindi_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->read_hindi_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->read_hindi_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->read_hindi_EduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_storyparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_storyparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_storyparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_storyparent_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_soundparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_soundparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_soundparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_soundparent_D) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_wordparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_wordparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_wordparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->read_wordparent_D) ; ?></td>
...
<td> <?php  echo number_format(($read_storyparent_1+$read_soundparent_2+$read_wordparent_3)/3,2)-number_format(($EntryEduHindi->read_hindi_EduA  + $EntryEduHindi->read_hindi_EduB*2+ $EntryEduHindi->read_hindi_EduC*3 + $EntryEduHindi->read_hindi_EduD*4)/$EntryEduHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryEduHindi->write_hindi_EduA) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->write_hindi_EduB) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->write_hindi_EduC) ; ?></td>
					    		<td><?php echo number_format($EntryEduHindi->write_hindi_EduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo number_format($FinalParentHindiSchl->writing_hindiparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->writing_hindiparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->writing_hindiparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->writing_hindiparent_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo number_format($FinalParentHindiSchl->hindi_drawingparent_A) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->hindi_drawingparent_B) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->hindi_drawingparent_C) ; ?></td>
					    		<td><?php echo number_format($FinalParentHindiSchl->hindi_drawingparent_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoEdu->oral_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->oral_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->oral_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->oral_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_converseA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_converseB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_converseC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_converseD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_talksA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_talksB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_talksC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_talksD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_recitesA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_recitesB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_recitesC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->oralnonedu_recitesD) ; ?></td> 
...
<td> <?php  echo number_format(($oralnonedu_converse1+$oralnonedu_talks2+$oralnonedu_recites3)/3,2)-number_format(($EntryDataNoEdu->oral_NoEduA  + $EntryDataNoEdu->oral_NoEduB*2+ $EntryDataNoEdu->oral_NoEduC*3 + $EntryDataNoEdu->oral_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoEdu->read_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->read_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->read_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->read_NoEduD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_partA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_partB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_partC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_partD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_usesA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_usesB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_usesC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_usesD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_tenceA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_tenceB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_tenceC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->readnonedu_tenceD) ; ?></td> 
...
<td> <?php  echo number_format(($readnonedu_part1+$readnonedu_uses2+$readnonedu_tence3)/3,2)- number_format(($EntryDataNoEdu->read_NoEduA  + $EntryDataNoEdu->read_NoEduB*2+ $EntryDataNoEdu->read_NoEduC*3 + $EntryDataNoEdu->read_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoEdu->write_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->write_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->write_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->write_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_wordA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_wordB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_wordC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_wordD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_conveyA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_conveyB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_conveyC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduSchl->writenonedu_conveyD) ; ?></td>
...
<td> <?php  echo number_format(($writenonedu_word1+$writenonedu_convey2)/2,2)- number_format(($EntryDataNoEdu->write_NoEduA  + $EntryDataNoEdu->write_NoEduB*2+ $EntryDataNoEdu->write_NoEduC*3 + $EntryDataNoEdu->write_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDataNoEdu->numeric_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->numeric_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->numeric_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryDataNoEdu->numeric_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_countA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_countB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_countC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_countD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_readA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_readB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_readC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_readD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_addA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_addB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_addC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_addD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_obsrA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_obsrB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_obsrC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_obsrD) ; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_unitA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_unitB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_unitC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_unitD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_reciteA) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_reciteB) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_reciteC) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduNumSchl->nonedu_reciteD) ; ?></td>
...
<td> <?php  echo number_format(($nonedu_count1+$nonedu_read1+$nonedu_add3+$nonedu_obsr4+$nonedu_unit5+$nonedu_recite6)/6,2)-  number_format(($EntryDataNoEdu->numeric_NoEduA  + $EntryDataNoEdu->numeric_NoEduB*2+ $EntryDataNoEdu->numeric_NoEduC*3 + $EntryDataNoEdu->numeric_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoEduHindi->oral_hindi_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->oral_hindi_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->oral_hindi_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->oral_hindi_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_nonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_nonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_nonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_nonedu_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_conveynonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_conveynonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_conveynonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_conveynonedu_s) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_storynonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_storynonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_storynonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->oral_storynonedu_D) ; ?></td>
...
<td> <?php  echo number_format(($oral_nonedu_1+$oral_conveynonedu_2+$oral_storynonedu_3)/3,2)- number_format(($EntryNoEduHindi->oral_hindi_NoEduA  + $EntryNoEduHindi->oral_hindi_NoEduB*2+ $EntryNoEduHindi->oral_hindi_NoEduC*3 + $EntryNoEduHindi->oral_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoEduHindi->read_hindi_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->read_hindi_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->read_hindi_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->read_hindi_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_storynonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_storynonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_storynonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_storynonedu_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_soundnonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_soundnonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_soundnonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_soundnonedu_D) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_wordnonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_wordnonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_wordnonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->read_wordnonedu_D) ; ?></td>
...
<td> <?php  echo number_format(($read_storynonedu_1+$read_soundnonedu_2+$read_wordnonedu_3)/3,2)- number_format(($EntryNoEduHindi->read_hindi_NoEduA  + $EntryNoEduHindi->read_hindi_NoEduB*2+ $EntryNoEduHindi->read_hindi_NoEduC*3 + $EntryNoEduHindi->read_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryNoEduHindi->write_hindi_NoEduA) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->write_hindi_NoEduB) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->write_hindi_NoEduC) ; ?></td>
					    		<td><?php echo number_format($EntryNoEduHindi->write_hindi_NoEduD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->writing_hindinonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->writing_hindinonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->writing_hindinonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->writing_hindinonedu_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->hindi_drawingnonedu_A) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->hindi_drawingnonedu_B) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->hindi_drawingnonedu_C) ; ?></td>
					    		<td><?php echo number_format($FinalNonEduHindiSchl->hindi_drawingnonedu_D) ; ?></td>
...
<tr>
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisData->oral_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->oral_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->oral_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->oral_DisD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_converseA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_converseB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_converseC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_converseD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_talksA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_talksB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_talksC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_talksD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_recitesA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_recitesB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_recitesC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->oraldisable_recitesD) ; ?></td> 
...
<td> <?php  echo number_format(($oraldisable_converse1+$oraldisable_talks2+$oraldisable_recites3)/3,2)- number_format(($EntryDisData->oral_DisA  + $EntryDisData->oral_DisB*2+ $EntryDisData->oral_DisC*3 + $EntryDisData->oral_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisData->read_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->read_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->read_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->read_DisD) ; ?></td>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_partA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_partB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_partC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_partD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo number_format($FinalDisSchl->readdisable_usesA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_usesB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_usesC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_usesD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_tenceA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_tenceB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_tenceC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->readdisable_tenceD) ; ?></td> 
...
<td> <?php  echo number_format(($readdisable_part1+$readdisable_uses2+$readdisable_tence3)/3,2)-number_format(($EntryDisData->read_DisA  + $EntryDisData->read_DisB*2+ $EntryDisData->read_DisC*3 + $EntryDisData->read_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisData->write_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->write_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->write_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->write_DisD) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_wordA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_wordB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_wordC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_wordD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_conveyA) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_conveyB) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_conveyC) ; ?></td>
					    		<td><?php echo number_format($FinalDisSchl->writedisable_conveyD) ; ?></td>
...
<td> <?php  echo number_format(($writedisable_word1+$writedisable_convey2)/2,2)-number_format(($EntryDisData->write_DisA  + $EntryDisData->write_DisB*2+ $EntryDisData->write_DisC*3 + $EntryDisData->write_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	 <tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisData->numeric_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->numeric_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->numeric_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisData->numeric_DisD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_countA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_countB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_countC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_countD) ; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_readA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_readB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_readC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_readD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_addA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_addB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_addC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_addD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_obsrA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_obsrB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_obsrC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_obsrD) ; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalDisNumSchl->disable_unitA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_unitB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_unitC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_unitD) ; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_reciteA) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_reciteB) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_reciteC) ; ?></td>
					    		<td><?php echo number_format($FinalDisNumSchl->disable_reciteD) ; ?></td>
...
<td> <?php  echo number_format(($disable_count1+$disable_read1+$disable_add3+$disable_obsr4+$disable_unit5+$disable_recite6)/6,2)-number_format(($EntryDisData->numeric_DisA  + $EntryDisData->numeric_DisB*2+ $EntryDisData->numeric_DisC*3 + $EntryDisData->numeric_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisHindi->oral_hindi_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->oral_hindi_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->oral_hindi_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->oral_hindi_DisD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_disable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_disable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_disable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_disable_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_conveydisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_conveydisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_conveydisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_conveydisable_s) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_storydisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_storydisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_storydisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->oral_storydisable_D) ; ?></td>
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisHindi->read_hindi_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->read_hindi_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->read_hindi_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->read_hindi_DisD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_storydisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_storydisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_storydisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_storydisable_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_sounddisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_sounddisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_sounddisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_sounddisable_D) ; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_worddisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_worddisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_worddisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->read_worddisable_D) ; ?></td>
...
<td> <?php  echo number_format(($read_storydisable_1+$read_sounddisable_2+$read_worddisable_3)/3,2)-number_format(($EntryDisHindi->read_hindi_DisA  + $EntryDisHindi->read_hindi_DisB*2+ $EntryDisHindi->read_hindi_DisC*3 + $EntryDisHindi->read_hindi_DisD*4)/$EntryDisHindi->Total,2); 
					...
					<table class="table">
						...
						<tbody>\
					    	...
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryDisHindi->write_hindi_DisA) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->write_hindi_DisB) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->write_hindi_DisC) ; ?></td>
					    		<td><?php echo number_format($EntryDisHindi->write_hindi_DisD) ; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo number_format($FinalDisHindiSchl->writing_hindidisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->writing_hindidisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->writing_hindidisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->writing_hindidisable_D) ; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo number_format($FinalDisHindiSchl->hindi_drawingdisable_A) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->hindi_drawingdisable_B) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->hindi_drawingdisable_C) ; ?></td>
					    		<td><?php echo number_format($FinalDisHindiSchl->hindi_drawingdisable_D) ; ?></td>
