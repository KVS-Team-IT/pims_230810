	...
	?>
            ...
            <?php  }  ?>
                <div class="form-group col-md-2">
                    <label class="col-sm-12 col-form-label text-white">&nbsp;<span class="reqd"></span></label>
                    <div class="col-sm-12">
                        <!--button type="button"  id="ReportGen" class="btn btn-primary btn-block float-right"><i class="fa fa-filter"></i>&nbsp; Generate Report</button-->
...
<script>
   ...
   function LockedST(RO_ID){ 
	 ...
	 $(document).ready(function () { 
        ...
        var oTable = $('#dataTableIdCon').dataTable({
            ...
            "columns": [
                ...
                {"data": "is_mid_updated"},    
				{"data": "is_yearend_updated"},  
                {
                    "orderable": false,
                    "render": function (data, type, row) {
                        return '<div class="col-md-4 p-0"></div><div class="col-md-4 p-0">'+
                           
				'<a href="<?php echo site_url(); ?>assessment/details/' + row.id + '" data-toggle="tooltip" title="Details"><i class="fa fa-eye" aria-hidden="true"></i></a><a href="javascripts:void(0)" data-toggle="tooltip" title="Delete" class="delete_data" category_id="'+row.id+'"><i class="fa fa-trash" aria-hidden="true"></i></a>'+
    ...
    $('#ReportGen').on('click', function (e) {
            ...
            if(R_ID!='') {  
                window.location="<?php echo base_url('assessment/generate_report'); ?>/"+R_ID;
            }  
           else {  
            alert("Please Select Region First.");
                return false;       
		...
		$('#FinReportGen').on('click', function (e) {
            ...
            var KVID = $("#KvList").val();  
            if(R_ID!='') {  
                window.location="<?php echo base_url('assessment/final_report'); ?>/"+R_ID+"/"+KVID;
            }  
           else {  
            alert("Please Select Region First.");
                return false;       
		...
		$('#FinReportGenBoy').on('click', function (e) {
            ...
            var KVID = $("#KvList").val();  
            if(R_ID!='') {  
                window.location="<?php echo base_url('assessment/assessmentboy/final_report'); ?>/"+R_ID+"/"+KVID;
            }  
           else {  
            alert("Please Select Region First.");
                return false;       
		...
		$('#FinReportGenGirl').on('click', function (e) {
            ...
            var KVID = $("#KvList").val();  
            if(R_ID!='') {  
                window.location="<?php echo base_url('assessment/assessmentgirl/final_report'); ?>/"+R_ID+"/"+KVID;
            }  
           else {  
            alert("Please Select Region First.");
                return false;       
