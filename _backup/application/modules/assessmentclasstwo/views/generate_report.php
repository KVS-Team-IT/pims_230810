                ...
                <div class="table-responsive">  
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). </td>
					    		<td><?php echo number_format($EntryData->oral_eng1A*100/$FinalOral->Total); ?> %</td>
					    		<td><?php echo number_format($EntryData->oral_eng1B*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($EntryData->oral_eng1C*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($EntryData->oral_eng1D*100/$FinalOral->Total); ?></td>
								<td id="entry_oral_1"> <?php  echo number_format(($EntryData->oral_eng1A  + $EntryData->oral_eng1B*2+ $EntryData->oral_eng1C*3 + $EntryData->oral_eng1D*4)/$FinalOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalOral->oral_converseA*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseB*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseC*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_converseD*100/$FinalOral->Total); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo number_format($FinalOral->oral_talksA*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksB*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksC*100/$FinalOral->Total); ?></td>
					    		<td><?php echo number_format($FinalOral->oral_talksD*100/$FinalOral->Total); ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalOral->oral_recitesA; ?></td>
					    		<td><?php echo $FinalOral->oral_recitesB; ?></td>
					    		<td><?php echo $FinalOral->oral_recitesC; ?></td>
					    		<td><?php echo $FinalOral->oral_recitesD; ?></td> 
					    	...
					    	<td><?php echo number_format(($FinalOral->oral_converseD+$FinalOral->oral_talksD+ $FinalOral->oral_recitesD)/3,2); ?></td>
								<td id="exit_oral_1"> <?php  $oral_A= number_format(($FinalOral->oral_converseA  + $FinalOral->oral_converseB*2+ $FinalOral->oral_converseC*3 + $FinalOral->oral_converseD*4)/$FinalOral->Total,2); 
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of READING ABILITIES (ENGLISH).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td id="entry_2"> <?php  echo number_format(($EntryData->read_eng1A  + $EntryData->read_eng1B*2+ $EntryData->read_eng1C*3 + $EntryData->read_eng1D*4)/$FinalOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalReading->read_partA; ?></td>
					    		<td><?php echo $FinalReading->read_partB; ?></td>
					    		<td><?php echo $FinalReading->read_partC; ?></td>
					    		<td><?php echo $FinalReading->read_partD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalReading->read_usesA; ?></td>
					    		<td><?php echo $FinalReading->read_usesB; ?></td>
					    		<td><?php echo $FinalReading->read_usesC; ?></td>
					    		<td><?php echo $FinalReading->read_usesD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalReading->read_tenceA; ?></td>
					    		<td><?php echo $FinalReading->read_tenceB; ?></td>
					    		<td><?php echo $FinalReading->read_tenceC; ?></td>
					    		<td><?php echo $FinalReading->read_tenceD; ?></td>
					    	...
					    	<td><?php echo number_format(($FinalReading->read_partD+$FinalReading->read_usesD+ $FinalReading->read_tenceD)/3,2); ?></td>
								<td id="exit_2"> <?php  $FinalR_A= number_format(($FinalReading->read_partA  + $FinalReading->read_partB*2+ $FinalReading->read_partC*3 + $FinalReading->read_partD*4)/$FinalReading->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalWriting->write_wordA; ?></td>
					    		<td><?php echo $FinalWriting->write_wordB; ?></td>
					    		<td><?php echo $FinalWriting->write_wordC; ?></td>
					    		<td><?php echo $FinalWriting->write_wordD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalWriting->write_conveyA; ?></td>
					    		<td><?php echo $FinalWriting->write_conveyB; ?></td>
					    		<td><?php echo $FinalWriting->write_conveyC; ?></td>
					    		<td><?php echo $FinalWriting->write_conveyD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_countA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_countB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_countC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_countD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_readA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_readB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_readC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_readD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_addA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_addB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_addC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_addD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_obsrA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_obsrB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_obsrC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_obsrD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_unitA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_unitB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_unitC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_unitD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalNumeracy->num_reciteA; ?></td>
					    		<td><?php echo $FinalNumeracy->num_reciteB; ?></td>
					    		<td><?php echo $FinalNumeracy->num_reciteC; ?></td>
					    		<td><?php echo $FinalNumeracy->num_reciteD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalHindi->oral_frndhA; ?></td>
					    		<td><?php echo $FinalHindi->oral_frndhB; ?></td>
					    		<td><?php echo $FinalHindi->oral_frndhC; ?></td>
					    		<td><?php echo $FinalHindi->oral_frndhD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalHindi->oral_conveyhA; ?></td>
					    		<td><?php echo $FinalHindi->oral_conveyhB; ?></td>
					    		<td><?php echo $FinalHindi->oral_conveyhC; ?></td>
					    		<td><?php echo $FinalHindi->oral_conveyhs; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalHindi->oral_storyhA; ?></td>
					    		<td><?php echo $FinalHindi->oral_storyhB; ?></td>
					    		<td><?php echo $FinalHindi->oral_storyhC; ?></td>
					    		<td><?php echo $FinalHindi->oral_storyhD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalHindi->read_storyhA; ?></td>
					    		<td><?php echo $FinalHindi->read_storyhB; ?></td>
					    		<td><?php echo $FinalHindi->read_storyhC; ?></td>
					    		<td><?php echo $FinalHindi->read_storyhD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalHindi->read_soundhA; ?></td>
					    		<td><?php echo $FinalHindi->read_soundhB; ?></td>
					    		<td><?php echo $FinalHindi->read_soundhC; ?></td>
					    		<td><?php echo $FinalHindi->read_soundhD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalHindi->read_wordhA; ?></td>
					    		<td><?php echo $FinalHindi->read_wordhB; ?></td>
					    		<td><?php echo $FinalHindi->read_wordhC; ?></td>
					    		<td><?php echo $FinalHindi->read_wordhD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		...
					    		<td><?php echo $FinalHindi->writing_hindihA; ?></td>
					    		<td><?php echo $FinalHindi->writing_hindihB; ?></td>
					    		<td><?php echo $FinalHindi->writing_hindihC; ?></td>
					    		<td><?php echo $FinalHindi->writing_hindihD; ?></td>
							...
							<tr>
					    		...
					    		<td><?php echo $FinalHindi->hindi_drawinghA; ?></td>
					    		<td><?php echo $FinalHindi->hindi_drawinghB; ?></td>
					    		<td><?php echo $FinalHindi->hindi_drawinghC; ?></td>
					    		<td><?php echo $FinalHindi->hindi_drawinghD; ?></td>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WITH Pre Schooling.</th>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo $FinalPreSchl->oralpre_converseA; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_converseB; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_converseC; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_converseD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo $FinalPreSchl->oralpre_talksA; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_talksB; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_talksC; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_talksD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo $FinalPreSchl->oralpre_recitesA; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_recitesB; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_recitesC; ?></td>
					    		<td><?php echo $FinalPreSchl->oralpre_recitesD; ?></td> 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo $FinalPreSchl->readpre_partA; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_partB; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_partC; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_partD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo $FinalPreSchl->readpre_usesA; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_usesB; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_usesC; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_usesD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalPreSchl->readpre_tenceA; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_tenceB; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_tenceC; ?></td>
					    		<td><?php echo $FinalPreSchl->readpre_tenceD; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo $FinalPreSchl->writepre_wordA; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_wordB; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_wordC; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_wordD; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo $FinalPreSchl->writepre_conveyA; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_conveyB; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_conveyC; ?></td>
					    		<td><?php echo $FinalPreSchl->writepre_conveyD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo $FinalPreNumSchl->pre_countA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_countB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_countC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_countD; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo $FinalPreNumSchl->pre_readA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_readB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_readC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_readD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo $FinalPreNumSchl->pre_addA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_addB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_addC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_addD; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo $FinalPreNumSchl->pre_obsrA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_obsrB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_obsrC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_obsrD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalPreNumSchl->pre_unitA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_unitB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_unitC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_unitD; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo $FinalPreNumSchl->pre_reciteA; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_reciteB; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_reciteC; ?></td>
					    		<td><?php echo $FinalPreNumSchl->pre_reciteD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo $FinalPreHindiSchl->oral_preA; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_preB; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_preC; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_preD; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo $FinalPreHindiSchl->oral_conveypre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_conveypre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_conveypre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_conveypre_s; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo $FinalPreHindiSchl->oral_storypre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_storypre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_storypre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->oral_storypre_D; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo $FinalPreHindiSchl->read_storypre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_storypre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_storypre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_storypre_D; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo $FinalPreHindiSchl->read_soundpre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_soundpre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_soundpre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_soundpre_D; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo $FinalPreHindiSchl->read_wordpre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_wordpre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_wordpre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->read_wordpre_D; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo $FinalPreHindiSchl->writing_hindipre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->writing_hindipre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->writing_hindipre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->writing_hindipre_D; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo $FinalPreHindiSchl->hindi_drawingpre_A; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->hindi_drawingpre_B; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->hindi_drawingpre_C; ?></td>
					    		<td><?php echo $FinalPreHindiSchl->hindi_drawingpre_D; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo $FinalNonSchl->oralnon_converseA; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_converseB; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_converseC; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_converseD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo $FinalNonSchl->oralnon_talksA; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_talksB; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_talksC; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_talksD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo $FinalNonSchl->oralnon_recitesA; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_recitesB; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_recitesC; ?></td>
					    		<td><?php echo $FinalNonSchl->oralnon_recitesD; ?></td> 
...
<td> <?php  echo number_format(($oralor_A+$oralor_B+$oralor_C)/3,2)-number_format(($EntryDataNoPre->oral_NoPreA  + $EntryDataNoPre->oral_NoPreB*2+ $EntryDataNoPre->oral_NoPreC*3 + $EntryDataNoPre->oral_NoPreD*4)/$EntryDataNoPre->Total,2); 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo $FinalNonSchl->readnon_partA; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_partB; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_partC; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_partD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo $FinalNonSchl->read_usesA; ?></td>
					    		<td><?php echo $FinalNonSchl->read_usesB; ?></td>
					    		<td><?php echo $FinalNonSchl->read_usesC; ?></td>
					    		<td><?php echo $FinalNonSchl->read_usesD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo $FinalNonSchl->readnon_tenceA; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_tenceB; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_tenceC; ?></td>
					    		<td><?php echo $FinalNonSchl->readnon_tenceD; ?></td> 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo $FinalNonSchl->writenon_wordA; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_wordB; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_wordC; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_wordD; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo $FinalNonSchl->writenon_conveyA; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_conveyB; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_conveyC; ?></td>
					    		<td><?php echo $FinalNonSchl->writenon_conveyD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo $FinalNonNumSchl->noncountA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->noncountB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->noncountC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->noncountD; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo $FinalNonNumSchl->nonreadA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreadB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreadC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreadD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo $FinalNonNumSchl->nonaddA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonaddB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonaddC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonaddD; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo $FinalNonNumSchl->nonobsrA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonobsrB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonobsrC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonobsrD; ?></td>
					    	...
					    	<tr>
					    		<td>(v). Estimates and verifies length using non-standard non-uniform units like hand span, footstep, fingers, etc and capacity using nonstandard uniform units like cup, spoon, mug etc.</td>
					    		<td><?php echo $FinalNonNumSchl->nonunitA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonunitB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonunitC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonunitD; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo $FinalNonNumSchl->nonreciteA; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreciteB; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreciteC; ?></td>
					    		<td><?php echo $FinalNonNumSchl->nonreciteD; ?></td>
...
<td> <?php  echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2)-number_format(($EntryDataNoPre->numeric_NoPreA  + $EntryDataNoPre->numeric_NoPreB*2+ $EntryDataNoPre->numeric_NoPreC*3 + $EntryDataNoPre->numeric_NoPreD*4)/$EntryDataNoPre->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo $FinalNonHindiSchl->oral_nonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_nonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_nonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_nonD; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo $FinalNonHindiSchl->oral_conveynonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_conveynonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_conveynonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_conveynons; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo $FinalNonHindiSchl->oral_storynonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_storynonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_storynonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->oral_storynonD; ?></td>
	...
	<td> <?php  echo number_format(($oral_non1+$oral_conveynon2+$oral_storynon3)/3,2)-number_format(($EntryNoPreHindi->oral_hindinopreA  + $EntryNoPreHindi->oral_hindinopreB*2+ $EntryNoPreHindi->oral_hindinopreC*3 + $EntryNoPreHindi->oral_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo $FinalNonHindiSchl->read_storynonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_storynonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_storynonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_storynonD; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo $FinalNonHindiSchl->read_soundnonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_soundnonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_soundnonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_soundnonD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo $FinalNonHindiSchl->read_wordnonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_wordnonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_wordnonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->read_wordnonD; ?></td>
...
<td> <?php  echo number_format(($read_storynon1+$read_soundnon2+$read_wordnon3)/3,2)-number_format(($EntryNoPreHindi->read_hindinopreA  + $EntryNoPreHindi->read_hindinopreB*2+ $EntryNoPreHindi->read_hindinopreC*3 + $EntryNoPreHindi->read_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo $FinalNonHindiSchl->writing_hindinonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->writing_hindinonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->writing_hindinonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->writing_hindinonD; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo $FinalNonHindiSchl->hindi_drawingnonA; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->hindi_drawingnonB; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->hindi_drawingnonC; ?></td>
					    		<td><?php echo $FinalNonHindiSchl->hindi_drawingnonD; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo $FinalParentSchl->oralparent_converseA; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_converseB; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_converseC; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_converseD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo $FinalParentSchl->oralparent_talksA; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_talksB; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_talksC; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_talksD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo $FinalParentSchl->oralparent_recitesA; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_recitesB; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_recitesC; ?></td>
					    		<td><?php echo $FinalParentSchl->oralparent_recitesD; ?></td> 
...
<td> <?php  echo number_format(($oralorp_A+$oralorp_B+$oralorp_C)/3,2)- number_format(($EntryDataEdu->oral_EduA  + $EntryDataEdu->oral_EduB*2+ $EntryDataEdu->oral_EduC*3 + $EntryDataEdu->oral_EduD*4)/$EntryDataEdu->Total,2); 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo $FinalParentSchl->readparent_partA; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_partB; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_partC; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_partD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo $FinalParentSchl->readparent_usesA; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_usesB; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_usesC; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_usesD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo $FinalParentSchl->readparent_tenceA; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_tenceB; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_tenceC; ?></td>
					    		<td><?php echo $FinalParentSchl->readparent_tenceD; ?></td> 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo $FinalParentSchl->writeparent_wordA; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_wordB; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_wordC; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_wordD; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo $FinalParentSchl->writeparent_conveyA; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_conveyB; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_conveyC; ?></td>
					    		<td><?php echo $FinalParentSchl->writeparent_conveyD; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo $FinalParentNumSchl->parent_countA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_countB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_countC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_countD; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo $FinalParentNumSchl->parent_readA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_readB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_readC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_readD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo $FinalParentNumSchl->parent_addA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_addB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_addC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_addD; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo $FinalParentNumSchl->parent_obsrA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_obsrB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_obsrC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_obsrD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalParentNumSchl->parent_unitA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_unitB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_unitC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_unitD; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo $FinalParentNumSchl->parent_reciteA; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_reciteB; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_reciteC; ?></td>
					    		<td><?php echo $FinalParentNumSchl->parent_reciteD; ?></td>
...
<td> <?php  echo number_format(($parent_count1+$parent_read1+$parent_add3+$parent_obsr4+$parent_unit5+$parent_recite6)/6,2)-number_format(($EntryDataEdu->numeric_EduA  + $EntryDataEdu->numeric_EduB*2+ $EntryDataEdu->numeric_EduC*3 + $EntryDataEdu->numeric_EduD*4)/$EntryDataEdu->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo $FinalParentHindiSchl->oral_parent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_parent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_parent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_parent_D; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo $FinalParentHindiSchl->oral_conveyparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_conveyparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_conveyparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_conveyparent_s; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo $FinalParentHindiSchl->oral_storyparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_storyparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_storyparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->oral_storyparent_D; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo $FinalParentHindiSchl->read_storyparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_storyparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_storyparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_storyparent_D; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo $FinalParentHindiSchl->read_soundparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_soundparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_soundparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_soundparent_D; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo $FinalParentHindiSchl->read_wordparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_wordparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_wordparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->read_wordparent_D; ?></td>
...
<td> <?php  echo number_format(($read_storyparent_1+$read_soundparent_2+$read_wordparent_3)/3,2)-number_format(($EntryEduHindi->read_hindi_EduA  + $EntryEduHindi->read_hindi_EduB*2+ $EntryEduHindi->read_hindi_EduC*3 + $EntryEduHindi->read_hindi_EduD*4)/$EntryEduHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo $FinalParentHindiSchl->writing_hindiparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->writing_hindiparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->writing_hindiparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->writing_hindiparent_D; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo $FinalParentHindiSchl->hindi_drawingparent_A; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->hindi_drawingparent_B; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->hindi_drawingparent_C; ?></td>
					    		<td><?php echo $FinalParentHindiSchl->hindi_drawingparent_D; ?></td>
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_converseA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_converseB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_converseC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_converseD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_talksA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_talksB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_talksC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_talksD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_recitesA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_recitesB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_recitesC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->oralnonedu_recitesD; ?></td> 
...
<td> <?php  echo number_format(($oralnonedu_converse1+$oralnonedu_talks2+$oralnonedu_recites3)/3,2)-number_format(($EntryDataNoEdu->oral_NoEduA  + $EntryDataNoEdu->oral_NoEduB*2+ $EntryDataNoEdu->oral_NoEduC*3 + $EntryDataNoEdu->oral_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_partA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_partB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_partC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_partD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo $FinalNonEduSchl->readnonedu_usesA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_usesB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_usesC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_usesD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_tenceA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_tenceB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_tenceC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->readnonedu_tenceD; ?></td> 
...
<td> <?php  echo number_format(($readnonedu_part1+$readnonedu_uses2+$readnonedu_tence3)/3,2)- number_format(($EntryDataNoEdu->read_NoEduA  + $EntryDataNoEdu->read_NoEduB*2+ $EntryDataNoEdu->read_NoEduC*3 + $EntryDataNoEdu->read_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_wordA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_wordB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_wordC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_wordD; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_conveyA; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_conveyB; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_conveyC; ?></td>
					    		<td><?php echo $FinalNonEduSchl->writenonedu_conveyD; ?></td>
...
<td> <?php  echo number_format(($writenonedu_word1+$writenonedu_convey2)/2,2)- number_format(($EntryDataNoEdu->write_NoEduA  + $EntryDataNoEdu->write_NoEduB*2+ $EntryDataNoEdu->write_NoEduC*3 + $EntryDataNoEdu->write_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_countA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_countB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_countC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_countD; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_readA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_readB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_readC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_readD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_addA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_addB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_addC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_addD; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_obsrA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_obsrB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_obsrC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_obsrD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_unitA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_unitB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_unitC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_unitD; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_reciteA; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_reciteB; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_reciteC; ?></td>
					    		<td><?php echo $FinalNonEduNumSchl->nonedu_reciteD; ?></td>
...
<td> <?php  echo number_format(($nonedu_count1+$nonedu_read1+$nonedu_add3+$nonedu_obsr4+$nonedu_unit5+$nonedu_recite6)/6,2)-  number_format(($EntryDataNoEdu->numeric_NoEduA  + $EntryDataNoEdu->numeric_NoEduB*2+ $EntryDataNoEdu->numeric_NoEduC*3 + $EntryDataNoEdu->numeric_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_nonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_nonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_nonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_nonedu_D; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_conveynonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_conveynonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_conveynonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_conveynonedu_s; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_storynonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_storynonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_storynonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->oral_storynonedu_D; ?></td>
...
<td> <?php  echo number_format(($oral_nonedu_1+$oral_conveynonedu_2+$oral_storynonedu_3)/3,2)- number_format(($EntryNoEduHindi->oral_hindi_NoEduA  + $EntryNoEduHindi->oral_hindi_NoEduB*2+ $EntryNoEduHindi->oral_hindi_NoEduC*3 + $EntryNoEduHindi->oral_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_storynonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_storynonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_storynonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_storynonedu_D; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_soundnonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_soundnonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_soundnonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_soundnonedu_D; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_wordnonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_wordnonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_wordnonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->read_wordnonedu_D; ?></td>
...
<td> <?php  echo number_format(($read_storynonedu_1+$read_soundnonedu_2+$read_wordnonedu_3)/3,2)- number_format(($EntryNoEduHindi->read_hindi_NoEduA  + $EntryNoEduHindi->read_hindi_NoEduB*2+ $EntryNoEduHindi->read_hindi_NoEduC*3 + $EntryNoEduHindi->read_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo $FinalNonEduHindiSchl->writing_hindinonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->writing_hindinonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->writing_hindinonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->writing_hindinonedu_D; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo $FinalNonEduHindiSchl->hindi_drawingnonedu_A; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->hindi_drawingnonedu_B; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->hindi_drawingnonedu_C; ?></td>
					    		<td><?php echo $FinalNonEduHindiSchl->hindi_drawingnonedu_D; ?></td>
...
<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of Differently abled Students.</th>						<tr>
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse with friends and class teacher about her needs, surroundings</td>
					    		<td><?php echo $FinalDisSchl->oraldisable_converseA; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_converseB; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_converseC; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_converseD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Talks about the print available in the classroom</td>					    		
					    		<td><?php echo $FinalDisSchl->oraldisable_talksA; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_talksB; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_talksC; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_talksD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo $FinalDisSchl->oraldisable_recitesA; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_recitesB; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_recitesC; ?></td>
					    		<td><?php echo $FinalDisSchl->oraldisable_recitesD; ?></td> 
...
<td> <?php  echo number_format(($oraldisable_converse1+$oraldisable_talks2+$oraldisable_recites3)/3,2)- number_format(($EntryDisData->oral_DisA  + $EntryDisData->oral_DisB*2+ $EntryDisData->oral_DisC*3 + $EntryDisData->oral_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Participate in read aloud/story telling session and demonstrate comprehension through activities</td>
					    		<td><?php echo $FinalDisSchl->readdisable_partA; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_partB; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_partC; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_partD; ?></td>
					    	...
					    	<tr>
					    		<td>(ii). Uses sound symbol correspondence to read words</td>					    		
					    		<td><?php echo $FinalDisSchl->readdisable_usesA; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_usesB; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_usesC; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_usesD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Reads small sentences consisting of at least 4-5 simple words in an ageappropriate unknown text.</td>
					    		<td><?php echo $FinalDisSchl->readdisable_tenceA; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_tenceB; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_tenceC; ?></td>
					    		<td><?php echo $FinalDisSchl->readdisable_tenceD; ?></td> 
...
<td> <?php  echo number_format(($readdisable_part1+$readdisable_uses2+$readdisable_tence3)/3,2)-number_format(($EntryDisData->read_DisA  + $EntryDisData->read_DisB*2+ $EntryDisData->read_DisC*3 + $EntryDisData->read_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Basic writing abilities </td>
					    		<td><?php echo $FinalDisSchl->writedisable_wordA; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_wordB; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_wordC; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_wordD; ?></td>
							...
							<tr>
					    		<td>(ii). Convey meanings and represent names through drawing, writing, and making things </td>
					    		<td><?php echo $FinalDisSchl->writedisable_conveyA; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_conveyB; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_conveyC; ?></td>
					    		<td><?php echo $FinalDisSchl->writedisable_conveyD; ?></td>
...
<td> <?php  echo number_format(($writedisable_word1+$writedisable_convey2)/2,2)-number_format(($EntryDisData->write_DisA  + $EntryDisData->write_DisB*2+ $EntryDisData->write_DisC*3 + $EntryDisData->write_DisD*4)/$EntryDisData->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Counts objects up to 20 </td>
					    		<td><?php echo $FinalDisNumSchl->disable_countA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_countB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_countC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_countD; ?></td>
							...
							<tr>
					    		<td>(ii). Reads and writes numbers upto 99</td>
					    		<td><?php echo $FinalDisNumSchl->disable_readA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_readB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_readC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_readD; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). Using addition and subtraction of numbers up to 9 in daily life situations</td>
					    		<td><?php echo $FinalDisNumSchl->disable_addA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_addB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_addC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_addD; ?></td>
					    	...
					    	<tr>
					    		<td>(iv). Observes and describes physical properties of 3D shapes (solid shapes) around him/her like round/flat surfaces, number of corners and edges etc</td>
					    		<td><?php echo $FinalDisNumSchl->disable_obsrA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_obsrB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_obsrC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_obsrD; ?></td>
					    	...
					    	<tr>
					    		...
					    		<td><?php echo $FinalDisNumSchl->disable_unitA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_unitB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_unitC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_unitD; ?></td>
					    	...
					    	<tr>
					    		<td>(vi). Creates and recites short poems and stories using shapes and numbers </td>
					    		<td><?php echo $FinalDisNumSchl->disable_reciteA; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_reciteB; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_reciteC; ?></td>
					    		<td><?php echo $FinalDisNumSchl->disable_reciteD; ?></td>
...
<td> <?php  echo number_format(($disable_count1+$disable_read1+$disable_add3+$disable_obsr4+$disable_unit5+$disable_recite6)/6,2)-number_format(($EntryDisData->numeric_DisA  + $EntryDisData->numeric_DisB*2+ $EntryDisData->numeric_DisC*3 + $EntryDisData->numeric_DisD*4)/$EntryDisData->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मित्रों और शिक्षको के साथ स्वयं की आवश्यकताओं और परिवेश पर वार्तालाप </td>
					    		<td><?php echo $FinalDisHindiSchl->oral_disable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_disable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_disable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_disable_D; ?></td>
							...
							<tr>
					    		<td>(ii). कक्षा में उपलब्ध मुद्रित सामग्री पर चर्चा करना</td>
					    		<td><?php echo $FinalDisHindiSchl->oral_conveydisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_conveydisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_conveydisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_conveydisable_s; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). तुकबंदियों/ कविताओं/ गीतों का पाठ क्रियाओं या भावों के साथ करना</td>
					    		<td><?php echo $FinalDisHindiSchl->oral_storydisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_storydisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_storydisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->oral_storydisable_D; ?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). सस्वर पाठ/ कहानी कथन सत्र में प्रतिभागिता और क्रियाकलापों के माध्यम से समझ का प्रदर्शन </td>
					    		<td><?php echo $FinalDisHindiSchl->read_storydisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_storydisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_storydisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_storydisable_D; ?></td>
							...
							<tr>
					    		<td>(ii). पढे हुए शब्दों के सापेक्ष ध्वनि-चिन्हों का उपयोग</td>
					    		<td><?php echo $FinalDisHindiSchl->read_sounddisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_sounddisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_sounddisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_sounddisable_D; ?></td>
					    	...
					    	<tr>
					    		<td>(iii). उम्र के अनुरूप चार पाँच सरल शब्दों वाले लघु वाक्यों के अपठित गदयांश पढ़ना</td>
					    		<td><?php echo $FinalDisHindiSchl->read_worddisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_worddisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_worddisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->read_worddisable_D; ?></td>
...
<td> <?php  echo number_format(($read_storydisable_1+$read_sounddisable_2+$read_worddisable_3)/3,2)-number_format(($EntryDisHindi->read_hindi_DisA  + $EntryDisHindi->read_hindi_DisB*2+ $EntryDisHindi->read_hindi_DisC*3 + $EntryDisHindi->read_hindi_DisD*4)/$EntryDisHindi->Total,2); 
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). मूलभूत लेखन योग्यताएँ </td>
					    		<td><?php echo $FinalDisHindiSchl->writing_hindidisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->writing_hindidisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->writing_hindidisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->writing_hindidisable_D; ?></td>
							...
							<tr>
					    		<td>(ii). कला, लेखन और वस्तुओं के निर्माण के माध्यम से अर्थ एवं नामों का सम्प्रेषण</td>
					    		<td><?php echo $FinalDisHindiSchl->hindi_drawingdisable_A; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->hindi_drawingdisable_B; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->hindi_drawingdisable_C; ?></td>
					    		<td><?php echo $FinalDisHindiSchl->hindi_drawingdisable_D; ?></td>
