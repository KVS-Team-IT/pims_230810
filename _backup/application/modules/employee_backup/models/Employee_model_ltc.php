...
class Employee_model extends CI_Model {
    ...
    public function InsPersonalData($empData,$empId,$empTyp){
            ...
            if($this->db->insert('employee_details', $PostData)) {
                ...
                $response['emp_name'] = $empData['emp_first_name'];
    ...
    public function setTrainingData($empData){
        ...
        foreach ($empData['course'] as $key => $value)
        {
            ...
            {
                $venuetype1 = $empData['venuetype'][$key];
                $venueregion1 = $empData['venueregion'][$key];
                $venueschool1 = $empData['venueschool'][$key];
            ...
            {
                $venuetype1 = $empData['doublevenuetype1'][$key];
                $venueregion1 = $empData['doublevenueregion1'][$key];
                $venueschool1 = $empData['doublevenueschool1'][$key];
                $venuetype2 = $empData['doublevenuetype2'][$key];
                $venueregion2 = $empData['doublevenueregion2'][$key];
                $venueschool2 = $empData['doublevenueschool2'][$key];
            ...
            {
                $venuetype1 = $empData['spellvenuetype1'][$key];
                $venueregion1 = $empData['spellvenueregion1'][$key];
                $venueschool1 = $empData['spellvenueschool1'][$key];
                $venuetype2 = $empData['spellvenuetype2'][$key];
                $venueregion2 = $empData['spellvenueregion2'][$key];
                $venueschool2 = $empData['spellvenueschool2'][$key];
                $venuetype3 = $empData['spellvenuetype3'][$key];
                $venueregion3 = $empData['spellvenueregion3'][$key];
                $venueschool3 = $empData['spellvenueschool3'][$key];
                $venuetype4 = $empData['spellvenuetype4'][$key];
                $venueregion4 = $empData['spellvenueregion4'][$key];
                $venueschool4 = $empData['spellvenueschool4'][$key];
            ...
            $PostData = array(
                ...
                'venuetype1' => $venuetype1,
                'venueregion1' => $venueregion1,
                'venueschool1' => $venueschool1,
                'venuetype2' => $venuetype2,
                'venueregion2' => $venueregion2,
                'venueschool2' => $venueschool2,
                'venuetype3' => $venuetype3,
                'venueregion3' => $venueregion3,
                'venueschool3' => $venueschool3,
                'venuetype4' => $venuetype4,
                'venueregion4' => $venueregion4,
                'venueschool4' => $venueschool4,
                'created_by' => $this->session->userdata('user_id')   
            );
        ...
        //========================= INSERT DATA INTO EXEMPTION =========================//
        $is_exemption=$empData['is_exemption'];
        $course=$empData['exemption_course'];
        $ground=$empData['exemption_ground'];
        $reason=$empData['reason'];
                
        if($is_exemption==1){ // Exemption
            for($p=0;$p<count($course);$p++){
                $pdata=array(
                'emp_id' => $empData['emp_id'],
                ...
                'reason' => $reason[$p],
                'status' => '1');
                $this->db->insert('ci_training_exemption', $pdata);
