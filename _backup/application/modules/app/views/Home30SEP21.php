        ...
        <div class="card-body shape-shadow">
            ...
            <div class="col-md-4">
                <?php if($this->role_id==6){ ?>
                        ...
                        <hr>
                        <a href="<?php echo base_url(''); ?>img/PIMS-PROFILE_TRANSFER_OR_MIGRATION_PROCESS.pdf" download>
                        <i class="fas fa-download" style="font-size: 22px; color:#F44336;"></i> 
                        &nbsp;&nbsp;<a style="font-size: 14px; font-weight: bold; color:#014A69;">Profile Transfer/Migration Process Document</a>
                        </a>
