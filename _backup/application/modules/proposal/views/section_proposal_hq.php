    ...
    <div class="delete_more_button" style="display:none;" id="history_more_1_{{random_exr_id}}">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                <?php echo form_input("dc_section[]", '{{history_detail.dc_section}}', 'readonly id="dc_section_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("dc_status[]", array("" => "Select") + section_status(), isset($school->dc_status) ? set_value('dc_status', $school->dc_status) : set_value('dc_status'), 'disabled id="dc_status_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
