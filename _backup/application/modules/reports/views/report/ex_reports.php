	...
	<div class="card mb-3">
		...
		<div class="row col-md-12">
                ...
                <div class="form-group col-md-3">
                    ...
                    <?php echo form_dropdown("initial_section_id",array("" => "Select Section") +section_lists(), '', 'class="form-control validate[required]"  id="initial_section_id" data-id="c" '); ?>
                ...
                <div class="form-group col-md-3" id="" >
                    ...
                    <?php echo form_dropdown("desiganition_id", array("" => "Select Designation") + designation_lists($this->role_id,$this->role_category), '', 'id="desiganition_id" data-id="c"  class="form-control validate[required]" onchange="getsubject()" ');    ?>
                </div>	
