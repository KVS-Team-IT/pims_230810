            ...
            'columns': [
                            ...
                            {"data": "created_on"},
                            {
                                ...
                                "render": function (data, type, row) {
                                    ...
                                    return '<a href="<?php echo site_url(); ?>web-tools/' + row.enc_sno + '"><i class="fa fa-pencil-square-o text-success" aria-hidden="true">&nbsp;View & Edit</i></a>';
                                    }else{
                                    return '<a href="<?php echo site_url(); ?>web-tools/' + row.enc_sno + '"><i class="fa fa-eye text-warning" aria-hidden="true">&nbsp; View</i></a>';   
                                    }
                                }
                            },
                           /* {
