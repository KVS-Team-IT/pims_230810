...
<!--================================ Permanent Address =================================-->
<h6><strong  class="font_size_dynamic">Permanent Address: - </strong></h6>
        <div class="background_div">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="col-sm-3">
				   <label for="" class="col-sm-12 col-form-label">State: </label>
                    <?php echo form_dropdown("emp_state_id", array("" => "Select") + state_lists(),  isset($PerData->emp_state_id) ? set_value('emp_state_id', $PerData->emp_state_id) : set_value('emp_state_id'), ' id="emp_state_id" class="form-control"  autocomplete="off"');?>
                    <span class="error"><?php echo form_error('emp_state_id'); ?></span>
                </div>
				<div class="col-sm-3">
				   <label for="" class="col-sm-12 col-form-label">District: </label>
                    <?php echo form_dropdown("emp_district_id", array("" => "Select") + district_lists(),  isset($PerData->emp_district_id) ? set_value('emp_district_id', $PerData->emp_district_id) : set_value('emp_district_id'), ' id="emp_district_id" class="form-control"  autocomplete="off"');?>
                    <span class="error"><?php echo form_error('emp_district_id'); ?></span>
                </div>
				
				<div class="form-group col-md-3">
                <label for="" class="col-sm-12 col-form-label">Pincode:</label>
                <div class="col-sm-12">
                    <?php echo form_input("emp_permanent_pincode", isset($PerData->emp_permanent_pincode) ? set_value('emp_permanent_pincode', $PerData->emp_permanent_pincode) : set_value('emp_permanent_pincode'), 'placeholder="Pincode" maxlength="6" minlength="6" id="emp_permanent_pincode" class="numericOnly validate[required,maxSize[6]] form-control" autocomplete="off" '); ?>
                    <span class="error"><?php echo form_error('emp_permanent_pincode'); ?></span>
                </div>
            </div>
        </div>
...
<!--================================ Residential Address =================================-->
<h6><strong  class="font_size_dynamic">Residential Address: - </strong></h6>
        <div class="background_div">
        ...
        <div class="row"> 
                <div class="form-group col-md-3">
                  ...
                  <div class="col-sm-3">
				   <label for="" class="col-sm-12 col-form-label">State: </label>
                    <?php echo form_dropdown("emp_res_state_id", array("" => "Select") + state_lists(),  isset($PerData->emp_res_state_id) ? set_value('emp_res_state_id', $PerData->emp_res_state_id) : set_value('emp_res_state_id'), ' id="emp_res_state_id" class="form-control"  autocomplete="off"');?>
                    <span class="error"><?php echo form_error('emp_res_state_id'); ?></span>
                </div>
				<div class="col-sm-3">
				   <label for="" class="col-sm-12 col-form-label">District:  </label>
                    <?php echo form_dropdown("emp_res_district_id", array("" => "Select") + district_lists(),  isset($PerData->emp_res_district_id) ? set_value('emp_res_district_id', $PerData->emp_res_district_id) : set_value('emp_res_district_id'), ' id="emp_res_district_id" class="form-control"  autocomplete="off"');?>
                    <span class="error"><?php echo form_error('emp_res_district_id'); ?></span>
                </div>
            ...
            <div class="row"><div class="form-group col-md-12"><hr></div></div>
		     ...
		     <div class="row"> 
                <div class="form-group col-md-3"> 
                   <label for="" class="col-sm-12 col-form-label">Domicile state As For Service Document:<span class="reqd">*</span></label>
					<div class="col-sm-12">
					
						                    <?php echo form_dropdown("domicile_id", array("" => "Select") + state_lists(),  isset($PerData->domicile_id) ? set_value('domicile_id', $PerData->domicile_id) : set_value('domicile_id'), ' id="domicile_id" class="form-control"  autocomplete="off"');?>
        ...
        ?>
            ...
            <div class="row"> 
                ...
                <div class="form-group col-md-4" id="shift_div_present" style="display:none;" >
                    ...
                    <div class="col-sm-12">
                        <?php echo form_dropdown("present_shift", array("" => "Select Shift") + shift(), isset($PrePost->present_shift) ? set_value('present_shift', $PrePost->present_shift) : set_value('present_shift',$CurData->KSHIFT), 'readonly id="shift_present" class="form-control" autocomplete="off" '); ?>
        ...
        <!-- ======================= H I D D E N   S E C T I O N    E N D ====================-->
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span class="error"><?php echo form_error('present_status'); ?></span> 
                    </div>
                </div>
                
                <div class="form-group col-md-3" >
                    <label for="" class="col-sm-12 col-form-label">Effective date of Employment Status:<span class="reqd">*</span></label>
                    <div class="col-sm-12">
                        <?php 
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4" >
                    ...
                    <div class="col-sm-12">
                        <?php echo form_dropdown("present_category", array("" => "Select") + pre_reserve_post(), isset($PrePost->present_category) ? set_value('present_category', $PrePost->present_category) : set_value('present_category'), 'class="form-control validate[required]" autocomplete="off" '); ?>
        ...
        <div class="col-sm-12">
            <div  style="float:right;"> 
                <?php if($PerData->emp_acceptance==1){ ?>
                    <a class="btn btn-warning" id="perSaveBtn" href="<?php echo base_url('employee-report');?>" >Please Unlock the Employee Profile to Save / Update the Data</a>     
                <?php }else{ ?>
...
$(document).ready(function(){
 $('#emp_state_id').change(function(){
  var state_id;
  var state_id = $('#emp_state_id').val(); 
  if(state_id != '')
  {
   $.ajax({
    url:"<?php echo base_url(); ?>getcityonprofile",
    method:"POST",
    data: get_csrf_token_name + '=' + get_csrf_hash + '&state_id=' + state_id,
    success:function(jsonData)
    {
		$('#emp_district_id').prop('selected', false).find('option:first').prop('selected', true); 
     $('#emp_district_id').select2();
        var options = $('#emp_district_id').empty(); 
        $.each(JSON.parse(jsonData), function() {
            options.append($("<option />").val(this.district_id).text(this.district_name));
        });
    }
   });
  }
  ...
  {
   $('#emp_district_id').html('<option value="">Select District</option>');
  }
 });
 
 $('#emp_res_state_id').change(function(){
  var state_id;
  var state_id = $('#emp_res_state_id').val();
  //alert(state_id);
  if(state_id != '')
  {
   $.ajax({
    ...
    {
        //alert(data);
      $('#emp_res_district_id').select2();
        var options = $('#emp_res_district_id').empty();
        $.each(JSON.parse(jsonDatas), function() {
            options.append($("<option />").val(this.district_id).text(this.district_name));
        });
    }
   });
