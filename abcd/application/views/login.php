...
<head>
    ...
    @font-face {
        ...
        src: url('assets/fonts/text-security-disc.eot?#iefix') format('embedded-opentype'),
            ...
            url('assets/images/text-security-disc.svg#text-security') format('svg');
    }
    ...
    <div class="container">
        ...
        <div class="card card-login mx-auto mt-5">
            <div class="card-header text-center" style="margin: 15px 15px !important;padding-bottom: 0px !important;">
                <img class="rounded" src="<?php echo base_url(); ?>assets/img/kvs-logo1bk.png" width="75" height="60">
                <br>
                <label
            ...
            <div class="card-body" style="padding-top: 0px!important;">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control password"
                        autocomplete="off" value="Pims@2022" placeholder="Password">
