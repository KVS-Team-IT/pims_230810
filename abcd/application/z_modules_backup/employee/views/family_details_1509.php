...
<script id="family_more_template" type="x-tmpl-mustache">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
        <?php echo form_dropdown("relation[]", array("" => "Select") + relation(),'', 'id="relation_{{random_exr_id}}" class="form-control validate[required]" autocomplete="off" '); ?>
...
<script id="nominee_more_template" type="x-tmpl-mustache">
    ...
    <div class="row">
        ...
        <label for="" class="col-sm-12 col-form-label">Relation:<span class="reqd">*</span></label>
        <div class="col-sm-12">
        <?php echo form_dropdown("nomineerelation[]", array("" => "Select") + relation(),'', 'id="nominee_{{random_exr_id}}" class="form-control validate[required]" autocomplete="off" '); ?>
