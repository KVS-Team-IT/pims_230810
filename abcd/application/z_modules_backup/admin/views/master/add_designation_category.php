        ...
        <div class="card mb-3">
            ...
            <div class="card-body user_view">
                <div class="row first-row">
                    ...
                    <div class="col-md-3">
                        <?php echo form_input("name", isset($designation_category->name) ? set_value('name', $designation_category->name) : set_value('name'), 'class="txtOnly validate[required] form-control" autocomplete="off"');
