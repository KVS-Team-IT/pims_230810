                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <?php echo form_input("emp_name", isset($DB['emp_name']) ? set_value('emp_name', $DB['emp_name']) : set_value('emp_name',''), 'placeholder=" " id="emp_name" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_code", isset($DB['emp_code']) ? set_value('emp_code', $DB['emp_code']) : set_value('emp_code',''), 'placeholder=" " id="emp_code" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_mail", isset($DB['emp_mail']) ? set_value('emp_mail', $DB['emp_mail']) : set_value('emp_mail',''), 'placeholder="" id="emp_mail" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_region", isset($DB['emp_region']) ? set_value('emp_region', $DB['emp_region']) : set_value('emp_region',''), 'placeholder=" " id="emp_region" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_kvname",isset($DB['emp_kvname']) ? set_value('emp_kvname', $DB['emp_kvname']) : set_value('emp_kvname',''), 'placeholder=" " id="emp_kvname" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_kvcode",isset($DB['emp_kvcode']) ? set_value('emp_kvcode', $DB['emp_kvcode']) : set_value('emp_kvcode',''), 'placeholder=" " id="emp_kvcode" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_desig",isset($DB['emp_desig']) ? set_value('emp_desig', $DB['emp_desig']) : set_value('emp_desig',''), 'placeholder=" " id="emp_desig" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("emp_subject",isset($DB['emp_subject']) ? set_value('emp_subject', $DB['emp_subject']) : set_value('emp_subject',''), 'placeholder=" " id="emp_subject" class="validate[required] form-control" autocomplete="off"'); ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("obs_name",isset($DB['obs_name']) ? set_value('obs_name', $DB['obs_name']) : set_value('obs_name',''), 'placeholder=" " id="obs_name" class="txtOnly validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("lession_topic_txt",isset($DB['lession_topic_txt']) ? set_value('lession_topic_txt', $DB['lession_topic_txt']) : set_value('lession_topic_txt',''), 'placeholder=" " id="lession_topic_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');     
                                }else{
                                echo form_input("lession_topic_txt",isset($DB['lession_topic_txt']) ? set_value('lession_topic_txt', $DB['lession_topic_txt']) : set_value('lession_topic_txt',''), 'placeholder=" " id="lession_topic_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("lession_plan_txt",isset($DB['lession_plan_txt']) ? set_value('lession_plan_txt', $DB['lession_plan_txt']) : set_value('lession_plan_txt',''), 'placeholder=" " id="lession_plan_txt" style="display:block" class="validate[required] form-control" autocomplete="off"'); 
                                }else{
                                echo form_input("lession_plan_txt",isset($DB['lession_plan_txt']) ? set_value('lession_plan_txt', $DB['lession_plan_txt']) : set_value('lession_plan_txt',''), 'placeholder=" " id="lession_plan_txt" style="display:none" class="validate[required] form-control" autocomplete="off"'); 
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("learner_skill",isset($DB['learner_skill']) ? set_value('learner_skill', $DB['learner_skill']) : set_value('learner_skill',''), 'placeholder=" " id="learner_skill" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("teacher_student_txt",isset($DB['teacher_student_txt']) ? set_value('teacher_student_txt', $DB['teacher_student_txt']) : set_value('teacher_student_txt',''), 'placeholder=" " id="teacher_student_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("teacher_student_txt",isset($DB['teacher_student_txt']) ? set_value('teacher_student_txt', $DB['teacher_student_txt']) : set_value('teacher_student_txt',''), 'placeholder=" " id="teacher_student_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("audio_visual",isset($DB['audio_visual']) ? set_value('audio_visual', $DB['audio_visual']) : set_value('audio_visual',''), 'placeholder=" " id="audio_visual" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("student_involve_txt",isset($DB['student_involve_txt']) ? set_value('student_involve_txt', $DB['student_involve_txt']) : set_value('student_involve_txt',''), 'placeholder=" " id="student_involve_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("student_involve_txt",isset($DB['student_involve_txt']) ? set_value('student_involve_txt', $DB['student_involve_txt']) : set_value('student_involve_txt',''), 'placeholder=" " id="student_involve_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("project_work",isset($DB['project_work']) ? set_value('project_work', $DB['project_work']) : set_value('project_work',''), 'placeholder=" " id="project_work" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("frequency_quality",isset($DB['frequency_quality']) ? set_value('frequency_quality', $DB['frequency_quality']) : set_value('frequency_quality',''), 'placeholder=" " id="frequency_quality" class="validate[required] form-control" autocomplete="off"'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <?php echo form_input("comm_skill",isset($DB['comm_skill']) ? set_value('comm_skill', $DB['comm_skill']) : set_value('comm_skill',''), 'placeholder=" " id="comm_skill" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="col-sm-12">
                            <?php echo form_input("obs_records",isset($DB['obs_records']) ? set_value('obs_records', $DB['obs_records']) : set_value('obs_records',''), 'placeholder=" " id="obs_records" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("teacher_improve_txt",isset($DB['teacher_improve_txt']) ? set_value('teacher_improve_txt', $DB['teacher_improve_txt']) : set_value('teacher_improve_txt',''), 'placeholder=" " id="teacher_improve_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("teacher_improve_txt",isset($DB['teacher_improve_txt']) ? set_value('teacher_improve_txt', $DB['teacher_improve_txt']) : set_value('teacher_improve_txt',''), 'placeholder=" " id="teacher_improve_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("instruction_tool_txt",isset($DB['instruction_tool_txt']) ? set_value('instruction_tool_txt', $DB['instruction_tool_txt']) : set_value('instruction_tool_txt',''), 'placeholder=" " id="instruction_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("instruction_tool_txt",isset($DB['instruction_tool_txt']) ? set_value('instruction_tool_txt', $DB['instruction_tool_txt']) : set_value('instruction_tool_txt',''), 'placeholder=" " id="instruction_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("classroom_tool_txt",isset($DB['classroom_tool_txt']) ? set_value('classroom_tool_txt', $DB['classroom_tool_txt']) : set_value('classroom_tool_txt',''), 'placeholder=" " id="classroom_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("classroom_tool_txt",isset($DB['classroom_tool_txt']) ? set_value('classroom_tool_txt', $DB['classroom_tool_txt']) : set_value('classroom_tool_txt',''), 'placeholder=" " id="classroom_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');    
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("assessment_tool_txt",isset($DB['assessment_tool_txt']) ? set_value('assessment_tool_txt', $DB['assessment_tool_txt']) : set_value('assessment_tool_txt',''), 'placeholder=" " id="assessment_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("assessment_tool_txt",isset($DB['assessment_tool_txt']) ? set_value('assessment_tool_txt', $DB['assessment_tool_txt']) : set_value('assessment_tool_txt',''), 'placeholder=" " id="assessment_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');   
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("planning_tool_txt",isset($DB['planning_tool_txt']) ? set_value('planning_tool_txt', $DB['planning_tool_txt']) : set_value('planning_tool_txt',''), 'placeholder=" " id="planning_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("planning_tool_txt",isset($DB['planning_tool_txt']) ? set_value('planning_tool_txt', $DB['planning_tool_txt']) : set_value('planning_tool_txt',''), 'placeholder=" " id="planning_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("suggestion_tool_txt",isset($DB['suggestion_tool_txt']) ? set_value('suggestion_tool_txt', $DB['suggestion_tool_txt']) : set_value('suggestion_tool_txt',''), 'placeholder=" " id="suggestion_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("suggestion_tool_txt",isset($DB['suggestion_tool_txt']) ? set_value('suggestion_tool_txt', $DB['suggestion_tool_txt']) : set_value('suggestion_tool_txt',''), 'placeholder=" " id="suggestion_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');  
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("management_tool_txt",isset($DB['management_tool_txt']) ? set_value('management_tool_txt', $DB['management_tool_txt']) : set_value('management_tool_txt',''), 'placeholder=" " id="management_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("management_tool_txt",isset($DB['management_tool_txt']) ? set_value('management_tool_txt', $DB['management_tool_txt']) : set_value('management_tool_txt',''), 'placeholder=" " id="management_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');   
                                }
                                ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            ?>
                                ...
                                echo form_input("action_tool_txt",isset($DB['action_tool_txt']) ? set_value('action_tool_txt', $DB['action_tool_txt']) : set_value('action_tool_txt',''), 'placeholder=" " id="action_tool_txt" style="display:block" class="validate[required] form-control" autocomplete="off"');
                                }else{
                                echo form_input("action_tool_txt",isset($DB['action_tool_txt']) ? set_value('action_tool_txt', $DB['action_tool_txt']) : set_value('action_tool_txt',''), 'placeholder=" " id="action_tool_txt" style="display:none" class="validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                        ...
                        <div class="col-sm-12">
                            <?php echo form_input("obs_grading",isset($DB['obs_grading']) ? set_value('obs_grading', $DB['obs_grading']) : set_value('obs_grading',''), 'placeholder=" " id="obs_grading" class="validate[required] form-control" autocomplete="off"'); ?>
                        ...
                        <div class="col-sm-12">
                            <?php echo form_input("per_garding",isset($DB['per_garding']) ? set_value('per_garding', $DB['per_garding']) : set_value('per_garding',''), 'placeholder=" " id="per_garding" class="validate[required] form-control" autocomplete="off"'); ?>
