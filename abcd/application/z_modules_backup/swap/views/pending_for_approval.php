                                ...
                                <td>
                                    <?php 
                                        if($T->in_process=='1' && $T->transfer_status=='1'){
                                            echo '<a href="'. base_url().'swap/process_pending_for_approval/'. EncryptIt($T->EMP_ID).'" class="btn btn-primary btn-block"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;UPDATE</a>';
