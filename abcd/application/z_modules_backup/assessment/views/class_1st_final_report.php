					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	...
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryData->oral_eng1A  + $EntryData->oral_eng1B*2+ $EntryData->oral_eng1C*3 + $EntryData->oral_eng1D*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of READING ABILITIES (ENGLISH).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryData->read_eng1A  + $EntryData->read_eng1B*2+ $EntryData->read_eng1C*3 + $EntryData->read_eng1D*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WRITING ABILITIES (ENGLISH).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryData->write_eng1A  + $EntryData->write_eng1B*2+ $EntryData->write_eng1C*3 + $EntryData->write_eng1D*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	...
					    	<td><?php echo number_format(($YearEndWriting->write_wordD+$YearEndWriting->write_conveyD)/2,2); ?></td>
								<td> <?php  $write_word_T1= number_format(($YearEndWriting->write_wordA  + $YearEndWriting->write_wordB*2+ $YearEndWriting->write_wordC*3 + $YearEndWriting->write_wordD*4)/$YearEndWriting->Total,2); 
								$write_convey_T2= number_format(($YearEndWriting->write_conveyA  + $YearEndWriting->write_conveyB*2+ $YearEndWriting->write_conveyC*3 + $YearEndWriting->write_conveyD*4)/$YearEndWriting->Total,2);
								echo number_format(($write_word_T1+$write_convey_T2)/2,2); 
									?></td>				
								<td><?php echo number_format(($write_word_T1+$write_convey_T2)/2,2)- number_format(($EntryData->write_eng1A  + $EntryData->write_eng1B*2+ $EntryData->write_eng1C*3 + $EntryData->write_eng1D*4)/$YearEndOral->Total,2); ?> </td>
					    	</tr>
						 </tbody>
						 </table>
							</div> 
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of NUMERACY ABILITIES.</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryData->numeric1A  + $EntryData->numeric1B*2+ $EntryData->numeric1C*3 + $EntryData->numeric1D*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
					...
					<div class="col-sm-6">
						...
						<tbody>  
							...
							<td> <?php  $NUM_A= number_format(($YearEndNumeracy->num_countA  + $YearEndNumeracy->num_countB*2+ $YearEndNumeracy->num_countC*3 + $YearEndNumeracy->num_countD*4)/$YearEndNumeracy->Total,2); 
								$NUM_B= number_format(($YearEndNumeracy->num_readA  + $YearEndNumeracy->num_readB*2+ $YearEndNumeracy->num_readC*3 + $YearEndNumeracy->num_readD*4)/$YearEndNumeracy->Total,2);
								$NUM_C= number_format(($YearEndNumeracy->num_addA  + $YearEndNumeracy->num_addB*2+ $YearEndNumeracy->num_addC*3 + $YearEndNumeracy->num_addD*4)/$YearEndNumeracy->Total,2);
								$NUM_D= number_format(($YearEndNumeracy->num_obsrA  + $YearEndNumeracy->num_obsrB*2+ $YearEndNumeracy->num_obsrC*3 + $YearEndNumeracy->num_obsrD*4)/$YearEndNumeracy->Total,2);
								$NUM_E= number_format(($YearEndNumeracy->num_unitA  + $YearEndNumeracy->num_unitB*2+ $YearEndNumeracy->num_unitC*3 + $YearEndNumeracy->num_unitD*4)/$YearEndNumeracy->Total,2);
								$NUM_F= number_format(($YearEndNumeracy->num_reciteA  + $YearEndNumeracy->num_reciteB*2+ $YearEndNumeracy->num_reciteC*3 + $YearEndNumeracy->num_reciteD*4)/$YearEndNumeracy->Total,2);
								echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2); 
									?></td>	
							<td> <?php  echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2)-number_format(($EntryData->numeric1A  + $EntryData->numeric1B*2+ $EntryData->numeric1C*3 + $EntryData->numeric1D*4)/$YearEndOral->Total,2); 
									?></td>
					    </tr>
						 </tbody>
						 </table>	
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of ORAL ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryHindi->oral_hindiA  + $EntryHindi->oral_hindiB*2+ $EntryHindi->oral_hindiC*3 + $EntryHindi->oral_hindiD*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of READING ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryHindi->read_hindiA  + $EntryHindi->read_hindiB*2+ $EntryHindi->read_hindiC*3 + $EntryHindi->read_hindiD*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
				...
				<th colspan="6" style="background: #f44336 !important;">Entry Level Assessment of WRITING ABILITIES (HINDI).</th>
						...
						<tbody>  
					    	<tr>
								...
								<td> <?php  echo number_format(($EntryHindi->write_hindiA  + $EntryHindi->write_hindiB*2+ $EntryHindi->write_hindiC*3 + $EntryHindi->write_hindiD*4)/$YearEndOral->Total,2); 
									?></td>								
					    	</tr>
						 </tbody>
						 </table>
