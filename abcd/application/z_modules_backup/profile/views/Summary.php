                ...
                <div class="card-body" style="background: #e0e0e0;">
                    <div class="row">
                        ...
                        if(isset($PerData->emp_photo) && ($PerData->emp_photo!='NA') ){
                            echo '<img class="img-responsive" src="'.base_url()."img/ProImage/".$PerData->emp_photo.'" width="125" height="145"/>';
                        }else{
                            echo '<img class="img-responsive" src="'.base_url().'img/img-icon.png" width="125" height="145">';
                        }
                        ?>
                        ...
                        <div class="col-md-4">
                            ...
                            elseif ($PerData->emp_title==4) { $title='Dr.'; } 
                            else {  $title=''; }
