        ...
        <div class="card mb-3">
            ...
            <div class="card-body shape-shadow" style="padding: 0.25rem!important;background:#ffffff!important;"> 
                <div class="accordion_container">
                     <!--======================================= PERSONAL DETAILS ======================================-->
                    <div class="accordion_head"><i class="fas fa-user" style="padding:10px 13px; border:1px solid;background: #014a69; color: #ffffff!important;"></i>&nbsp;PROFILE SUMMARY<span class="plusminus">-</span></div>
                    <div class="accordion_body" style="display: block;">
                        <?php echo $this->load->view('Summary',array())?>
                    </div>
                    <!--======================================= PERSONAL DETAILS ======================================-->
...
$('#pdfpro').click(function() {
    ...
    pdf.text('Profile_Summary - '+EmpInfo, 20,20);
    //pdf.text("Centered text",{align: "center"},250,15);
    pdf.addHTML($("#Summary_PDF"), 10, 25, options, function() {
        pdf.save('Profile_Summary_'+EmpInfo+'_'+cDateTime+'.pdf');
    });
});
$('#pdf1').click(function() {
    var options = {
