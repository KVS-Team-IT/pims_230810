<script>
    ...
    var oTable = $('#dataTableId').dataTable( {
        ...
        "ajax":{
            "url": "<?php echo site_url('proposal/region_post_report'); ?>",
            'dataType': 'json',
            'type': 'POST',
        ...
        "columns": [
                ...
                { "data": "code" },
                {
                    "orderable": false,
                    "render": function (data, type, row) {
                        return '<div class="col-md-4 p-0"></div><div class="col-md-4 p-0"><a href="<?php echo site_url(); ?>postproposal-details-ro/'+row.id+'">View Proposal</a></div>';
                    }
                },
