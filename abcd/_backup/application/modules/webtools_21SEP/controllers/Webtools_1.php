        ...
        if($ObsData = $this->input->post(null, true)) {
            ...
            if ($response == 1) {
                ...
                $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, $EmpFor);
                    ...
                    $html.='<h2><u>Introduction to the lesson / topic::</u></h2>';
                    ...
                    $html.='<h3>(ii) Whether the teacher has accommodated slow/bright learners in her planning:</h3>';
                    $html.='<p style="font-weight: normal!important;">'.$ObsData['learner_skill'].'</p>';
                    $html.='<h2><u>Observations on::</u></h2>';
                    $html.='<h3>(i) Interaction between the teacher & the student:</h3>';
                    ...
                    $html.='<h3>(ii) Application of TLM & use of audio-visual aid including ICT:</h3>';
                    ...
                    $html.='<h3>(iii) Involvement of the students:</h3>';
                    ...
                    $html.='<h3>(IV) Assignments or activities in asynchronous mode:</h3>';
