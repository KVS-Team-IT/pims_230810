...
<div id="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <?php 
                        ...
                        ?>
                    <?php echo '<br><div style="font-weight: bold; font-size: 24px; color: #aaa; letter-spacing: 5px; text-shadow: 1px 1px #1a1a1a;">'.strtoupper($UD->PLACE).'</div><hr><div style="color: #f36d1b;font-size: 18px;">'.$UD->NAME;?></div>
                </div>
            <div class="col-md-4">
                <?php if($this->role_id==6){ ?>
                        ...
                        <a href="<?php echo base_url(''); ?>img/PIMS-Document1.0.pdf" target="_blank">
                            ...
                            &nbsp;&nbsp;<a style="font-size: 12px; font-weight: bold; color:#014A69;">Employee Service Data Update Process Document<img src="<?php echo base_url(''); ?>img/new-gif-image.gif" height="25"></a>
                        </a>
                        <hr>
                        <a href="<?php echo base_url(''); ?>img/PIMS-Document 2.0.pdf" target="_blank">
                            <i class="fas fa-download" style="font-size: 22px; color:#F44336;"></i>
                        &nbsp;&nbsp;<a style="font-size: 12px; font-weight: bold; color:#014A69;">Employee Profile Transfer Process Document<img src="<?php echo base_url(''); ?>img/new-gif-image.gif" height="25"></a>
                        </a>
                        <?php if($this->role_id==3){ ?>
                        <hr>
                        <a href="<?php echo base_url(''); ?>img/PIMS-Document 3.0.pdf" target="_blank">
                            <i class="fas fa-download" style="font-size: 22px; color:#F44336;"></i>
                        &nbsp;&nbsp;<a style="font-size: 12px; font-weight: bold; color:#014A69;">Assign External Observer for Class Observation<img src="<?php echo base_url(''); ?>img/new-gif-image.gif" height="25"></a>
                        </a>    
                        <?php } ?>
    ...
    background-color: rgb(240 15 0);">
        <em>For any Query / Support / Feedback Please Write us on the PIMS Portal Support Mail Id: <a href="mailto:kvspims@gmail.com"><u>kvspims@gmail.com</u></a> with Your KV/RO/ZIET Code And If the query is Employee Specific then mention the Employee Code with Designation and Subject(if any).</em>
    </div>
    ...
    <div id="myModal" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-justify">
                <h6 class="text-warning">The vacancy position of staff of your Vidyalaya for the session 2021-22 has been updated in the PIMS portal.</h6>
				<hr>
				
				<p>Kindly, Check the In-position employees data against the sanctioned post data.</p>
				<p>The Surplus staff position will be highlighted in Red color in the <a href="<?php echo base_url('/vacancy-report'); ?>">post strength report</a> menu under MIS Report. Kindly verify the sanctioned strength of your Vidyalaya for session 2021-22.</p>
				<h6 class="text-warning">To update the employee's employment status, please follow the steps on the PIMS portal...</h6>
				<hr>
				<ul>
					<li>Log on to the PIMS portal from the Unit head (KV / RO / ZIET / KVS Estt. 1, and KVS Estt. 2&3) login credential.</li>
					...
					<li>Check and Unlock the employee profile.
						<ul>
						 ...
						 <li>- If it shows "Locked " then click on the Locked button, A pop-up window will appear then click on agree button to unlock the employee profile.</li>
						</ul>
					</li>
					<li>After unlocking the employee Profile, to edit/update the employee data click on EDIT EMPLOYEE DATA from the left-side menu.</li>
					...
					<li>From the Personal tab go to the "Present Posting Details " section and update the Employment Status & Effective date of Employment Status field and then press Save & Next button.</li>
				</ul>
            </div>
