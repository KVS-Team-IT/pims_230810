...
<ul class="sidebar navbar-nav">
    ...
    <li class="active nav-item <?php if (strpos($cur_url, 'home') !== false){echo'menu_active active'; }?>">
    ...
    <li class="active nav-item dropdown <?php if (
            strpos($cur_url, 'web-tools') !== false
        ||  strpos($cur_url, 'observed-data') !== false
        ) {  echo'menu_active '; } ?>">
        <a class="nav-link dropdown-toggle" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown" x-placement="top-start" >
            <a class="dropdown-item" href="<?php echo site_url('web-tools'); ?>">
