...
<div id="content-wrapper">
	...
	<ol class="breadcrumb">
        ...
        <!-- ========================= Data Tables Start ========================== -->
	<div class="card mb-3">
            <div class="card-header"><i class="fa fa-users"></i> Registered Employee Master Data
            <?php if(has_permission('menu-user')){ ?>
                <a href="<?php echo base_url().'add-an-employee'?>" class="btn btn-warning" style="float:right; line-height:5px; margin-left: 10px!important;"><i class="fa fa-plus-circle"></i>&nbsp;Add Employee</a>
                
                <a href="<?php echo base_url().'add-bulk-employee'?>" class="btn btn-success" style="float:right; line-height:5px;"><i class="fa fa-plus-circle"></i>&nbsp;Add Bulk Employee</a>	
            <?php } ?>
            </div>
    ...
    <!-- END CONTENT -->
    <?php echo $this->load->view("admin/js/users/eusers_js",'',true); ?> 
    <script>
