    ...
    <div class="card-body shape-shadow">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("role_id", array("" => "Select Level") + role_lists(), isset($users->role_id) ? set_value('role_id', $users->role_id) : set_value('role_id'), 'class="form-control role" onchange="processRegionDiv();" id="role_id" data-id="c" autocomplete="off"'); ?>
            ...
            <div class="form-group col-md-4" id="category">
                ...
                <div class="col-sm-12">
                    <select class="form-control" name="role_category" id="role_category" autocomplete="off">
            ...
            <div class="form-group col-md-4" id="region_div" style="display:none;">
                ...
                <div class="col-sm-12">
                    ...
                    <select required class="form-control region" name="region_id" id="c_region" data-id="c" autocomplete="off">
            ...
            <div class="form-group col-md-4" id="school_div" style="display:none;">
                ...
                <div class="col-sm-12">
                    <select required class="form-control" onchange="getschoolcode();" name="school_id" id="c_school" data-id="c" autocomplete="off">
            ...
            <div class="form-group col-md-4" id="kvcode_div" style="display:none;">
                ...
                <div class="col-sm-12">
                    <?php echo form_input("kv_code", '', 'readonly id="kv_code" class=" validate[required] form-control" autocomplete="off"'); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <input type="text" name="username" value="<?php echo isset($users->username) ? set_value('username', $users->username) : set_value('username'); ?>" class="form-control noSpace" maxlength="20" minlength="6" placeholder="User Name" autocomplete="off">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <input type="text" name="email_id" value="<?php echo isset($users->email_id) ? set_value('email_id', $users->email_id) : set_value('email_id'); ?>" class="form-control noSpace" maxlength="30" minlength="6" placeholder="Email Id" autocomplete="off">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <input type="text" name="password" id="password" class="form-control password" value="" minlength="8" autocomplete="off" placeholder="Password" autocomplete="off">
