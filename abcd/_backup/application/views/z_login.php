...
<body class="login-bg">
	...
	<span class="error"><?php echo form_error('username');?></span>
        ...
        <div class="form-group clear">
            <div class="row">
            <div class="col-sm-6">
            <label style="color: #0c304a;font-size: 12px;margin-bottom: 10px;">Can't read the code? &nbsp; &nbsp;<a href="javascript:void(0)" id="refresh_captcha"><img src="<?php echo base_url();?>img/refresh.png" title="Refresh Captcha"></a></label>
