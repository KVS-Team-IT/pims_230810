    ...
    <div class="container-fluid" style="width:85%!important;">
		<div class="card mb-3">
           <div class="card-header text-center" style="padding-bottom: 0px !important;">
			...
			Admission 2021-22 Student Information
			</label>
        </div> 
		 <hr>
        <div class="card mb-3">
            <div class="card-header"><i class="fas fa-note"></i>Class -1 Admission Data - 2021-22</div>
			...
			<div class="row">
                    ...
                    <div class="col-md-4">
                        <?php echo form_dropdown("region_id", array("" => "Select Region") + masterregion_lists(), isset($details->region_id) ? set_value('region_id', $details->region_id) : set_value('region_id'),  'class="validate[required] form-control" autocomplete="off" id="region_id" onchange="GetKVListing(this.value)"');
				...
				<div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <?php echo form_input("adminssion_no", isset($details->adminssion_no) ? set_value('adminssion_no', $details->adminssion_no) : set_value('adminssion_no'), 'class="txtOnly validate[required] form-control" autocomplete="off"');
			...
			<div class="row">
				...
				<div class="row">
                    ...
                    <div class="col-md-4">
					  <?php echo form_input("parent_mobile_no", isset($details->parent_mobile_no) ? set_value('parent_mobile_no', $details->parent_mobile_no) : set_value('parent_mobile_no'), 'class="validate[required] form-control" autocomplete="off"');
                    ...
                    <div class="col-md-4">
					 <?php echo form_input("parent_email_id", isset($details->parent_email_id) ? set_value('parent_email_id', $details->parent_email_id) : set_value('parent_email_id'), 'class="txtOnly validate[required] form-control" autocomplete="off"');
				...
				<div class="col-md-2">
					...
					<select name="oral_language_eng" class="form-control"> 
							<option value="">Choose</option>
							<option value="Shows hesitation / faces difficulties in responding; needs support" <?php echo  set_select('oral_language_eng', 'Shows hesitation / faces difficulties in responding; needs support'); ?>>Shows hesitation / faces difficulties in responding; needs support </option>
							...
							<option value="Speaks audibly and but struggles to express thoughts, feelings, and ideas clearly" <?php echo  set_select('oral_language_eng', 'Speaks audibly and but struggles to express thoughts, feelings, and ideas clearly'); ?>>Speaks audibly and but struggles to express thoughts, feelings, and ideas clearly. </option>
...
<script type="text/javascript">
    <?php /*if(($details) && !empty($details)){ ?>
        $("#year_of_establish").val("<?php echo $details->year_of_establish;?>").trigger("change");
    <?php } */?> 
