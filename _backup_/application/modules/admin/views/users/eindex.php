...
<div id="content-wrapper">
	...
	<!-- DataTables Example -->
	<div class="card mb-3">
            <div class="card-header"><i class="fa fa-users"></i> Registered Employee List
            <?php if(has_permission('menu-user')){ ?>
                <a href="<?php echo base_url().'add-employee'?>" class="btn btn-warning" style="float:right; line-height:5px;"><i class="fa fa-plus-circle"></i>&nbsp;Add Employee</a>	
            <?php } ?>
            </div>
