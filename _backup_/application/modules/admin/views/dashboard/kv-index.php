...
<html lang="en">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Breadcrumbs-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">REGIONAL OFFICE DASHBOARD</a></li>
        ...
        <div class="row ml-1 mr-1">
            <div class="col-md-12 text-center btn btn-block bg-primary text-white" style=" line-height: 50px; font-size: 18px;">
                <?php //show($RO); 
                    echo strtoupper(str_replace("KV","KENDRIYA VIDYALAYA - ",$KV->KV_NAME));
                ?>
            </div>
        </div>
        <hr>
...
valueAxis.title.text = "Designation  / Subject Wise";
