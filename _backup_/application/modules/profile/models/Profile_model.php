...
class Profile_model extends CI_Model {
    ...
    public function getProfessionalQualification($ExEc = NULL){
        ...
        WHEN prof_education=6 THEN 'B.P.Ed'
        WHEN prof_education=7 THEN 'M.P.Ed'
        WHEN prof_education=8 THEN 'B.Lib'
        WHEN prof_education=9 THEN 'M.Lib'
        WHEN prof_education=10 THEN 'BFA'
	...
	$this->db->where('emp_code', $this->session->userdata('master_code'));
