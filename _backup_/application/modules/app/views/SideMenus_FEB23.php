...
<ul class="sidebar navbar-nav">
    ...
    <li class="active nav-item dropdown  <?php if (
        ...
        <?php if($this->role_id==2 && $this->role_category==1){
                
            }else if($this->role_id==2 && $this->role_category==2){
            
            }else if($this->role_id==2 && $this->role_category==4){
            
            }else if($this->role_id==2 && $this->role_category==5){
            
            }else if($this->role_id==2 && $this->role_category==6){
            
            }else if($this->role_id==2 && $this->role_category==7){
            
            }else if($this->role_id==2 && $this->role_category==8){
            
            }else if($this->role_id==2 && $this->role_category==9){
