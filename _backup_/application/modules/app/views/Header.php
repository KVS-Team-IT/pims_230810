...
<head>
  ...
  <link rel="icon" href="<?php echo base_url(); ?>img/favicon.ico" type="image/x-icon">
    ...
    <script src="<?php echo base_url(); ?>vendor/datatable/jquery.table.transpose.min.js"></script>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        <div class="row  col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <h6 style="margin-bottom: 0; color: #ff8d17!important;font-size: 16px;text-shadow: 1px 1px 1px #1a1a1a;">केंद्रीय विद्यालय संगठन </h6>
                    <div class="clearfix"></div>
                    <span style="text-shadow: 1px 1px 1px #1a1a1a;letter-spacing: 1px;color: #f8f8f9;font-size: 12.7px;">KENDRIYA VIDYALAYA SANGATHAN</span>
                    <div class="clearfix"></div>
                    <small style="color: #54a706; text-shadow: 1px 1px 1px #1a1a1a; font-size: 75% !important">शिक्षा  मंत्रालय  भारत  सरकार  के  अधीन  एवं  स्वायत्त  निकाय</small>
                    <div class="clearfix"></div>
                    <small style="color: #54a706; text-shadow: 1px 1px 1px #1a1a1a; font-size: 75% !important;position: absolute;margin-top: -5px;">An Autonomous Body Under Ministry of Education,<br> 
                ...
                <div class="row text-center">
                    <div class="col-sm-12">
                        <label style="letter-spacing: 7px;margin-bottom: -4px;color: #FF9800;text-shadow: 1px 1px 0px #4c9b0b;font-size: 24px;font-family: auto;">
                            <img src="<?php echo base_url(); ?>img/PIMS.png" alt="Digital India" width="25" height="25" style=" margin-top: -8px; margin-right: 3px;">PIMS
                        </label>
                        <hr>
                        <label style="letter-spacing: 2px;font-size: 14px;color: #ffffff; font-family: sans-serif;text-shadow: 1px 1px 5px #1a1a1a;">[ Personnel Information Management System ]</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6 px-5">
                            <a href="http://digitalindiaportal.co.in/" title="Digital India" target="_blank">
                                <img src="<?php echo base_url(); ?>img/digital-ind.png" alt="Digital India" width="175" height="75">
					</a>
                        </div>
                        <div class="col-sm-6">
