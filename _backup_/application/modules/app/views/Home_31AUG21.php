    ...
    <div id="myModal" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-justify">
                <h6 class="text-warning">The vacancy position of staff of your Unit (KVS(HQ)/RO/ZIET/KV) for the session 2021-22 has been updated in the PIMS portal.</h6>
				<hr>
				<ul>
				<li><p>Kindly, Check the In-position employees data against the sanctioned post data.</p></li>
				<li><p>The Surplus staff position will be highlighted in Red color in the <a href="<?php echo base_url('/vacancy-report'); ?>">post strength report</a> menu under MIS Report. Kindly verify the sanctioned strength of your Unit (KVS(HQ)/RO/ZIET/KV) for session 2021-22.</p></li>
				</ul>
				<h6 class="text-warning">To update the employee's employment status of those employees who have - Retired, Resigned, VRS, Deputation, LIEN, Long Leave, Terminate or Dead, etc...</br> Please follow the steps on the PIMS portal...</h6>
				<hr>
				<ul>
					...
					<li>From the Personal tab go to the "Present Posting Details " section and update the "Employment Status" & "Effective date of Employment Status" field and Submit the data (Save & Next).</li>
				</ul>
            </div>
