                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("obs_name",isset($DB['obs_name']) ? set_value('obs_name', $DB['obs_name']) : set_value('obs_name',$OD->OBS), 'placeholder=" " id="obs_name" class="txtOnly validate[required] form-control" autocomplete="off"'); ?>
