                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                The Teacher using following ICT resources - <br/>
                            <div class="form-check">
                            <?php
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="font-size:20px;">&#9632;&nbsp;</span>Whether writing assignment was given & collected back as image/pdf and correction done?
                                <div class="col-sm-12">&emsp;
                                <?php
                                foreach(opt_yes_no() as $O=>$R){
