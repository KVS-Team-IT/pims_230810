...
<div id="content-wrapper">
    ...
    <div class="card-body">
        ...
        <h5>Select School for Observation :<hr></h5>
        <div class="row">
            <div class="form-group col-md-3" id="region_div_initial">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("initial_region_id", array("" => "Select") + masterregion_lists(),'', 'id="initial_region_id" onchange="processSchoolInitialDiv();"  class="form-control validate[required]" ');    ?>
        ...
        <h5><hr>Select Observer for Class Observation :<hr></h5>
        <div class="row">
        ...
        <div class="card-body">
                <div class="table-responsive">
                    <table class="table-responsive table-bordered table-sm" id="dataTableId" width="100%" cellspacing="0">
                    <thead>
                        <tr style="background:#014a69!important;color:#ffffff;">
                            ...
                            <!--<th style="text-align:center;">ACTION</th><td style="text-align:center;"><button class="btn btn-danger btn-sm" onclick="DeleteObs('.$V->ID.')"> DELETE</button></td>-->
                        </tr>
                    </thead>
                    <tbody>
                     <?php
                     if(sizeof($OBS)>0){
                         foreach($OBS as $K=>$V){
                             ...
                             echo '<tr><td style="text-align:center;">'.($K+1).'</td><td>'.$V->OBS_ID.'</td><td>'.$V->OBS_NAME.'</td><td>'.$V->OBS_REGION.'</td><td>'.$V->OBS_SCHOOL.'</td><td>'.$V->REGION.'</td><td>'.$V->SCHOOL.'</td><td><button class="btn '.$ACT.' btn-sm">'.$V->OBS_DATE.'</button></td></tr>';
                         }
                     }else{
