                ...
                <div class="background_div">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" >
                            ...
                            <div class="col-sm-12">
                                <?php echo form_input("relieving_date", '', 'placeholder="Relieving Date [dd-mm-yyyy]"  class="datepicker-here form-control future_datepicker validate[required]" autocomplete="off"'); ?>
                                <div class="input-group-addon">
                                    <span class="glyphicon glyphicon-th"></span>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div  style="float: right; margin-bottom: 30px; margin-top: 14px;"> 
                            <input class="btn btn-primary" type="submit" value="Generate Relieving Order">
