          ...
          <button id="print1" class="btn btn-success float-left m-1" autocomplete="off" onclick="printData();"><i class="fas fa-print"></i> Print</button>  
            ...
            <div class="card-body" style="padding: 0px!important;" id="Personal_PDF">              	
            	<div class="table-responsive">                      
						<table class="table">
					    <thead>
					    	<th colspan="3" style="background: #999999 !important;">1. Assessment of Entry Level Abilities of Students of Class-2</th>
					      <tr>
                ...
                <div class="table-responsive">  
					...
					<div class="col-sm-6"> 
					    ...
					    <tbody>
					    	...
					    	<tr>
					    		<td>(ii). Recitation of songs/ poems</td>					    		
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).कक्षा में उपलब्ध प्रकाशित सामग्री/ पुस्तक के बारे में चर्चा एवं वार्तालाप करें। </td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->oral_hindi_i_L1  + $Class2YearEndPreSchl->oral_hindi_i_L2*2+ $Class2YearEndPreSchl->oral_hindi_i_L3*3 + $Class2YearEndPreSchl->oral_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).प्रश्न करने और दूसरों को सुनने के लिए वार्तालाप में व्यस्त रहता है।</td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->oral_hindi_ii_L1  + $Class2YearEndPreSchl->oral_hindi_ii_L2*2+ $Class2YearEndPreSchl->oral_hindi_ii_L3*3 + $Class2YearEndPreSchl->oral_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). गीतों/कविताओं का पाठ</td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->oral_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->oral_hindi_iii_L1  + $Class2YearEndPreSchl->oral_hindi_iii_L2*2+ $Class2YearEndPreSchl->oral_hindi_iii_L3*3 + $Class2YearEndPreSchl->oral_hindi_iii_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndPreSchl->oral_hindi_i_L1+$Class2YearEndPreSchl->oral_hindi_ii_L1+ $Class2YearEndPreSchl->oral_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->oral_hindi_i_L2+$Class2YearEndPreSchl->oral_hindi_ii_L2+ $Class2YearEndPreSchl->oral_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->oral_hindi_i_L3+$Class2YearEndPreSchl->oral_hindi_ii_L3+ $Class2YearEndPreSchl->oral_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->oral_hindi_i_L4+$Class2YearEndPreSchl->oral_hindi_ii_L4+ $Class2YearEndPreSchl->oral_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $YearEndPreOH_A= number_format(($Class2YearEndPreSchl->oral_hindi_i_L1  + $Class2YearEndPreSchl->oral_hindi_i_L2*2+ $Class2YearEndPreSchl->oral_hindi_i_L3*3 + $Class2YearEndPreSchl->oral_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
								$YearEndPreOH_B= number_format(($Class2YearEndPreSchl->oral_hindi_ii_L1  + $Class2YearEndPreSchl->oral_hindi_ii_L2*2+ $Class2YearEndPreSchl->oral_hindi_ii_L3*3 + $Class2YearEndPreSchl->oral_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2);
								$YearEndPreOH_C= number_format(($Class2YearEndPreSchl->oral_hindi_iii_L1  + $Class2YearEndPreSchl->oral_hindi_iii_L2*2+ $Class2YearEndPreSchl->oral_hindi_iii_L3*3 + $Class2YearEndPreSchl->oral_hindi_iii_L4*4)/$Class2YearEndPreSchl->Total,2); 
								echo number_format(($YearEndPreOH_A+$YearEndPreOH_B+$YearEndPreOH_C)/3,2); 
									?></td>	
							<td> <?php  echo number_format(($YearEndPreOH_A+$YearEndPreOH_B+$YearEndPreOH_C)/3,2)-number_format(($EntryPreHindi->oral_hindipreA  + $EntryPreHindi->oral_hindipreB*2+ $EntryPreHindi->oral_hindipreC*3 + $EntryPreHindi->oral_hindipreD*4)/$EntryPreHindi->Total,2); 
									?></td>
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). बाल साहित्य/ पाठ्यपुस्तक से कहानियों को पढ़ता है और सुनाता/पुन: सुनाता है। </td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->read_hindi_i_L1  + $Class2YearEndPreSchl->read_hindi_i_L2*2+ $Class2YearEndPreSchl->read_hindi_i_L3*3 + $Class2YearEndPreSchl->read_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).दिए गए शब्द के वर्णों से नए शब्द बनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->read_hindi_ii_L1  + $Class2YearEndPreSchl->read_hindi_ii_L2*2+ $Class2YearEndPreSchl->read_hindi_ii_L3*3 + $Class2YearEndPreSchl->read_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).8 से 10 वाक्यों की सरल शब्दों की अज्ञात पाठ्य सामग्री को लगभग 30 से 45 शब्द प्रति मिनट की उपयुक्त गति से सही ढंग से और स्पष्टता के साथ पढ़ता है।</td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->read_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->read_hindi_iii_L1  + $Class2YearEndPreSchl->read_hindi_iii_L2*2+ $Class2YearEndPreSchl->read_hindi_iii_L3*3 + $Class2YearEndPreSchl->read_hindi_iii_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndPreSchl->read_hindi_i_L1+$Class2YearEndPreSchl->read_hindi_ii_L1+ $Class2YearEndPreSchl->read_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->read_hindi_i_L2+$Class2YearEndPreSchl->read_hindi_ii_L2+ $Class2YearEndPreSchl->read_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->read_hindi_i_L3+$Class2YearEndPreSchl->read_hindi_ii_L3+ $Class2YearEndPreSchl->read_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->read_hindi_i_L4+$Class2YearEndPreSchl->read_hindi_ii_L4+ $Class2YearEndPreSchl->read_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $YearEndPreOR_A= number_format(($Class2YearEndPreSchl->read_hindi_i_L1  + $Class2YearEndPreSchl->read_hindi_i_L2*2+ $Class2YearEndPreSchl->read_hindi_i_L3*3 + $Class2YearEndPreSchl->read_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
								$YearEndPreOR_B= number_format(($Class2YearEndPreSchl->read_hindi_ii_L1  + $Class2YearEndPreSchl->read_hindi_ii_L2*2+ $Class2YearEndPreSchl->read_hindi_ii_L3*3 + $Class2YearEndPreSchl->read_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2);
								$YearEndPreOR_C= number_format(($Class2YearEndPreSchl->read_hindi_iii_L1  + $Class2YearEndPreSchl->read_hindi_iii_L2*2+ $Class2YearEndPreSchl->read_hindi_iii_L3*3 + $Class2YearEndPreSchl->read_hindi_iii_L4*4)/$Class2YearEndPreSchl->Total,2);
								echo number_format(($YearEndPreOR_A+$YearEndPreOR_B+$YearEndPreOR_C)/3,2); 
									?></td>
							<td> <?php  echo number_format(($YearEndPreOR_A+$YearEndPreOR_B+$YearEndPreOR_C)/3,2)-number_format(($EntryPreHindi->read_hindipreA  + $EntryPreHindi->read_hindipreB*2+ $EntryPreHindi->read_hindipreC*3 + $EntryPreHindi->read_hindipreD*4)/$EntryPreHindi->Total,2); 
									?></td>	
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). स्वयं को अभिव्यक्त करने के लिए छोटे/ सरल वाक्यों को सही ढंग से लिखता है। </td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->writing_hindi_i_L1  + $Class2YearEndPreSchl->writing_hindi_i_L2*2+ $Class2YearEndPreSchl->writing_hindi_i_L3*3 + $Class2YearEndPreSchl->writing_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). संज्ञा शब्दों, क्रिया शब्दों और विराम चिह्नों को पहचानता है।</td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndPreSchl->writing_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndPreSchl->writing_hindi_ii_L1  + $Class2YearEndPreSchl->writing_hindi_ii_L2*2+ $Class2YearEndPreSchl->writing_hindi_ii_L3*3 + $Class2YearEndPreSchl->writing_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndPreSchl->writing_hindi_i_L1+$Class2YearEndPreSchl->writing_hindi_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->writing_hindi_i_L2+$Class2YearEndPreSchl->writing_hindi_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->writing_hindi_i_L3+$Class2YearEndPreSchl->writing_hindi_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndPreSchl->writing_hindi_i_L4+$Class2YearEndPreSchl->writing_hindi_ii_L4)/2,2); ?></td>
								<td> <?php  $writing_hindipreH_r1= number_format(($Class2YearEndPreSchl->writing_hindi_i_L1  + $Class2YearEndPreSchl->writing_hindi_i_L2*2+ $Class2YearEndPreSchl->writing_hindi_i_L3*3 + $Class2YearEndPreSchl->writing_hindi_i_L4*4)/$Class2YearEndPreSchl->Total,2); 
								
								$hindi_drawingpreH_r2= number_format(($Class2YearEndPreSchl->writing_hindi_ii_L1  + $Class2YearEndPreSchl->writing_hindi_ii_L2*2+ $Class2YearEndPreSchl->writing_hindi_ii_L3*3 + $Class2YearEndPreSchl->writing_hindi_ii_L4*4)/$Class2YearEndPreSchl->Total,2); 
								echo number_format(($writing_hindipreH_r1+$hindi_drawingpreH_r2)/2,2); 
									?></td>	
								<td> <?php  echo number_format(($writing_hindipreH_r1+$hindi_drawingpreH_r2)/2,2)-number_format(($EntryPreHindi->write_hindipreA  + $EntryPreHindi->write_hindipreB*2+ $EntryPreHindi->write_hindipreC*3 + $EntryPreHindi->write_hindipreD*4)/$EntryPreHindi->Total,2); 
									?></td>
					...
					<div class="col-sm-6">
					 <table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse and talks about the print available in the classroom.</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->oral_i_L1  + $Class2YearEndNoPreSchl->oral_i_L2*2+ $Class2YearEndNoPreSchl->oral_i_L3*3 + $Class2YearEndNoPreSchl->oral_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).Engages in conversation to ask questions and listens to others</td>					    		
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndNoPreSchl->oral_ii_L1  + $Class2YearEndNoPreSchl->oral_ii_L2*2+ $Class2YearEndNoPreSchl->oral_ii_L3*3 + $Class2YearEndNoPreSchl->oral_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Recitation of songs/ poems</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndNoPreSchl->oral_iii_L1  + $Class2YearEndNoPreSchl->oral_iii_L2*2+ $Class2YearEndNoPreSchl->oral_iii_L3*3 + $Class2YearEndNoPreSchl->oral_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_i_L1+$Class2YearEndNoPreSchl->oral_ii_L1+ $Class2YearEndNoPreSchl->oral_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_i_L2+$Class2YearEndNoPreSchl->oral_ii_L2+ $Class2YearEndNoPreSchl->oral_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_i_L3+$Class2YearEndNoPreSchl->oral_ii_L3+ $Class2YearEndNoPreSchl->oral_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_i_L4+$Class2YearEndNoPreSchl->oral_ii_L4+ $Class2YearEndNoPreSchl->oral_iii_L4)/3,2); ?></td>
								<td> <?php  $oralor_A= number_format(($Class2YearEndNoPreSchl->oral_i_L1  + $Class2YearEndNoPreSchl->oral_i_L2*2+ $Class2YearEndNoPreSchl->oral_i_L3*3 + $Class2YearEndNoPreSchl->oral_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$oralor_B= number_format(($Class2YearEndNoPreSchl->oral_ii_L1  + $Class2YearEndNoPreSchl->oral_ii_L2*2+ $Class2YearEndNoPreSchl->oral_ii_L3*3 + $Class2YearEndNoPreSchl->oral_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$oralor_C= number_format(($Class2YearEndNoPreSchl->oral_iii_L1  + $Class2YearEndNoPreSchl->oral_iii_L2*2+ $Class2YearEndNoPreSchl->oral_iii_L3*3 + $Class2YearEndNoPreSchl->oral_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($oralor_A+$oralor_B+$oralor_C)/3,2); 
									?></td>	
<td> <?php  echo number_format(($oralor_A+$oralor_B+$oralor_C)/3,2)-number_format(($EntryDataNoPre->oral_NoPreA  + $EntryDataNoPre->oral_NoPreB*2+ $EntryDataNoPre->oral_NoPreC*3 + $EntryDataNoPre->oral_NoPreD*4)/$EntryDataNoPre->Total,2); 
									?></td>									
...
<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i).Reads and narrates /retells the stories from children's literature/ textbook</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->reading_i_L1  + $Class2YearEndNoPreSchl->reading_i_L2*2+ $Class2YearEndNoPreSchl->reading_i_L3*3 + $Class2YearEndNoPreSchl->reading_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).Makes new words from the letters of a given word.</td>					    		
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndNoPreSchl->reading_ii_L1  + $Class2YearEndNoPreSchl->reading_ii_L2*2+ $Class2YearEndNoPreSchl->reading_ii_L3*3 + $Class2YearEndNoPreSchl->reading_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Reads unknown text of 8 to 10 sentences with simple words with appropriate speed approximately 30 to 45 words per minute correctly and clarity</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->reading_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndNoPreSchl->reading_iii_L1  + $Class2YearEndNoPreSchl->reading_iii_L2*2+ $Class2YearEndNoPreSchl->reading_iii_L3*3 + $Class2YearEndNoPreSchl->reading_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->reading_i_L1+$Class2YearEndNoPreSchl->reading_ii_L1+ $Class2YearEndNoPreSchl->reading_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->reading_i_L2+$Class2YearEndNoPreSchl->reading_ii_L2+ $Class2YearEndNoPreSchl->reading_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->reading_i_L3+$Class2YearEndNoPreSchl->reading_ii_L3+ $Class2YearEndNoPreSchl->reading_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->reading_i_L4+$Class2YearEndNoPreSchl->reading_ii_L4+ $Class2YearEndNoPreSchl->reading_iii_L4)/3,2); ?></td>
								<td> <?php  $oralrr_A= number_format(($Class2YearEndNoPreSchl->reading_i_L1  + $Class2YearEndNoPreSchl->reading_i_L2*2+ $Class2YearEndNoPreSchl->reading_i_L3*3 + $Class2YearEndNoPreSchl->reading_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$oralrr_B= number_format(($Class2YearEndNoPreSchl->reading_ii_L1  + $Class2YearEndNoPreSchl->reading_ii_L2*2+ $Class2YearEndNoPreSchl->reading_ii_L3*3 + $Class2YearEndNoPreSchl->reading_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$oralrr_C= number_format(($Class2YearEndNoPreSchl->reading_iii_L1  + $Class2YearEndNoPreSchl->reading_iii_L2*2+ $Class2YearEndNoPreSchl->reading_iii_L3*3 + $Class2YearEndNoPreSchl->reading_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($oralrr_A+$oralrr_B+$oralrr_C)/3,2); 
									?></td>		
										<td> <?php  echo number_format(($oralrr_A+$oralrr_B+$oralrr_C)/3,2)-number_format(($EntryDataNoPre->read_NoPreA  + $EntryDataNoPre->read_NoPreB*2+ $EntryDataNoPre->read_NoPreC*3 + $EntryDataNoPre->read_NoPreD*4)/$EntryDataNoPre->Total,2); 
									?></td>	
					...
					<div class="col-sm-6">
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).Writes short/ simple sentences correctly to express herself.</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->writingh_i_L1  + $Class2YearEndNoPreSchl->writingh_i_L2*2+ $Class2YearEndNoPreSchl->writingh_i_L3*3 + $Class2YearEndNoPreSchl->writingh_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Recognises naming words , action words and punctuation marks.</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writingh_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->writingh_ii_L1  + $Class2YearEndNoPreSchl->writingh_ii_L2*2+ $Class2YearEndNoPreSchl->writingh_ii_L3*3 + $Class2YearEndNoPreSchl->writingh_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writingh_i_L1+$Class2YearEndNoPreSchl->writingh_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writingh_i_L2+$Class2YearEndNoPreSchl->writingh_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writingh_i_L3+$Class2YearEndNoPreSchl->writingh_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writingh_i_L4+$Class2YearEndNoPreSchl->writingh_ii_L4)/2,2); ?></td>
								<td> <?php  $writenon_wordwr1= number_format(($Class2YearEndNoPreSchl->writingh_i_L1  + $Class2YearEndNoPreSchl->writingh_i_L2*2+ $Class2YearEndNoPreSchl->writingh_i_L3*3 + $Class2YearEndNoPreSchl->writingh_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$hindi_drawingpreH_wr2= number_format(($Class2YearEndNoPreSchl->writingh_ii_L1  + $Class2YearEndNoPreSchl->writingh_ii_L2*2+ $Class2YearEndNoPreSchl->writingh_ii_L3*3 + $Class2YearEndNoPreSchl->writingh_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($writenon_wordwr1+$hindi_drawingpreH_wr2)/2,2); 
									?></td>	
								<td> <?php  echo number_format(($writenon_wordwr1+$hindi_drawingpreH_wr2)/2,2)-number_format(($EntryDataNoPre->write_NoPreA  + $EntryDataNoPre->write_NoPreB*2+ $EntryDataNoPre->write_NoPreC*3 + $EntryDataNoPre->write_NoPreD*4)/$EntryDataNoPre->Total,2); 
									?></td>		
...
<td> <?php  echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2)-number_format(($EntryDataNoPre->numeric_NoPreA  + $EntryDataNoPre->numeric_NoPreB*2+ $EntryDataNoPre->numeric_NoPreC*3 + $EntryDataNoPre->numeric_NoPreD*4)/$EntryDataNoPre->Total,2); 
					   ...
					   <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Reads and writes numbers up to 999</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_i_L1  + $Class2YearEndNoPreSchl->numeracy_i_L2*2+ $Class2YearEndNoPreSchl->numeracy_i_L3*3 + $Class2YearEndNoPreSchl->numeracy_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Uses addition and subtraction of numbers up to 99, sum not exceeding situations 99 in daily life</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_ii_L1  + $Class2YearEndNoPreSchl->numeracy_ii_L2*2+ $Class2YearEndNoPreSchl->numeracy_ii_L3*3 + $Class2YearEndNoPreSchl->numeracy_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). Performs multiplication as repeated addition and division as equal distribution/ sharing and constructs multiplication facts (tables) of 2, 3 and 4</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_iii_L1  + $Class2YearEndNoPreSchl->numeracy_iii_L2*2+ $Class2YearEndNoPreSchl->numeracy_iii_L3*3 + $Class2YearEndNoPreSchl->numeracy_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iv). Estimates and measure: length distance / capacity using nonstandard uniform units like rod, pencil, thread, cup, spoon, mug etc and compares weight using simple balance</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iv_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iv_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iv_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_iv_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_iv_L1  + $Class2YearEndNoPreSchl->numeracy_iv_L2*2+ $Class2YearEndNoPreSchl->numeracy_iv_L3*3 + $Class2YearEndNoPreSchl->numeracy_iv_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(v). Identifies and describes 2D & 3 D shapes like rectangle, triangle, circle, oval ,cone, cube, cuboid, sphere etc.</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_v_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_v_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_v_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_v_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_v_L1  + $Class2YearEndNoPreSchl->numeracy_v_L2*2+ $Class2YearEndNoPreSchl->numeracy_v_L3*3 + $Class2YearEndNoPreSchl->numeracy_v_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(vi). Uses spatial vocabulary like far /near, in/out, above /below, front/ behind, left/right, top / bottom etc.</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_vi_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_vi_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_vi_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->numeracy_vi_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->numeracy_vi_L1  + $Class2YearEndNoPreSchl->numeracy_vi_L2*2+ $Class2YearEndNoPreSchl->numeracy_vi_L3*3 + $Class2YearEndNoPreSchl->numeracy_vi_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->numeracy_i_L1+$Class2YearEndNoPreSchl->numeracy_ii_L1+ $Class2YearEndNoPreSchl->numeracy_iii_L1 +$Class2YearEndNoPreSchl->numeracy_iv_L1+ $Class2YearEndNoPreSchl->numeracy_v_L1+ $Class2YearEndNoPreSchl->numeracy_vi_L1)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->numeracy_i_L2+$Class2YearEndNoPreSchl->numeracy_ii_L2+ $Class2YearEndNoPreSchl->numeracy_iii_L2 +$Class2YearEndNoPreSchl->numeracy_iv_L2+ $Class2YearEndNoPreSchl->numeracy_v_L2+ $Class2YearEndNoPreSchl->numeracy_vi_L2)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->numeracy_i_L3+$Class2YearEndNoPreSchl->numeracy_ii_L3+ $Class2YearEndNoPreSchl->numeracy_iii_L3 +$Class2YearEndNoPreSchl->numeracy_iv_L3+ $Class2YearEndNoPreSchl->numeracy_v_L3+ $Class2YearEndNoPreSchl->numeracy_vi_L3)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->numeracy_i_L4+$Class2YearEndNoPreSchl->numeracy_ii_L4+ $Class2YearEndNoPreSchl->numeracy_iii_L4 +$Class2YearEndNoPreSchl->numeracy_iv_L4+ $Class2YearEndNoPreSchl->numeracy_v_L4+ $Class2YearEndNoPreSchl->numeracy_vi_L4)/6,2); ?></td>
							<td> <?php  $NUM_A= number_format(($Class2YearEndNoPreSchl->numeracy_i_L1  + $Class2YearEndNoPreSchl->numeracy_i_L2*2+ $Class2YearEndNoPreSchl->numeracy_i_L3*3 + $Class2YearEndNoPreSchl->numeracy_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$NUM_B= number_format(($Class2YearEndNoPreSchl->numeracy_ii_L1  + $Class2YearEndNoPreSchl->numeracy_ii_L2*2+ $Class2YearEndNoPreSchl->numeracy_ii_L3*3 + $Class2YearEndNoPreSchl->numeracy_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$NUM_C= number_format(($Class2YearEndNoPreSchl->numeracy_iii_L1  + $Class2YearEndNoPreSchl->numeracy_iii_L2*2+ $Class2YearEndNoPreSchl->numeracy_iii_L3*3 + $Class2YearEndNoPreSchl->numeracy_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$NUM_D= number_format(($Class2YearEndNoPreSchl->numeracy_iv_L1  + $Class2YearEndNoPreSchl->numeracy_iv_L2*2+ $Class2YearEndNoPreSchl->numeracy_iv_L3*3 + $Class2YearEndNoPreSchl->numeracy_iv_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$NUM_E= number_format(($Class2YearEndNoPreSchl->numeracy_v_L1  + $Class2YearEndNoPreSchl->numeracy_v_L2*2+ $Class2YearEndNoPreSchl->numeracy_v_L3*3 + $Class2YearEndNoPreSchl->numeracy_v_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$NUM_F= number_format(($Class2YearEndNoPreSchl->numeracy_vi_L1  + $Class2YearEndNoPreSchl->numeracy_vi_L2*2+ $Class2YearEndNoPreSchl->numeracy_vi_L3*3 + $Class2YearEndNoPreSchl->numeracy_vi_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2); 
									?></td>	
<td> <?php  echo number_format(($NUM_A+$NUM_B+$NUM_C+$NUM_D+$NUM_E+$NUM_F)/6,2)-number_format(($EntryDataNoPre->numeric_NoPreA  + $EntryDataNoPre->numeric_NoPreB*2+ $EntryDataNoPre->numeric_NoPreC*3 + $EntryDataNoPre->numeric_NoPreD*4)/$EntryDataNoPre->Total,2); 
									?></td>									
	...
	<td> <?php  echo number_format(($oral_non1+$oral_conveynon2+$oral_storynon3)/3,2)-number_format(($EntryNoPreHindi->oral_hindinopreA  + $EntryNoPreHindi->oral_hindinopreB*2+ $EntryNoPreHindi->oral_hindinopreC*3 + $EntryNoPreHindi->oral_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
						...
						<tbody>  
					    	<tr>
					    		<td>(i).कक्षा में उपलब्ध प्रकाशित सामग्री/ पुस्तक के बारे में चर्चा एवं वार्तालाप करें। </td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L1  + $Class2YearEndNoPreSchl->oral_hindi_i_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_i_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).प्रश्न करने और दूसरों को सुनने के लिए वार्तालाप में व्यस्त रहता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->oral_hindi_ii_L1  + $Class2YearEndNoPreSchl->oral_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). गीतों/कविताओं का पाठ</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->oral_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->oral_hindi_iii_L1  + $Class2YearEndNoPreSchl->oral_hindi_iii_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_iii_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>  
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L1+$Class2YearEndNoPreSchl->oral_hindi_ii_L1+ $Class2YearEndNoPreSchl->oral_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L2+$Class2YearEndNoPreSchl->oral_hindi_ii_L2+ $Class2YearEndNoPreSchl->oral_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L3+$Class2YearEndNoPreSchl->oral_hindi_ii_L3+ $Class2YearEndNoPreSchl->oral_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L4+$Class2YearEndNoPreSchl->oral_hindi_ii_L4+ $Class2YearEndNoPreSchl->oral_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $oral_non1= number_format(($Class2YearEndNoPreSchl->oral_hindi_i_L1  + $Class2YearEndNoPreSchl->oral_hindi_i_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_i_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$oral_conveynon2= number_format(($Class2YearEndNoPreSchl->oral_hindi_ii_L1  + $Class2YearEndNoPreSchl->oral_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$oral_storynon3= number_format(($Class2YearEndNoPreSchl->oral_hindi_iii_L1  + $Class2YearEndNoPreSchl->oral_hindi_iii_L2*2+ $Class2YearEndNoPreSchl->oral_hindi_iii_L3*3 + $Class2YearEndNoPreSchl->oral_hindi_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								//echo $oral_non1.'-'.$oral_conveynon2.'-'.$oral_storynon3;
								echo number_format(($oral_non1+$oral_conveynon2+$oral_storynon3)/3,2); 
									?></td>			
	<td> <?php  echo number_format(($oral_non1+$oral_conveynon2+$oral_storynon3)/3,2)-number_format(($EntryNoPreHindi->oral_hindinopreA  + $EntryNoPreHindi->oral_hindinopreB*2+ $EntryNoPreHindi->oral_hindinopreC*3 + $EntryNoPreHindi->oral_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
...
<td> <?php  echo number_format(($read_storynon1+$read_soundnon2+$read_wordnon3)/3,2)-number_format(($EntryNoPreHindi->read_hindinopreA  + $EntryNoPreHindi->read_hindinopreB*2+ $EntryNoPreHindi->read_hindinopreC*3 + $EntryNoPreHindi->read_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
						...
						<tbody>  
					    	<tr>
					    		<td>(i). बाल साहित्य/ पाठ्यपुस्तक से कहानियों को पढ़ता है और सुनाता/पुन: सुनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->read_hindi_i_L1  + $Class2YearEndNoPreSchl->read_hindi_i_L2*2+ $Class2YearEndNoPreSchl->read_hindi_i_L3*3 + $Class2YearEndNoPreSchl->read_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). दिए गए शब्द के वर्णों से नए शब्द बनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->read_hindi_ii_L1  + $Class2YearEndNoPreSchl->read_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->read_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->read_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). 8 से 10 वाक्यों की सरल शब्दों की अज्ञात पाठ्य सामग्री को लगभग 30 से 45 शब्द प्रति मिनट की उपयुक्त गति से सही ढंग से और स्पष्टता के साथ पढ़ता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->read_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->read_hindi_iii_L1  + $Class2YearEndNoPreSchl->read_hindi_iii_L2*2+ $Class2YearEndNoPreSchl->read_hindi_iii_L3*3 + $Class2YearEndNoPreSchl->read_hindi_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>  
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->read_hindi_i_L1+$Class2YearEndNoPreSchl->read_hindi_ii_L1+ $Class2YearEndNoPreSchl->read_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->read_hindi_i_L2+$Class2YearEndNoPreSchl->read_hindi_ii_L2+ $Class2YearEndNoPreSchl->read_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->read_hindi_i_L3+$Class2YearEndNoPreSchl->read_hindi_ii_L3+ $Class2YearEndNoPreSchl->read_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->read_hindi_i_L4+$Class2YearEndNoPreSchl->read_hindi_ii_L4+ $Class2YearEndNoPreSchl->read_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $read_storynon1= number_format(($Class2YearEndNoPreSchl->read_hindi_i_L1  + $Class2YearEndNoPreSchl->read_hindi_i_L2*2+ $Class2YearEndNoPreSchl->read_hindi_i_L3*3 + $Class2YearEndNoPreSchl->read_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$read_soundnon2= number_format(($Class2YearEndNoPreSchl->read_hindi_ii_L1  + $Class2YearEndNoPreSchl->read_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->read_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->read_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								$read_wordnon3= number_format(($Class2YearEndNoPreSchl->read_hindi_iii_L1  + $Class2YearEndNoPreSchl->read_hindi_iii_L2*2+ $Class2YearEndNoPreSchl->read_hindi_iii_L3*3 + $Class2YearEndNoPreSchl->read_hindi_iii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($read_storynon1+$read_soundnon2+$read_wordnon3)/3,2); 
									?></td>		
<td> <?php  echo number_format(($read_storynon1+$read_soundnon2+$read_wordnon3)/3,2)-number_format(($EntryNoPreHindi->read_hindinopreA  + $EntryNoPreHindi->read_hindinopreB*2+ $EntryNoPreHindi->read_hindinopreC*3 + $EntryNoPreHindi->read_hindinopreD*4)/$EntryNoPreHindi->Total,2); 
									?></td>									
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). स्वयं को अभिव्यक्त करने के लिए छोटे/ सरल वाक्यों को सही ढंग से लिखता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L1  + $Class2YearEndNoPreSchl->writing_hindi_i_L2*2+ $Class2YearEndNoPreSchl->writing_hindi_i_L3*3 + $Class2YearEndNoPreSchl->writing_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).संज्ञा शब्दों, क्रिया शब्दों और विराम चिह्नों को पहचानता है।</td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndNoPreSchl->writing_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndNoPreSchl->writing_hindi_ii_L1  + $Class2YearEndNoPreSchl->writing_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->writing_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->writing_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
									?></td>								
					    	</tr> 
					    	 <tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L1+$Class2YearEndNoPreSchl->writing_hindi_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L2+$Class2YearEndNoPreSchl->writing_hindi_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L3+$Class2YearEndNoPreSchl->writing_hindi_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L4+$Class2YearEndNoPreSchl->writing_hindi_ii_L4)/2,2); ?></td>
								<td> <?php  $writing_hindinon1= number_format(($Class2YearEndNoPreSchl->writing_hindi_i_L1  + $Class2YearEndNoPreSchl->writing_hindi_i_L2*2+ $Class2YearEndNoPreSchl->writing_hindi_i_L3*3 + $Class2YearEndNoPreSchl->writing_hindi_i_L4*4)/$Class2YearEndNoPreSchl->Total,2); 
								$hindi_drawingnon2= number_format(($Class2YearEndNoPreSchl->writing_hindi_ii_L1  + $Class2YearEndNoPreSchl->writing_hindi_ii_L2*2+ $Class2YearEndNoPreSchl->writing_hindi_ii_L3*3 + $Class2YearEndNoPreSchl->writing_hindi_ii_L4*4)/$Class2YearEndNoPreSchl->Total,2);
								echo number_format(($writing_hindinon1+$hindi_drawingnon2)/2,2); 
									?></td>	
					...
					<div class="col-sm-6">
					 <table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse and talks about the print available in the classroom.</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->oral_i_L1  + $Class2YearEndParentEdu->oral_i_L2*2+ $Class2YearEndParentEdu->oral_i_L3*3 + $Class2YearEndParentEdu->oral_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).Engages in conversation to ask questions and listens to others</td>					    		
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndParentEdu->oral_ii_L1  + $Class2YearEndParentEdu->oral_ii_L2*2+ $Class2YearEndParentEdu->oral_ii_L3*3 + $Class2YearEndParentEdu->oral_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Recites rhymes/songs/poems with action</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndParentEdu->oral_iii_L1  + $Class2YearEndParentEdu->oral_iii_L2*2+ $Class2YearEndParentEdu->oral_iii_L3*3 + $Class2YearEndParentEdu->oral_iii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_i_L1+$Class2YearEndParentEdu->oral_ii_L1+ $Class2YearEndParentEdu->oral_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_i_L2+$Class2YearEndParentEdu->oral_ii_L2+ $Class2YearEndParentEdu->oral_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_i_L3+$Class2YearEndParentEdu->oral_ii_L3+ $Class2YearEndParentEdu->oral_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_i_L4+$Class2YearEndParentEdu->oral_ii_L4+ $Class2YearEndParentEdu->oral_iii_L4)/3,2); ?></td>
								<td> <?php  $oralorp_A= number_format(($Class2YearEndParentEdu->oral_i_L1  + $Class2YearEndParentEdu->oral_i_L2*2+ $Class2YearEndParentEdu->oral_i_L3*3 + $Class2YearEndParentEdu->oral_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$oralorp_B= number_format(($Class2YearEndParentEdu->oral_ii_L1  + $Class2YearEndParentEdu->oral_ii_L2*2+ $Class2YearEndParentEdu->oral_ii_L3*3 + $Class2YearEndParentEdu->oral_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$oralorp_C= number_format(($Class2YearEndParentEdu->oral_iii_L1  + $Class2YearEndParentEdu->oral_iii_L2*2+ $Class2YearEndParentEdu->oral_iii_L3*3 + $Class2YearEndParentEdu->oral_iii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($oralorp_A+$oralorp_B+$oralorp_C)/3,2); 
									?></td>		
<td> <?php  echo number_format(($oralorp_A+$oralorp_B+$oralorp_C)/3,2)- number_format(($EntryDataEdu->oral_EduA  + $EntryDataEdu->oral_EduB*2+ $EntryDataEdu->oral_EduC*3 + $EntryDataEdu->oral_EduD*4)/$EntryDataEdu->Total,2); 
									?></td>										
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Reads and narrates /retells the stories from children's literature/ textbook</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->reading_i_L1  + $Class2YearEndParentEdu->reading_i_L2*2+ $Class2YearEndParentEdu->reading_i_L3*3 + $Class2YearEndParentEdu->reading_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii). Makes new words from the letters of a given word.</td>					    		
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndParentEdu->reading_ii_L1  + $Class2YearEndParentEdu->reading_ii_L2*2+ $Class2YearEndParentEdu->reading_ii_L3*3 + $Class2YearEndParentEdu->reading_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Reads unknown text of 8 to 10 sentences with simple words with appropriate speed approximately 30 to 45 words per minute correctly and clarity</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->reading_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndParentEdu->reading_iii_L1  + $Class2YearEndParentEdu->reading_iii_L2*2+ $Class2YearEndParentEdu->reading_iii_L3*3 + $Class2YearEndParentEdu->reading_iii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->reading_i_L1+$Class2YearEndParentEdu->reading_ii_L1+ $Class2YearEndParentEdu->reading_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->reading_i_L2+$Class2YearEndParentEdu->reading_ii_L2+ $Class2YearEndParentEdu->reading_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->reading_i_L3+$Class2YearEndParentEdu->reading_ii_L3+ $Class2YearEndParentEdu->reading_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->reading_i_L4+$Class2YearEndParentEdu->reading_ii_L4+ $Class2YearEndParentEdu->reading_iii_L4)/3,2); ?></td>
								<td> <?php  $oralrrp_A= number_format(($Class2YearEndParentEdu->reading_i_L1  + $Class2YearEndParentEdu->reading_i_L2*2+ $Class2YearEndParentEdu->reading_i_L3*3 + $Class2YearEndParentEdu->reading_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$oralrrp_B= number_format(($Class2YearEndParentEdu->reading_ii_L1  + $Class2YearEndParentEdu->reading_ii_L2*2+ $Class2YearEndParentEdu->reading_ii_L3*3 + $Class2YearEndParentEdu->reading_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$oralrrp_C= number_format(($Class2YearEndParentEdu->reading_iii_L1  + $Class2YearEndParentEdu->reading_iii_L2*2+ $Class2YearEndParentEdu->reading_iii_L3*3 + $Class2YearEndParentEdu->reading_iii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($oralrrp_A+$oralrrp_B+$oralrrp_C)/3,2); 
									?></td>	<td> <?php  echo number_format(($oralrrp_A+$oralrrp_B+$oralrrp_C)/3,2)-number_format(($EntryDataEdu->read_EduA  + $EntryDataEdu->read_EduB*2+ $EntryDataEdu->read_EduC*3 + $EntryDataEdu->read_EduD*4)/$EntryDataEdu->Total,2); 
									?></td>								
					    	</tr> 
					...
					<div class="col-sm-6">
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Writes short/ simple sentences correctly to express herself. </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->writingh_i_L1  + $Class2YearEndParentEdu->writingh_i_L2*2+ $Class2YearEndParentEdu->writingh_i_L3*3 + $Class2YearEndParentEdu->writingh_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Recognises naming words , action words and punctuation marks. </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writingh_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->writingh_ii_L1  + $Class2YearEndParentEdu->writingh_ii_L2*2+ $Class2YearEndParentEdu->writingh_ii_L3*3 + $Class2YearEndParentEdu->writingh_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writingh_i_L1+$Class2YearEndParentEdu->writingh_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writingh_i_L2+$Class2YearEndParentEdu->writingh_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writingh_i_L3+$Class2YearEndParentEdu->writingh_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writingh_i_L4+$Class2YearEndParentEdu->writingh_ii_L4)/2,2); ?></td>
								<td> <?php  $writeparent_wordr1= number_format(($Class2YearEndParentEdu->writingh_i_L1  + $Class2YearEndParentEdu->writingh_i_L2*2+ $Class2YearEndParentEdu->writingh_i_L3*3 + $Class2YearEndParentEdu->writingh_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$writeparent_convey2= number_format(($Class2YearEndParentEdu->writingh_ii_L1  + $Class2YearEndParentEdu->writingh_ii_L2*2+ $Class2YearEndParentEdu->writingh_ii_L3*3 + $Class2YearEndParentEdu->writingh_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($writeparent_wordr1+$writeparent_convey2)/2,2); 
									?></td>	<td> <?php  echo number_format(($writeparent_wordr1+$writeparent_convey2)/2,2)-number_format(($EntryDataEdu->write_EduA  + $EntryDataEdu->write_EduB*2+ $EntryDataEdu->write_EduC*3 + $EntryDataEdu->write_EduD*4)/$EntryDataEdu->Total,2); 
									?></td>							
					    	</tr>
...
<td> <?php  echo number_format(($parent_count1+$parent_read1+$parent_add3+$parent_obsr4+$parent_unit5+$parent_recite6)/6,2)-number_format(($EntryDataEdu->numeric_EduA  + $EntryDataEdu->numeric_EduB*2+ $EntryDataEdu->numeric_EduC*3 + $EntryDataEdu->numeric_EduD*4)/$EntryDataEdu->Total,2); 
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Reads and writes numbers up to 999 </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_i_L1  + $Class2YearEndParentEdu->numeracy_i_L2*2+ $Class2YearEndParentEdu->numeracy_i_L3*3 + $Class2YearEndParentEdu->numeracy_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). Uses addition and subtraction of numbers up to 99, sum not exceeding situations 99 in daily life</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_ii_L1  + $Class2YearEndParentEdu->numeracy_ii_L2*2+ $Class2YearEndParentEdu->numeracy_ii_L3*3 + $Class2YearEndParentEdu->numeracy_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).Performs multiplication as repeated addition and division as equal distribution/ sharing and constructs multiplication facts (tables) of 2, 3 and 4</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_iii_L1  + $Class2YearEndParentEdu->numeracy_iii_L2*2+ $Class2YearEndParentEdu->numeracy_iii_L3*3 + $Class2YearEndParentEdu->numeracy_iii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iv). Estimates and measure: length distance / capacity using nonstandard uniform units like rod, pencil, thread, cup, spoon, mug etc and compares weight using simple balance</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iv_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iv_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iv_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_iv_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_iv_L1  + $Class2YearEndParentEdu->numeracy_iv_L2*2+ $Class2YearEndParentEdu->numeracy_iv_L3*3 + $Class2YearEndParentEdu->numeracy_iv_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(v). Identifies and describes 2D & 3 D shapes like rectangle, triangle, circle, oval ,cone, cube, cuboid, sphere etc.</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_v_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_v_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_v_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_v_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_v_L1  + $Class2YearEndParentEdu->numeracy_v_L2*2+ $Class2YearEndParentEdu->numeracy_v_L3*3 + $Class2YearEndParentEdu->numeracy_v_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(vi).  Uses spatial vocabulary like far /near, in/out, above /below, front/ behind, left/right, top / bottom etc.</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_vi_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_vi_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_vi_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->numeracy_vi_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->numeracy_vi_L1  + $Class2YearEndParentEdu->numeracy_vi_L2*2+ $Class2YearEndParentEdu->numeracy_vi_L3*3 + $Class2YearEndParentEdu->numeracy_vi_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->numeracy_i_L1+$Class2YearEndParentEdu->numeracy_ii_L1+ $Class2YearEndParentEdu->numeracy_iii_L1 +$Class2YearEndParentEdu->numeracy_iv_L1+ $Class2YearEndParentEdu->numeracy_v_L1+ $Class2YearEndParentEdu->numeracy_vi_L1)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->numeracy_i_L2+$Class2YearEndParentEdu->numeracy_ii_L2+ $Class2YearEndParentEdu->numeracy_iii_L2 +$Class2YearEndParentEdu->numeracy_iv_L2+ $Class2YearEndParentEdu->numeracy_v_L2+ $Class2YearEndParentEdu->numeracy_vi_L2)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->numeracy_i_L3+$Class2YearEndParentEdu->numeracy_ii_L3+ $Class2YearEndParentEdu->numeracy_iii_L3 +$Class2YearEndParentEdu->numeracy_iv_L3+ $Class2YearEndParentEdu->numeracy_v_L3+ $Class2YearEndParentEdu->numeracy_vi_L3)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->numeracy_i_L4+$Class2YearEndParentEdu->numeracy_ii_L4+ $Class2YearEndParentEdu->numeracy_iii_L4 +$Class2YearEndParentEdu->numeracy_iv_L4+ $Class2YearEndParentEdu->numeracy_v_L4+ $Class2YearEndParentEdu->numeracy_vi_L4)/6,2); ?></td>
							<td> <?php  $parent_count1= number_format(($Class2YearEndParentEdu->numeracy_i_L1  + $Class2YearEndParentEdu->numeracy_i_L2*2+ $Class2YearEndParentEdu->numeracy_i_L3*3 + $Class2YearEndParentEdu->numeracy_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$parent_read1= number_format(($Class2YearEndParentEdu->numeracy_ii_L1  + $Class2YearEndParentEdu->numeracy_ii_L2*2+ $Class2YearEndParentEdu->numeracy_ii_L3*3 + $Class2YearEndParentEdu->numeracy_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$parent_add3= number_format(($Class2YearEndParentEdu->numeracy_iii_L1  + $Class2YearEndParentEdu->numeracy_iii_L2*2+ $Class2YearEndParentEdu->numeracy_iii_L3*3 + $Class2YearEndParentEdu->numeracy_iii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$parent_obsr4= number_format(($Class2YearEndParentEdu->numeracy_iv_L1  + $Class2YearEndParentEdu->numeracy_iv_L2*2+ $Class2YearEndParentEdu->numeracy_iv_L3*3 + $Class2YearEndParentEdu->numeracy_iv_L4*4)/$Class2YearEndParentEdu->Total,2);
								$parent_unit5= number_format(($Class2YearEndParentEdu->numeracy_v_L1  + $Class2YearEndParentEdu->numeracy_v_L2*2+ $Class2YearEndParentEdu->numeracy_v_L3*3 + $Class2YearEndParentEdu->numeracy_v_L4*4)/$Class2YearEndParentEdu->Total,2);
								$parent_recite6= number_format(($Class2YearEndParentEdu->numeracy_vi_L1  + $Class2YearEndParentEdu->numeracy_vi_L2*2+ $Class2YearEndParentEdu->numeracy_vi_L3*3 + $Class2YearEndParentEdu->numeracy_vi_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($parent_count1+$parent_read1+$parent_add3+$parent_obsr4+$parent_unit5+$parent_recite6)/6,2); 
									?></td>
<td> <?php  echo number_format(($parent_count1+$parent_read1+$parent_add3+$parent_obsr4+$parent_unit5+$parent_recite6)/6,2)-number_format(($EntryDataEdu->numeric_EduA  + $EntryDataEdu->numeric_EduB*2+ $EntryDataEdu->numeric_EduC*3 + $EntryDataEdu->numeric_EduD*4)/$EntryDataEdu->Total,2); 
									?></td>									
					...
					<div class="col-sm-6">
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).कक्षा में उपलब्ध प्रकाशित सामग्री/ पुस्तक के बारे में चर्चा एवं वार्तालाप करें। </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->oral_hindi_i_L1  + $Class2YearEndParentEdu->oral_hindi_i_L2*2+ $Class2YearEndParentEdu->oral_hindi_i_L3*3 + $Class2YearEndParentEdu->oral_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).प्रश्न करने और दूसरों को सुनने के लिए वार्तालाप में व्यस्त रहता है।</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->oral_hindi_ii_L1  + $Class2YearEndParentEdu->oral_hindi_ii_L2*2+ $Class2YearEndParentEdu->oral_hindi_ii_L3*3 + $Class2YearEndParentEdu->oral_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).गीतों/कविताओं का पाठ</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->oral_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->oral_hindi_iii_L1  + $Class2YearEndParentEdu->oral_hindi_iii_L2*2+ $Class2YearEndParentEdu->oral_hindi_iii_L3*3 + $Class2YearEndParentEdu->oral_hindi_iii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_hindi_i_L1+$Class2YearEndParentEdu->oral_hindi_ii_L1+ $Class2YearEndParentEdu->oral_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_hindi_i_L2+$Class2YearEndParentEdu->oral_hindi_ii_L2+ $Class2YearEndParentEdu->oral_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_hindi_i_L3+$Class2YearEndParentEdu->oral_hindi_ii_L3+ $Class2YearEndParentEdu->oral_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->oral_hindi_i_L4+$Class2YearEndParentEdu->oral_hindi_ii_L4+ $Class2YearEndParentEdu->oral_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $oral_parent_1= number_format(($Class2YearEndParentEdu->oral_hindi_i_L1  + $Class2YearEndParentEdu->oral_hindi_i_L2*2+ $Class2YearEndParentEdu->oral_hindi_i_L3*3 + $Class2YearEndParentEdu->oral_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$oral_conveyparent_2= number_format(($Class2YearEndParentEdu->oral_hindi_ii_L1  + $Class2YearEndParentEdu->oral_hindi_ii_L2*2+ $Class2YearEndParentEdu->oral_hindi_ii_L3*3 + $Class2YearEndParentEdu->oral_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$oral_storyparent_3= number_format(($Class2YearEndParentEdu->oral_hindi_iii_L1  + $Class2YearEndParentEdu->oral_hindi_iii_L2*2+ $Class2YearEndParentEdu->oral_hindi_iii_L3*3 + $Class2YearEndParentEdu->oral_hindi_iii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($oral_parent_1+$oral_conveyparent_2+$oral_storyparent_3)/3,2); 
									?></td>		
							<td> <?php  echo number_format(($oral_parent_1+$oral_conveyparent_2+$oral_storyparent_3)/3,2)-number_format(($EntryEduHindi->oral_hindi_EduA  + $EntryEduHindi->oral_hindi_EduB*2+ $EntryEduHindi->oral_hindi_EduC*3 + $EntryEduHindi->oral_hindi_EduD*4)/$EntryEduHindi->Total,2); 
									?></td>	
...
<td> <?php  echo number_format(($read_storyparent_1+$read_soundparent_2+$read_wordparent_3)/3,2)-number_format(($EntryEduHindi->read_hindi_EduA  + $EntryEduHindi->read_hindi_EduB*2+ $EntryEduHindi->read_hindi_EduC*3 + $EntryEduHindi->read_hindi_EduD*4)/$EntryEduHindi->Total,2); 
					  ...
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). बाल साहित्य/ पाठ्यपुस्तक से कहानियों को पढ़ता है और सुनाता/पुन: सुनाता है। </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->read_hindi_i_L1  + $Class2YearEndParentEdu->read_hindi_i_L2*2+ $Class2YearEndParentEdu->read_hindi_i_L3*3 + $Class2YearEndParentEdu->read_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).दिए गए शब्द के वर्णों से नए शब्द बनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->read_hindi_ii_L1  + $Class2YearEndParentEdu->read_hindi_ii_L2*2+ $Class2YearEndParentEdu->read_hindi_ii_L3*3 + $Class2YearEndParentEdu->read_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). 8 से 10 वाक्यों की सरल शब्दों की अज्ञात पाठ्य सामग्री को लगभग 30 से 45 शब्द प्रति मिनट की उपयुक्त गति से सही ढंग से और स्पष्टता के साथ पढ़ता है।</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->read_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->read_hindi_iii_L1  + $Class2YearEndParentEdu->read_hindi_iii_L2*2+ $Class2YearEndParentEdu->read_hindi_iii_L3*3 + $Class2YearEndParentEdu->read_hindi_iii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>  
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndParentEdu->read_hindi_i_L1+$Class2YearEndParentEdu->read_hindi_ii_L1+ $Class2YearEndParentEdu->read_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->read_hindi_i_L2+$Class2YearEndParentEdu->read_hindi_ii_L2+ $Class2YearEndParentEdu->read_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->read_hindi_i_L3+$Class2YearEndParentEdu->read_hindi_ii_L3+ $Class2YearEndParentEdu->read_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->read_hindi_i_L4+$Class2YearEndParentEdu->read_hindi_ii_L4+ $Class2YearEndParentEdu->read_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $read_storyparent_1= number_format(($Class2YearEndParentEdu->read_hindi_i_L1  + $Class2YearEndParentEdu->read_hindi_i_L2*2+ $Class2YearEndParentEdu->read_hindi_i_L3*3 + $Class2YearEndParentEdu->read_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$read_soundparent_2= number_format(($Class2YearEndParentEdu->read_hindi_ii_L1  + $Class2YearEndParentEdu->read_hindi_ii_L2*2+ $Class2YearEndParentEdu->read_hindi_ii_L3*3 + $Class2YearEndParentEdu->read_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								$read_wordparent_3= number_format(($Class2YearEndParentEdu->read_hindi_iii_L1  + $Class2YearEndParentEdu->read_hindi_iii_L2*2+ $Class2YearEndParentEdu->read_hindi_iii_L3*3 + $Class2YearEndParentEdu->read_hindi_iii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($read_storyparent_1+$read_soundparent_2+$read_wordparent_3)/3,2); 
									?></td>		
<td> <?php  echo number_format(($read_storyparent_1+$read_soundparent_2+$read_wordparent_3)/3,2)-number_format(($EntryEduHindi->read_hindi_EduA  + $EntryEduHindi->read_hindi_EduB*2+ $EntryEduHindi->read_hindi_EduC*3 + $EntryEduHindi->read_hindi_EduD*4)/$EntryEduHindi->Total,2); 
									?></td>										
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).स्वयं को अभिव्यक्त करने के लिए छोटे/ सरल वाक्यों को सही ढंग से लिखता है। </td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->writing_hindi_i_L1  + $Class2YearEndParentEdu->writing_hindi_i_L2*2+ $Class2YearEndParentEdu->writing_hindi_i_L3*3 + $Class2YearEndParentEdu->writing_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).संज्ञा शब्दों, क्रिया शब्दों और विराम चिह्नों को पहचानता है।</td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndParentEdu->writing_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndParentEdu->writing_hindi_ii_L1  + $Class2YearEndParentEdu->writing_hindi_ii_L2*2+ $Class2YearEndParentEdu->writing_hindi_ii_L3*3 + $Class2YearEndParentEdu->writing_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writing_hindi_i_L1+$Class2YearEndParentEdu->writing_hindi_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writing_hindi_i_L2+$Class2YearEndParentEdu->writing_hindi_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writing_hindi_i_L3+$Class2YearEndParentEdu->writing_hindi_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndParentEdu->writing_hindi_i_L4+$Class2YearEndParentEdu->writing_hindi_ii_L4)/2,2); ?></td>
								<td> <?php  $writing_hindiparent_1= number_format(($Class2YearEndParentEdu->writing_hindi_i_L1  + $Class2YearEndParentEdu->writing_hindi_i_L2*2+ $Class2YearEndParentEdu->writing_hindi_i_L3*3 + $Class2YearEndParentEdu->writing_hindi_i_L4*4)/$Class2YearEndParentEdu->Total,2); 
								$hindi_drawingparent_2= number_format(($Class2YearEndParentEdu->writing_hindi_ii_L1  + $Class2YearEndParentEdu->writing_hindi_ii_L2*2+ $Class2YearEndParentEdu->writing_hindi_ii_L3*3 + $Class2YearEndParentEdu->writing_hindi_ii_L4*4)/$Class2YearEndParentEdu->Total,2);
								echo number_format(($writing_hindiparent_1+$hindi_drawingparent_2)/2,2); 
									?></td>	
										<td> <?php  echo number_format(($writing_hindiparent_1+$hindi_drawingparent_2)/2,2)-number_format(($EntryEduHindi->write_hindi_EduA  + $EntryEduHindi->write_hindi_EduB*2+ $EntryEduHindi->write_hindi_EduC*3 + $EntryEduHindi->write_hindi_EduD*4)/$EntryEduHindi->Total,2); 
									?></td>	
					...
					<div class="col-sm-6">
					  <table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i). Converse and talks about the print available in the classroom.</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->oral_i_L1  + $Class2YearEndFirstGen->oral_i_L2*2+ $Class2YearEndFirstGen->oral_i_L3*3 + $Class2YearEndFirstGen->oral_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).Engages in conversation to ask questions and listens to others</td>					    		
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndFirstGen->oral_ii_L1  + $Class2YearEndFirstGen->oral_ii_L2*2+ $Class2YearEndFirstGen->oral_ii_L3*3 + $Class2YearEndFirstGen->oral_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Recitation of songs/ poems</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndFirstGen->oral_iii_L1  + $Class2YearEndFirstGen->oral_iii_L2*2+ $Class2YearEndFirstGen->oral_iii_L3*3 + $Class2YearEndFirstGen->oral_iii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_i_L1+$Class2YearEndFirstGen->oral_ii_L1+ $Class2YearEndFirstGen->oral_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_i_L2+$Class2YearEndFirstGen->oral_ii_L2+ $Class2YearEndFirstGen->oral_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_i_L3+$Class2YearEndFirstGen->oral_ii_L3+ $Class2YearEndFirstGen->oral_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_i_L4+$Class2YearEndFirstGen->oral_ii_L4+ $Class2YearEndFirstGen->oral_iii_L4)/3,2); ?></td>
								<td> <?php  $oralnonedu_converse1= number_format(($Class2YearEndFirstGen->oral_i_L1  + $Class2YearEndFirstGen->oral_i_L2*2+ $Class2YearEndFirstGen->oral_i_L3*3 + $Class2YearEndFirstGen->oral_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$oralnonedu_talks2= number_format(($Class2YearEndFirstGen->oral_ii_L1  + $Class2YearEndFirstGen->oral_ii_L2*2+ $Class2YearEndFirstGen->oral_ii_L3*3 + $Class2YearEndFirstGen->oral_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$oralnonedu_recites3= number_format(($Class2YearEndFirstGen->oral_iii_L1  + $Class2YearEndFirstGen->oral_iii_L2*2+ $Class2YearEndFirstGen->oral_iii_L3*3 + $Class2YearEndFirstGen->oral_iii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($oralnonedu_converse1+$oralnonedu_talks2+$oralnonedu_recites3)/3,2); 
									?></td>	
<td> <?php  echo number_format(($oralnonedu_converse1+$oralnonedu_talks2+$oralnonedu_recites3)/3,2)-number_format(($EntryDataNoEdu->oral_NoEduA  + $EntryDataNoEdu->oral_NoEduB*2+ $EntryDataNoEdu->oral_NoEduC*3 + $EntryDataNoEdu->oral_NoEduD*4)/$EntryDataNoEdu->Total,2); 
									?></td>										
					...
					<div class="col-sm-6">
					 <table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i).Reads and narrates /retells the stories from children's literature/ textbook</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->reading_i_L1  + $Class2YearEndFirstGen->reading_i_L2*2+ $Class2YearEndFirstGen->reading_i_L3*3 + $Class2YearEndFirstGen->reading_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).  Makes new words from the letters of a given word.</td>					    		
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndFirstGen->reading_ii_L1  + $Class2YearEndFirstGen->reading_ii_L2*2+ $Class2YearEndFirstGen->reading_ii_L3*3 + $Class2YearEndFirstGen->reading_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii).Reads unknown text of 8 to 10 sentences with simple words with appropriate speed approximately 30 to 45 words per minute correctly and clarity</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->reading_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndFirstGen->reading_iii_L1  + $Class2YearEndFirstGen->reading_iii_L2*2+ $Class2YearEndFirstGen->reading_iii_L3*3 + $Class2YearEndFirstGen->reading_iii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndFirstGen->reading_i_L1+$Class2YearEndFirstGen->reading_ii_L1+ $Class2YearEndFirstGen->reading_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->reading_i_L2+$Class2YearEndFirstGen->reading_ii_L2+ $Class2YearEndFirstGen->reading_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->reading_i_L3+$Class2YearEndFirstGen->reading_ii_L3+ $Class2YearEndFirstGen->reading_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->reading_i_L4+$Class2YearEndFirstGen->reading_ii_L4+ $Class2YearEndFirstGen->reading_iii_L4)/3,2); ?></td>
								<td> <?php  $readnonedu_part1= number_format(($Class2YearEndFirstGen->reading_i_L1  + $Class2YearEndFirstGen->reading_i_L2*2+ $Class2YearEndFirstGen->reading_i_L3*3 + $Class2YearEndFirstGen->reading_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$readnonedu_uses2= number_format(($Class2YearEndFirstGen->reading_ii_L1  + $Class2YearEndFirstGen->reading_ii_L2*2+ $Class2YearEndFirstGen->reading_ii_L3*3 + $Class2YearEndFirstGen->reading_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$readnonedu_tence3= number_format(($Class2YearEndFirstGen->reading_iii_L1  + $Class2YearEndFirstGen->reading_iii_L2*2+ $Class2YearEndFirstGen->reading_iii_L3*3 + $Class2YearEndFirstGen->reading_iii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($readnonedu_part1+$readnonedu_uses2+$readnonedu_tence3)/3,2); 
									?></td>		
<td> <?php  echo number_format(($readnonedu_part1+$readnonedu_uses2+$readnonedu_tence3)/3,2)- number_format(($EntryDataNoEdu->read_NoEduA  + $EntryDataNoEdu->read_NoEduB*2+ $EntryDataNoEdu->read_NoEduC*3 + $EntryDataNoEdu->read_NoEduD*4)/$EntryDataNoEdu->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($writenonedu_word1+$writenonedu_convey2)/2,2)- number_format(($EntryDataNoEdu->write_NoEduA  + $EntryDataNoEdu->write_NoEduB*2+ $EntryDataNoEdu->write_NoEduC*3 + $EntryDataNoEdu->write_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).Writes short/ simple sentences correctly to express herself.</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->writingh_i_L1  + $Class2YearEndFirstGen->writingh_i_L2*2+ $Class2YearEndFirstGen->writingh_i_L3*3 + $Class2YearEndFirstGen->writingh_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Recognises naming words , action words and punctuation marks. </td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writingh_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->writingh_ii_L1  + $Class2YearEndFirstGen->writingh_ii_L2*2+ $Class2YearEndFirstGen->writingh_ii_L3*3 + $Class2YearEndFirstGen->writingh_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writingh_i_L1+$Class2YearEndFirstGen->writingh_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writingh_i_L2+$Class2YearEndFirstGen->writingh_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writingh_i_L3+$Class2YearEndFirstGen->writingh_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writingh_i_L4+$Class2YearEndFirstGen->writingh_ii_L4)/2,2); ?></td>
								<td> <?php  $writenonedu_word1= number_format(($Class2YearEndFirstGen->writingh_i_L1  + $Class2YearEndFirstGen->writingh_i_L2*2+ $Class2YearEndFirstGen->writingh_i_L3*3 + $Class2YearEndFirstGen->writingh_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$writenonedu_convey2= number_format(($Class2YearEndFirstGen->writingh_ii_L1  + $Class2YearEndFirstGen->writingh_ii_L2*2+ $Class2YearEndFirstGen->writingh_ii_L3*3 + $Class2YearEndFirstGen->writingh_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($writenonedu_word1+$writenonedu_convey2)/2,2); 
									?></td>	
<td> <?php  echo number_format(($writenonedu_word1+$writenonedu_convey2)/2,2)- number_format(($EntryDataNoEdu->write_NoEduA  + $EntryDataNoEdu->write_NoEduB*2+ $EntryDataNoEdu->write_NoEduC*3 + $EntryDataNoEdu->write_NoEduD*4)/$EntryDataNoEdu->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($nonedu_count1+$nonedu_read1+$nonedu_add3+$nonedu_obsr4+$nonedu_unit5+$nonedu_recite6)/6,2)-  number_format(($EntryDataNoEdu->numeric_NoEduA  + $EntryDataNoEdu->numeric_NoEduB*2+ $EntryDataNoEdu->numeric_NoEduC*3 + $EntryDataNoEdu->numeric_NoEduD*4)/$EntryDataNoEdu->Total,2); 
					  ...
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).Reads and writes numbers up to 999 </td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_i_L1  + $Class2YearEndFirstGen->numeracy_i_L2*2+ $Class2YearEndFirstGen->numeracy_i_L3*3 + $Class2YearEndFirstGen->numeracy_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). Uses addition and subtraction of numbers up to 99, sum not exceeding situations 99 in daily life</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_ii_L1  + $Class2YearEndFirstGen->numeracy_ii_L2*2+ $Class2YearEndFirstGen->numeracy_ii_L3*3 + $Class2YearEndFirstGen->numeracy_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).Performs multiplication as repeated addition and division as equal distribution/ sharing and constructs multiplication facts (tables) of 2, 3 and 4</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_iii_L1  + $Class2YearEndFirstGen->numeracy_iii_L2*2+ $Class2YearEndFirstGen->numeracy_iii_L3*3 + $Class2YearEndFirstGen->numeracy_iii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iv). Estimates and measure: length distance / capacity using nonstandard uniform units like rod, pencil, thread, cup, spoon, mug etc and compares weight using simple balance</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iv_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iv_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iv_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_iv_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_iv_L1  + $Class2YearEndFirstGen->numeracy_iv_L2*2+ $Class2YearEndFirstGen->numeracy_iv_L3*3 + $Class2YearEndFirstGen->numeracy_iv_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(v).Identifies and describes 2D & 3 D shapes like rectangle, triangle, circle, oval ,cone, cube, cuboid, sphere etc.</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_v_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_v_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_v_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_v_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_v_L1  + $Class2YearEndFirstGen->numeracy_v_L2*2+ $Class2YearEndFirstGen->numeracy_v_L3*3 + $Class2YearEndFirstGen->numeracy_v_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(vi).Uses spatial vocabulary like far /near, in/out, above /below, front/ behind, left/right, top / bottom etc.</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_vi_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_vi_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_vi_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->numeracy_vi_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->numeracy_vi_L1  + $Class2YearEndFirstGen->numeracy_vi_L2*2+ $Class2YearEndFirstGen->numeracy_vi_L3*3 + $Class2YearEndFirstGen->numeracy_vi_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->numeracy_i_L1+$Class2YearEndFirstGen->numeracy_ii_L1+ $Class2YearEndFirstGen->numeracy_iii_L1 +$Class2YearEndFirstGen->numeracy_iv_L1+ $Class2YearEndFirstGen->numeracy_v_L1+ $Class2YearEndFirstGen->numeracy_vi_L1)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->numeracy_i_L2+$Class2YearEndFirstGen->numeracy_ii_L2+ $Class2YearEndFirstGen->numeracy_iii_L2 +$Class2YearEndFirstGen->numeracy_iv_L2+ $Class2YearEndFirstGen->numeracy_v_L2+ $Class2YearEndFirstGen->numeracy_vi_L2)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->numeracy_i_L3+$Class2YearEndFirstGen->numeracy_ii_L3+ $Class2YearEndFirstGen->numeracy_iii_L3 +$Class2YearEndFirstGen->numeracy_iv_L3+ $Class2YearEndFirstGen->numeracy_v_L3+ $Class2YearEndFirstGen->numeracy_vi_L3)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->numeracy_i_L4+$Class2YearEndFirstGen->numeracy_ii_L4+ $Class2YearEndFirstGen->numeracy_iii_L4 +$Class2YearEndFirstGen->numeracy_iv_L4+ $Class2YearEndFirstGen->numeracy_v_L4+ $Class2YearEndFirstGen->numeracy_vi_L4)/6,2); ?></td>
							<td> <?php  $nonedu_count1= number_format(($Class2YearEndFirstGen->numeracy_i_L1  + $Class2YearEndFirstGen->numeracy_i_L2*2+ $Class2YearEndFirstGen->numeracy_i_L3*3 + $Class2YearEndFirstGen->numeracy_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$nonedu_read1= number_format(($Class2YearEndFirstGen->numeracy_ii_L1  + $Class2YearEndFirstGen->numeracy_ii_L2*2+ $Class2YearEndFirstGen->numeracy_ii_L3*3 + $Class2YearEndFirstGen->numeracy_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$nonedu_add3= number_format(($Class2YearEndFirstGen->numeracy_iii_L1  + $Class2YearEndFirstGen->numeracy_iii_L2*2+ $Class2YearEndFirstGen->numeracy_iii_L3*3 + $Class2YearEndFirstGen->numeracy_iii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$nonedu_obsr4= number_format(($Class2YearEndFirstGen->numeracy_iv_L1  + $Class2YearEndFirstGen->numeracy_iv_L2*2+ $Class2YearEndFirstGen->numeracy_iv_L3*3 + $Class2YearEndFirstGen->numeracy_iv_L4*4)/$Class2YearEndFirstGen->Total,2);
								$nonedu_unit5= number_format(($Class2YearEndFirstGen->numeracy_v_L1  + $Class2YearEndFirstGen->numeracy_v_L2*2+ $Class2YearEndFirstGen->numeracy_v_L3*3 + $Class2YearEndFirstGen->numeracy_v_L4*4)/$Class2YearEndFirstGen->Total,2);
								$nonedu_recite6= number_format(($Class2YearEndFirstGen->numeracy_vi_L1  + $Class2YearEndFirstGen->numeracy_vi_L2*2+ $Class2YearEndFirstGen->numeracy_vi_L3*3 + $Class2YearEndFirstGen->numeracy_vi_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($nonedu_count1+$nonedu_read1+$nonedu_add3+$nonedu_obsr4+$nonedu_unit5+$nonedu_recite6)/6,2); 
									?></td>
<td> <?php  echo number_format(($nonedu_count1+$nonedu_read1+$nonedu_add3+$nonedu_obsr4+$nonedu_unit5+$nonedu_recite6)/6,2)-  number_format(($EntryDataNoEdu->numeric_NoEduA  + $EntryDataNoEdu->numeric_NoEduB*2+ $EntryDataNoEdu->numeric_NoEduC*3 + $EntryDataNoEdu->numeric_NoEduD*4)/$EntryDataNoEdu->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($oral_nonedu_1+$oral_conveynonedu_2+$oral_storynonedu_3)/3,2)- number_format(($EntryNoEduHindi->oral_hindi_NoEduA  + $EntryNoEduHindi->oral_hindi_NoEduB*2+ $EntryNoEduHindi->oral_hindi_NoEduC*3 + $EntryNoEduHindi->oral_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).  कक्षा में उपलब्ध प्रकाशित सामग्री/ पुस्तक के बारे में चर्चा एवं वार्तालाप करें।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->oral_hindi_i_L1  + $Class2YearEndFirstGen->oral_hindi_i_L2*2+ $Class2YearEndFirstGen->oral_hindi_i_L3*3 + $Class2YearEndFirstGen->oral_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). प्रश्न करने और दूसरों को सुनने के लिए वार्तालाप में व्यस्त रहता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->oral_hindi_ii_L1  + $Class2YearEndFirstGen->oral_hindi_ii_L2*2+ $Class2YearEndFirstGen->oral_hindi_ii_L3*3 + $Class2YearEndFirstGen->oral_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). गीतों/कविताओं का पाठ</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->oral_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->oral_hindi_iii_L1  + $Class2YearEndFirstGen->oral_hindi_iii_L2*2+ $Class2YearEndFirstGen->oral_hindi_iii_L3*3 + $Class2YearEndFirstGen->oral_hindi_iii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_hindi_i_L1+$Class2YearEndFirstGen->oral_hindi_ii_L1+ $Class2YearEndFirstGen->oral_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_hindi_i_L2+$Class2YearEndFirstGen->oral_hindi_ii_L2+ $Class2YearEndFirstGen->oral_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_hindi_i_L3+$Class2YearEndFirstGen->oral_hindi_ii_L3+ $Class2YearEndFirstGen->oral_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->oral_hindi_i_L4+$Class2YearEndFirstGen->oral_hindi_ii_L4+ $Class2YearEndFirstGen->oral_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $oral_nonedu_1= number_format(($Class2YearEndFirstGen->oral_hindi_i_L1  + $Class2YearEndFirstGen->oral_hindi_i_L2*2+ $Class2YearEndFirstGen->oral_hindi_i_L3*3 + $Class2YearEndFirstGen->oral_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$oral_conveynonedu_2= number_format(($Class2YearEndFirstGen->oral_hindi_ii_L1  + $Class2YearEndFirstGen->oral_hindi_ii_L2*2+ $Class2YearEndFirstGen->oral_hindi_ii_L3*3 + $Class2YearEndFirstGen->oral_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$oral_storynonedu_3= number_format(($Class2YearEndFirstGen->oral_hindi_iii_L1  + $Class2YearEndFirstGen->oral_hindi_iii_L2*2+ $Class2YearEndFirstGen->oral_hindi_iii_L3*3 + $Class2YearEndFirstGen->oral_hindi_iii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($oral_nonedu_1+$oral_conveynonedu_2+$oral_storynonedu_3)/3,2); 
									?></td>	
<td> <?php  echo number_format(($oral_nonedu_1+$oral_conveynonedu_2+$oral_storynonedu_3)/3,2)- number_format(($EntryNoEduHindi->oral_hindi_NoEduA  + $EntryNoEduHindi->oral_hindi_NoEduB*2+ $EntryNoEduHindi->oral_hindi_NoEduC*3 + $EntryNoEduHindi->oral_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
									?></td>										
...
<td> <?php  echo number_format(($read_storynonedu_1+$read_soundnonedu_2+$read_wordnonedu_3)/3,2)- number_format(($EntryNoEduHindi->read_hindi_NoEduA  + $EntryNoEduHindi->read_hindi_NoEduB*2+ $EntryNoEduHindi->read_hindi_NoEduC*3 + $EntryNoEduHindi->read_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					  ...
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).बाल साहित्य/ पाठ्यपुस्तक से कहानियों को पढ़ता है और सुनाता/पुन: सुनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->read_hindi_i_L1  + $Class2YearEndFirstGen->read_hindi_i_L2*2+ $Class2YearEndFirstGen->read_hindi_i_L3*3 + $Class2YearEndFirstGen->read_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). दिए गए शब्द के वर्णों से नए शब्द बनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->read_hindi_ii_L1  + $Class2YearEndFirstGen->read_hindi_ii_L2*2+ $Class2YearEndFirstGen->read_hindi_ii_L3*3 + $Class2YearEndFirstGen->read_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).8 से 10 वाक्यों की सरल शब्दों की अज्ञात पाठ्य सामग्री को लगभग 30 से 45 शब्द प्रति मिनट की उपयुक्त गति से सही ढंग से और स्पष्टता के साथ पढ़ता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->read_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->read_hindi_iii_L1  + $Class2YearEndFirstGen->read_hindi_iii_L2*2+ $Class2YearEndFirstGen->read_hindi_iii_L3*3 + $Class2YearEndFirstGen->read_hindi_iii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndFirstGen->read_hindi_i_L1+$Class2YearEndFirstGen->read_hindi_ii_L1+ $Class2YearEndFirstGen->read_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->read_hindi_i_L2+$Class2YearEndFirstGen->read_hindi_ii_L2+ $Class2YearEndFirstGen->read_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->read_hindi_i_L3+$Class2YearEndFirstGen->read_hindi_ii_L3+ $Class2YearEndFirstGen->read_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->read_hindi_i_L4+$Class2YearEndFirstGen->read_hindi_ii_L4+ $Class2YearEndFirstGen->read_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $read_storynonedu_1= number_format(($Class2YearEndFirstGen->read_hindi_i_L1  + $Class2YearEndFirstGen->read_hindi_i_L2*2+ $Class2YearEndFirstGen->read_hindi_i_L3*3 + $Class2YearEndFirstGen->read_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$read_soundnonedu_2= number_format(($Class2YearEndFirstGen->read_hindi_ii_L1  + $Class2YearEndFirstGen->read_hindi_ii_L2*2+ $Class2YearEndFirstGen->read_hindi_ii_L3*3 + $Class2YearEndFirstGen->read_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								$read_wordnonedu_3= number_format(($Class2YearEndFirstGen->read_hindi_iii_L1  + $Class2YearEndFirstGen->read_hindi_iii_L2*2+ $Class2YearEndFirstGen->read_hindi_iii_L3*3 + $Class2YearEndFirstGen->read_hindi_iii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($read_storynonedu_1+$read_soundnonedu_2+$read_wordnonedu_3)/3,2); 
									?></td>	
<td> <?php  echo number_format(($read_storynonedu_1+$read_soundnonedu_2+$read_wordnonedu_3)/3,2)- number_format(($EntryNoEduHindi->read_hindi_NoEduA  + $EntryNoEduHindi->read_hindi_NoEduB*2+ $EntryNoEduHindi->read_hindi_NoEduC*3 + $EntryNoEduHindi->read_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
									?></td>										
...
<td> <?php  echo number_format(($writing_hindinonedu_1+$hindi_drawingnonedu_2)/2,2)- number_format(($EntryNoEduHindi->write_hindi_NoEduA  + $EntryNoEduHindi->write_hindi_NoEduB*2+ $EntryNoEduHindi->write_hindi_NoEduC*3 + $EntryNoEduHindi->write_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). स्वयं को अभिव्यक्त करने के लिए छोटे/ सरल वाक्यों को सही ढंग से लिखता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->writing_hindi_i_L1  + $Class2YearEndFirstGen->writing_hindi_i_L2*2+ $Class2YearEndFirstGen->writing_hindi_i_L3*3 + $Class2YearEndFirstGen->writing_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii). संज्ञा शब्दों, क्रिया शब्दों और विराम चिह्नों को पहचानता है।</td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndFirstGen->writing_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndFirstGen->writing_hindi_ii_L1  + $Class2YearEndFirstGen->writing_hindi_ii_L2*2+ $Class2YearEndFirstGen->writing_hindi_ii_L3*3 + $Class2YearEndFirstGen->writing_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writing_hindi_i_L1+$Class2YearEndFirstGen->writing_hindi_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writing_hindi_i_L2+$Class2YearEndFirstGen->writing_hindi_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writing_hindi_i_L3+$Class2YearEndFirstGen->writing_hindi_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndFirstGen->writing_hindi_i_L4+$Class2YearEndFirstGen->writing_hindi_ii_L4)/2,2); ?></td>
								<td> <?php  $writing_hindinonedu_1= number_format(($Class2YearEndFirstGen->writing_hindi_i_L1  + $Class2YearEndFirstGen->writing_hindi_i_L2*2+ $Class2YearEndFirstGen->writing_hindi_i_L3*3 + $Class2YearEndFirstGen->writing_hindi_i_L4*4)/$Class2YearEndFirstGen->Total,2); 
								$hindi_drawingnonedu_2= number_format(($Class2YearEndFirstGen->writing_hindi_ii_L1  + $Class2YearEndFirstGen->writing_hindi_ii_L2*2+ $Class2YearEndFirstGen->writing_hindi_ii_L3*3 + $Class2YearEndFirstGen->writing_hindi_ii_L4*4)/$Class2YearEndFirstGen->Total,2);
								echo number_format(($writing_hindinonedu_1+$hindi_drawingnonedu_2)/2,2); 
									?></td>	
<td> <?php  echo number_format(($writing_hindinonedu_1+$hindi_drawingnonedu_2)/2,2)- number_format(($EntryNoEduHindi->write_hindi_NoEduA  + $EntryNoEduHindi->write_hindi_NoEduB*2+ $EntryNoEduHindi->write_hindi_NoEduC*3 + $EntryNoEduHindi->write_hindi_NoEduD*4)/$EntryNoEduHindi->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($oraldisable_converse1+$oraldisable_talks2+$oraldisable_recites3)/3,2)- number_format(($EntryDisData->oral_DisA  + $EntryDisData->oral_DisB*2+ $EntryDisData->oral_DisC*3 + $EntryDisData->oral_DisD*4)/$EntryDisData->Total,2); 
					...
					<div class="col-sm-6">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i).  Converse and talks about the print available in the classroom.</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->oral_i_L1  + $Class2YearEndDifferently->oral_i_L2*2+ $Class2YearEndDifferently->oral_i_L3*3 + $Class2YearEndDifferently->oral_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii). Engages in conversation to ask questions and listens to others</td>					    		
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndDifferently->oral_ii_L1  + $Class2YearEndDifferently->oral_ii_L2*2+ $Class2YearEndDifferently->oral_ii_L3*3 + $Class2YearEndDifferently->oral_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii). Recitation of songs/ poems</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndDifferently->oral_iii_L1  + $Class2YearEndDifferently->oral_iii_L2*2+ $Class2YearEndDifferently->oral_iii_L3*3 + $Class2YearEndDifferently->oral_iii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>	
					    	</tr>
							 <tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_i_L1+$Class2YearEndDifferently->oral_ii_L1+ $Class2YearEndDifferently->oral_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_i_L2+$Class2YearEndDifferently->oral_ii_L2+ $Class2YearEndDifferently->oral_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_i_L3+$Class2YearEndDifferently->oral_ii_L3+ $Class2YearEndDifferently->oral_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_i_L4+$Class2YearEndDifferently->oral_ii_L4+ $Class2YearEndDifferently->oral_iii_L4)/3,2); ?></td>
								<td> <?php  $oraldisable_converse1= number_format(($Class2YearEndDifferently->oral_i_L1  + $Class2YearEndDifferently->oral_i_L2*2+ $Class2YearEndDifferently->oral_i_L3*3 + $Class2YearEndDifferently->oral_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$oraldisable_talks2= number_format(($Class2YearEndDifferently->oral_ii_L1  + $Class2YearEndDifferently->oral_ii_L2*2+ $Class2YearEndDifferently->oral_ii_L3*3 + $Class2YearEndDifferently->oral_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								$oraldisable_recites3= number_format(($Class2YearEndDifferently->oral_iii_L1  + $Class2YearEndDifferently->oral_iii_L2*2+ $Class2YearEndDifferently->oral_iii_L3*3 + $Class2YearEndDifferently->oral_iii_L4*4)/$Class2YearEndDifferently->Total,2);
								echo number_format(($oraldisable_converse1+$oraldisable_talks2+$oraldisable_recites3)/3,2); 
									?></td>	
<td> <?php  echo number_format(($oraldisable_converse1+$oraldisable_talks2+$oraldisable_recites3)/3,2)- number_format(($EntryDisData->oral_DisA  + $EntryDisData->oral_DisB*2+ $EntryDisData->oral_DisC*3 + $EntryDisData->oral_DisD*4)/$EntryDisData->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($readdisable_part1+$readdisable_uses2+$readdisable_tence3)/3,2)-number_format(($EntryDisData->read_DisA  + $EntryDisData->read_DisB*2+ $EntryDisData->read_DisC*3 + $EntryDisData->read_DisD*4)/$EntryDisData->Total,2); 
					...
					<table class="table">
					    ...
					    <tbody>
					    	<tr>
					    		<td>(i).Reads and narrates /retells the stories from children's literature/ textbook</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->reading_i_L1  + $Class2YearEndDifferently->reading_i_L2*2+ $Class2YearEndDifferently->reading_i_L3*3 + $Class2YearEndDifferently->reading_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
					    	<tr>
					    		<td>(ii).Makes new words from the letters of a given word.</td>					    		
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_ii_L4) ; ?></td>
								<td> <?php echo number_format(($Class2YearEndDifferently->reading_ii_L1  + $Class2YearEndDifferently->reading_ii_L2*2+ $Class2YearEndDifferently->reading_ii_L3*3 + $Class2YearEndDifferently->reading_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>									
					    	</tr>
					    	<tr>
					    		<td>(iii).Reads unknown text of 8 to 10 sentences with simple words with appropriate speed approximately 30 to 45 words per minute correctly and clarity</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->reading_iii_L4) ; ?></td> 
								<td> <?php echo number_format(($Class2YearEndDifferently->reading_iii_L1  + $Class2YearEndDifferently->reading_iii_L2*2+ $Class2YearEndDifferently->reading_iii_L3*3 + $Class2YearEndDifferently->reading_iii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>	
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->reading_i_L1+$Class2YearEndDifferently->reading_ii_L1+ $Class2YearEndDifferently->reading_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->reading_i_L2+$Class2YearEndDifferently->reading_ii_L2+ $Class2YearEndDifferently->reading_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->reading_i_L3+$Class2YearEndDifferently->reading_ii_L3+ $Class2YearEndDifferently->reading_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->reading_i_L4+$Class2YearEndDifferently->reading_ii_L4+ $Class2YearEndDifferently->reading_iii_L4)/3,2); ?></td>
								<td> <?php  $readdisable_part1= number_format(($Class2YearEndDifferently->reading_i_L1  + $Class2YearEndDifferently->reading_i_L2*2+ $Class2YearEndDifferently->reading_i_L3*3 + $Class2YearEndDifferently->reading_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$readdisable_uses2= number_format(($Class2YearEndDifferently->reading_ii_L1  + $Class2YearEndDifferently->reading_ii_L2*2+ $Class2YearEndDifferently->reading_ii_L3*3 + $Class2YearEndDifferently->reading_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								$readdisable_tence3= number_format(($Class2YearEndDifferently->reading_iii_L1  + $Class2YearEndDifferently->reading_iii_L2*2+ $Class2YearEndDifferently->reading_iii_L3*3 + $Class2YearEndDifferently->reading_iii_L4*4)/$Class2YearEndDifferently->Total,2);
								echo number_format(($readdisable_part1+$readdisable_uses2+$readdisable_tence3)/3,2); 
									?></td>		
<td> <?php  echo number_format(($readdisable_part1+$readdisable_uses2+$readdisable_tence3)/3,2)-number_format(($EntryDisData->read_DisA  + $EntryDisData->read_DisB*2+ $EntryDisData->read_DisC*3 + $EntryDisData->read_DisD*4)/$EntryDisData->Total,2); 
									?></td>									
...
<td> <?php  echo number_format(($writedisable_word1+$writedisable_convey2)/2,2)-number_format(($EntryDisData->write_DisA  + $EntryDisData->write_DisB*2+ $EntryDisData->write_DisC*3 + $EntryDisData->write_DisD*4)/$EntryDisData->Total,2); 
					 ...
					 <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).Writes short/ simple sentences correctly to express herself.</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->writingh_i_L1  + $Class2YearEndDifferently->writingh_i_L2*2+ $Class2YearEndDifferently->writingh_i_L3*3 + $Class2YearEndDifferently->writingh_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Recognises naming words , action words and punctuation marks.</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writingh_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->writingh_ii_L1  + $Class2YearEndDifferently->writingh_ii_L2*2+ $Class2YearEndDifferently->writingh_ii_L3*3 + $Class2YearEndDifferently->writingh_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndDifferently->writingh_i_L1+$Class2YearEndDifferently->writingh_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writingh_i_L2+$Class2YearEndDifferently->writingh_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writingh_i_L3+$Class2YearEndDifferently->writingh_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writingh_i_L4+$Class2YearEndDifferently->writingh_ii_L4)/2,2); ?></td>
								<td> <?php  $writedisable_word1= number_format(($Class2YearEndDifferently->writingh_i_L1  + $Class2YearEndDifferently->writingh_i_L2*2+ $Class2YearEndDifferently->writingh_i_L3*3 + $Class2YearEndDifferently->writingh_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$writedisable_convey2= number_format(($Class2YearEndDifferently->writingh_ii_L1  + $Class2YearEndDifferently->writingh_ii_L2*2+ $Class2YearEndDifferently->writingh_ii_L3*3 + $Class2YearEndDifferently->writingh_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								echo number_format(($writedisable_word1+$writedisable_convey2)/2,2); 
									?></td>	
<td> <?php  echo number_format(($writedisable_word1+$writedisable_convey2)/2,2)-number_format(($EntryDisData->write_DisA  + $EntryDisData->write_DisB*2+ $EntryDisData->write_DisC*3 + $EntryDisData->write_DisD*4)/$EntryDisData->Total,2); 
									?></td>										
...
<td> <?php  echo number_format(($disable_count1+$disable_read1+$disable_add3+$disable_obsr4+$disable_unit5+$disable_recite6)/6,2)-number_format(($EntryDisData->numeric_DisA  + $EntryDisData->numeric_DisB*2+ $EntryDisData->numeric_DisC*3 + $EntryDisData->numeric_DisD*4)/$EntryDisData->Total,2); 
					  ...
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i). Reads and writes numbers up to 999 </td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_i_L1  + $Class2YearEndDifferently->numeracy_i_L2*2+ $Class2YearEndDifferently->numeracy_i_L3*3 + $Class2YearEndDifferently->numeracy_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).Uses addition and subtraction of numbers up to 99, sum not exceeding situations 99 in daily life</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_ii_L1  + $Class2YearEndDifferently->numeracy_ii_L2*2+ $Class2YearEndDifferently->numeracy_ii_L3*3 + $Class2YearEndDifferently->numeracy_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). Performs multiplication as repeated addition and division as equal distribution/ sharing and constructs multiplication facts (tables) of 2, 3 and 4</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_iii_L1  + $Class2YearEndDifferently->numeracy_iii_L2*2+ $Class2YearEndDifferently->numeracy_iii_L3*3 + $Class2YearEndDifferently->numeracy_iii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iv). Estimates and measure: length distance / capacity using nonstandard uniform units like rod, pencil, thread, cup, spoon, mug etc and compares weight using simple balance</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iv_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iv_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iv_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_iv_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_iv_L1  + $Class2YearEndDifferently->numeracy_iv_L2*2+ $Class2YearEndDifferently->numeracy_iv_L3*3 + $Class2YearEndDifferently->numeracy_iv_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(v).Identifies and describes 2D & 3 D shapes like rectangle, triangle, circle, oval ,cone, cube, cuboid, sphere etc.</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_v_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_v_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_v_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_v_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_v_L1  + $Class2YearEndDifferently->numeracy_v_L2*2+ $Class2YearEndDifferently->numeracy_v_L3*3 + $Class2YearEndDifferently->numeracy_v_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(vi).Uses spatial vocabulary like far /near, in/out, above /below, front/ behind, left/right, top / bottom etc. </td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_vi_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_vi_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_vi_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->numeracy_vi_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->numeracy_vi_L1  + $Class2YearEndDifferently->numeracy_vi_L2*2+ $Class2YearEndDifferently->numeracy_vi_L3*3 + $Class2YearEndDifferently->numeracy_vi_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->numeracy_i_L1+$Class2YearEndDifferently->numeracy_ii_L1+ $Class2YearEndDifferently->numeracy_iii_L1 +$Class2YearEndDifferently->numeracy_iv_L1+ $Class2YearEndDifferently->numeracy_v_L1+ $Class2YearEndDifferently->numeracy_vi_L1)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->numeracy_i_L2+$Class2YearEndDifferently->numeracy_ii_L2+ $Class2YearEndDifferently->numeracy_iii_L2 +$Class2YearEndDifferently->numeracy_iv_L2+ $Class2YearEndDifferently->numeracy_v_L2+ $Class2YearEndDifferently->numeracy_vi_L2)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->numeracy_i_L3+$Class2YearEndDifferently->numeracy_ii_L3+ $Class2YearEndDifferently->numeracy_iii_L3 +$Class2YearEndDifferently->numeracy_iv_L3+ $Class2YearEndDifferently->numeracy_v_L3+ $Class2YearEndDifferently->numeracy_vi_L3)/6,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->numeracy_i_L4+$Class2YearEndDifferently->numeracy_ii_L4+ $Class2YearEndDifferently->numeracy_iii_L4 +$Class2YearEndDifferently->numeracy_iv_L4+ $Class2YearEndDifferently->numeracy_v_L4+ $Class2YearEndDifferently->numeracy_vi_L4)/6,2); ?></td>
							<td> <?php  $disable_count1= number_format(($Class2YearEndDifferently->numeracy_i_L1  + $Class2YearEndDifferently->numeracy_i_L2*2+ $Class2YearEndDifferently->numeracy_i_L3*3 + $Class2YearEndDifferently->numeracy_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$disable_read1= number_format(($Class2YearEndDifferently->numeracy_ii_L1  + $Class2YearEndDifferently->numeracy_ii_L2*2+ $Class2YearEndDifferently->numeracy_ii_L3*3 + $Class2YearEndDifferently->numeracy_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								$disable_add3= number_format(($Class2YearEndDifferently->numeracy_iii_L1  + $Class2YearEndDifferently->numeracy_iii_L2*2+ $Class2YearEndDifferently->numeracy_iii_L3*3 + $Class2YearEndDifferently->numeracy_iii_L4*4)/$Class2YearEndDifferently->Total,2);
								$disable_obsr4= number_format(($Class2YearEndDifferently->numeracy_iv_L1  + $Class2YearEndDifferently->numeracy_iv_L2*2+ $Class2YearEndDifferently->numeracy_iv_L3*3 + $Class2YearEndDifferently->numeracy_iv_L4*4)/$Class2YearEndDifferently->Total,2);
								$disable_unit5= number_format(($Class2YearEndDifferently->numeracy_v_L1  + $Class2YearEndDifferently->numeracy_v_L2*2+ $Class2YearEndDifferently->numeracy_v_L3*3 + $Class2YearEndDifferently->numeracy_v_L4*4)/$Class2YearEndDifferently->Total,2);
								$disable_recite6= number_format(($Class2YearEndDifferently->numeracy_vi_L1  + $Class2YearEndDifferently->numeracy_vi_L2*2+ $Class2YearEndDifferently->numeracy_vi_L3*3 + $Class2YearEndDifferently->numeracy_vi_L4*4)/$Class2YearEndDifferently->Total,2);
								echo number_format(($disable_count1+$disable_read1+$disable_add3+$disable_obsr4+$disable_unit5+$disable_recite6)/6,2); 
									?></td>		
<td> <?php  echo number_format(($disable_count1+$disable_read1+$disable_add3+$disable_obsr4+$disable_unit5+$disable_recite6)/6,2)-number_format(($EntryDisData->numeric_DisA  + $EntryDisData->numeric_DisB*2+ $EntryDisData->numeric_DisC*3 + $EntryDisData->numeric_DisD*4)/$EntryDisData->Total,2); 
									?></td>									
					...
					<div class="col-sm-6">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).कक्षा में उपलब्ध प्रकाशित सामग्री/ पुस्तक के बारे में चर्चा एवं वार्तालाप करें। </td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->oral_hindi_i_L1  + $Class2YearEndDifferently->oral_hindi_i_L2*2+ $Class2YearEndDifferently->oral_hindi_i_L3*3 + $Class2YearEndDifferently->oral_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).प्रश्न करने और दूसरों को सुनने के लिए वार्तालाप में व्यस्त रहता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->oral_hindi_ii_L1  + $Class2YearEndDifferently->oral_hindi_ii_L2*2+ $Class2YearEndDifferently->oral_hindi_ii_L3*3 + $Class2YearEndDifferently->oral_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii).गीतों/कविताओं का पाठ</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->oral_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->oral_hindi_iii_L1  + $Class2YearEndDifferently->oral_hindi_iii_L2*2+ $Class2YearEndDifferently->oral_hindi_iii_L3*3 + $Class2YearEndDifferently->oral_hindi_iii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>  
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_hindi_i_L1+$Class2YearEndDifferently->oral_hindi_ii_L1+ $Class2YearEndDifferently->oral_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_hindi_i_L2+$Class2YearEndDifferently->oral_hindi_ii_L2+ $Class2YearEndDifferently->oral_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_hindi_i_L3+$Class2YearEndDifferently->oral_hindi_ii_L3+ $Class2YearEndDifferently->oral_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->oral_hindi_i_L4+$Class2YearEndDifferently->oral_hindi_ii_L4+ $Class2YearEndDifferently->oral_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  $oral_disable_1= number_format(($Class2YearEndDifferently->oral_hindi_i_L1  + $Class2YearEndDifferently->oral_hindi_i_L2*2+ $Class2YearEndDifferently->oral_hindi_i_L3*3 + $Class2YearEndDifferently->oral_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$oral_conveydisable_2= number_format(($Class2YearEndDifferently->oral_hindi_ii_L1  + $Class2YearEndDifferently->oral_hindi_ii_L2*2+ $Class2YearEndDifferently->oral_hindi_ii_L3*3 + $Class2YearEndDifferently->oral_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								$oral_storydisable_3= number_format(($Class2YearEndDifferently->oral_hindi_iii_L1  + $Class2YearEndDifferently->oral_hindi_iii_L2*2+ $Class2YearEndDifferently->oral_hindi_iii_L3*3 + $Class2YearEndDifferently->oral_hindi_iii_L4*4)/$Class2YearEndDifferently->Total,2);
								 echo number_format(($oral_disable_1+$oral_conveydisable_2+$oral_storydisable_3)/3,2); 
									?></td>		
							<td> <?php  echo number_format(($oral_disable_1+$oral_conveydisable_2+$oral_storydisable_3)/3,2)-number_format(($EntryDisHindi->oral_hindi_DisA  + $EntryDisHindi->oral_hindi_DisB*2+ $EntryDisHindi->oral_hindi_DisC*3 + $EntryDisHindi->oral_hindi_DisD*4)/$EntryDisHindi->Total,2); 
									?></td>		
...
<td> <?php  echo number_format(($read_storydisable_1+$read_sounddisable_2+$read_worddisable_3)/3,2)-number_format(($EntryDisHindi->read_hindi_DisA  + $EntryDisHindi->read_hindi_DisB*2+ $EntryDisHindi->read_hindi_DisC*3 + $EntryDisHindi->read_hindi_DisD*4)/$EntryDisHindi->Total,2); 
					  ...
					  <table class="table">
						...
						<tbody>  
					    	<tr>
					    		<td>(i).बाल साहित्य/ पाठ्यपुस्तक से कहानियों को पढ़ता है और सुनाता/पुन: सुनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->read_hindi_i_L1  + $Class2YearEndDifferently->read_hindi_i_L2*2+ $Class2YearEndDifferently->read_hindi_i_L3*3 + $Class2YearEndDifferently->read_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).दिए गए शब्द के वर्णों से नए शब्द बनाता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->read_hindi_ii_L1  + $Class2YearEndDifferently->read_hindi_ii_L2*2+ $Class2YearEndDifferently->read_hindi_ii_L3*3 + $Class2YearEndDifferently->read_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr>
					    		<td>(iii). 8 से 10 वाक्यों की सरल शब्दों की अज्ञात पाठ्य सामग्री को लगभग 30 से 45 शब्द प्रति मिनट की उपयुक्त गति से सही ढंग से और स्पष्टता के साथ पढ़ता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_iii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_iii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_iii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->read_hindi_iii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->read_hindi_iii_L1  + $Class2YearEndDifferently->read_hindi_iii_L2*2+ $Class2YearEndDifferently->read_hindi_iii_L3*3 + $Class2YearEndDifferently->read_hindi_iii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
							<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndDifferently->read_hindi_i_L1+$Class2YearEndDifferently->read_hindi_ii_L1+ $Class2YearEndDifferently->read_hindi_iii_L1)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->read_hindi_i_L2+$Class2YearEndDifferently->read_hindi_ii_L2+ $Class2YearEndDifferently->read_hindi_iii_L2)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->read_hindi_i_L3+$Class2YearEndDifferently->read_hindi_ii_L3+ $Class2YearEndDifferently->read_hindi_iii_L3)/3,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->read_hindi_i_L4+$Class2YearEndDifferently->read_hindi_ii_L4+ $Class2YearEndDifferently->read_hindi_iii_L4)/3,2); ?></td>
								<td> <?php  
								$read_storydisable_1= number_format(($Class2YearEndDifferently->read_hindi_i_L1  + $Class2YearEndDifferently->read_hindi_i_L2*2+ $Class2YearEndDifferently->read_hindi_i_L3*3 + $Class2YearEndDifferently->read_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								
								
								$read_sounddisable_2= number_format(($Class2YearEndDifferently->read_hindi_ii_L1  + $Class2YearEndDifferently->read_hindi_ii_L2*2+ $Class2YearEndDifferently->read_hindi_ii_L3*3 + $Class2YearEndDifferently->read_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								$read_worddisable_3= number_format(($Class2YearEndDifferently->read_hindi_iii_L1  + $Class2YearEndDifferently->read_hindi_iii_L2*2+ $Class2YearEndDifferently->read_hindi_iii_L3*3 + $Class2YearEndDifferently->read_hindi_iii_L4*4)/$Class2YearEndDifferently->Total,2);
								//echo $read_storydisable_1.'-'.$read_sounddisable_2.'-'.$read_worddisable_3;
								echo number_format(($read_storydisable_1+$read_sounddisable_2+$read_worddisable_3)/3,2); 
									?></td>	
<td> <?php  echo number_format(($read_storydisable_1+$read_sounddisable_2+$read_worddisable_3)/3,2)-number_format(($EntryDisHindi->read_hindi_DisA  + $EntryDisHindi->read_hindi_DisB*2+ $EntryDisHindi->read_hindi_DisC*3 + $EntryDisHindi->read_hindi_DisD*4)/$EntryDisHindi->Total,2); 
...
<td> <?php  echo number_format(($writing_hindidisable_1+$hindi_drawingdisable_2)/2,2)-number_format(($EntryDisHindi->write_hindi_DisA  + $EntryDisHindi->write_hindi_DisB*2+ $EntryDisHindi->write_hindi_DisC*3 + $EntryDisHindi->write_hindi_DisD*4)/$EntryDisHindi->Total,2); 
						...
						<tbody>  
					    	<tr>
					    		<td>(i).स्वयं को अभिव्यक्त करने के लिए छोटे/ सरल वाक्यों को सही ढंग से लिखता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_i_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_i_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_i_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_i_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->writing_hindi_i_L1  + $Class2YearEndDifferently->writing_hindi_i_L2*2+ $Class2YearEndDifferently->writing_hindi_i_L3*3 + $Class2YearEndDifferently->writing_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr>
							<tr>
					    		<td>(ii).संज्ञा शब्दों, क्रिया शब्दों और विराम चिह्नों को पहचानता है।</td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_ii_L1) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_ii_L2) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_ii_L3) ; ?></td>
					    		<td><?php echo number_format($Class2YearEndDifferently->writing_hindi_ii_L4) ; ?></td>
								<td> <?php  echo number_format(($Class2YearEndDifferently->writing_hindi_ii_L1  + $Class2YearEndDifferently->writing_hindi_ii_L2*2+ $Class2YearEndDifferently->writing_hindi_ii_L3*3 + $Class2YearEndDifferently->writing_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2); 
									?></td>								
					    	</tr> 
					    	<tr style="background: #ffeb3b;"> 
							<td><b>Average Score</b></td> 
					    	<td><?php echo number_format(($Class2YearEndDifferently->writing_hindi_i_L1+$Class2YearEndDifferently->writing_hindi_ii_L1)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writing_hindi_i_L2+$Class2YearEndDifferently->writing_hindi_ii_L2)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writing_hindi_i_L3+$Class2YearEndDifferently->writing_hindi_ii_L3)/2,2); ?></td>
					    	<td><?php echo number_format(($Class2YearEndDifferently->writing_hindi_i_L4+$Class2YearEndDifferently->writing_hindi_ii_L4)/2,2); ?></td>
								<td> <?php  $writing_hindidisable_1= number_format(($Class2YearEndDifferently->writing_hindi_i_L1  + $Class2YearEndDifferently->writing_hindi_i_L2*2+ $Class2YearEndDifferently->writing_hindi_i_L3*3 + $Class2YearEndDifferently->writing_hindi_i_L4*4)/$Class2YearEndDifferently->Total,2); 
								$hindi_drawingdisable_2= number_format(($Class2YearEndDifferently->writing_hindi_ii_L1  + $Class2YearEndDifferently->writing_hindi_ii_L2*2+ $Class2YearEndDifferently->writing_hindi_ii_L3*3 + $Class2YearEndDifferently->writing_hindi_ii_L4*4)/$Class2YearEndDifferently->Total,2);
								//echo $writing_hindidisable_1.'-'.$hindi_drawingdisable_2;
								echo number_format(($writing_hindidisable_1+$hindi_drawingdisable_2)/2,2); 
									?></td>
<td> <?php  echo number_format(($writing_hindidisable_1+$hindi_drawingdisable_2)/2,2)-number_format(($EntryDisHindi->write_hindi_DisA  + $EntryDisHindi->write_hindi_DisB*2+ $EntryDisHindi->write_hindi_DisC*3 + $EntryDisHindi->write_hindi_DisD*4)/$EntryDisHindi->Total,2); 
