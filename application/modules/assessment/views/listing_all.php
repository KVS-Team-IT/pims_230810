    ...
    ?>
            ...
            <div class="row" style="padding: 6px;">
                <div class="form-group col-md-3">
                    <label class="col-sm-12 col-form-label text-white" id="initial_region_label">Select Region:<span
                ...
                <div class="form-group col-md-3 kv-list">
                    <label class="col-sm-12 col-form-label text-white" id="initial_region_label">Select Kendriya
                        Vidyalaya:<span class="reqd">*</span></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="col-sm-12">
                        <button type="button" id="btn_filter" class="btn btn-warning btn-block float-right"><i
                ...
                <div class="form-group col-md-3">
                    <label class="col-sm-12 col-form-label text-white">&nbsp;<span class="reqd"></span></label>
                    <div class="col-sm-12">
                        <button type="button" id="Download_Excel" class="btn btn-primary btn-block float-right"><i
                                class="fa fa-filter"></i>&nbsp; Download Excel</button>
                    </div>
                </div>
                <?php  }*/  ?>
                ...
                <div class="form-group col-md-2">
                    <label class="col-sm-12 col-form-label text-white">&nbsp;<span class="reqd"></span></label>
                    <button type="button" id="AssessmentStatus" class="btn btn-success btn-block float-right">Assessment
                        Status</button>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <button type="button" id="FinReportGen" class="btn btn-success btn-block float-right"><i
                            class="fa fa-filter"></i>&nbsp; Final Report</button>
                </div>
                <?php  if($role_id==1){  ?>
                <div class="form-group col-md-2">
                    <button type="button" id="FinReportGenBoy" class="btn btn-success btn-block float-right"><i
                            class="fa fa-filter"></i>&nbsp; Final Report Boy</button>
                </div>
                <div class="form-group col-md-2">
                    <button type="button" id="FinReportGenGirl" class="btn btn-success btn-block float-right"><i
                            class="fa fa-filter"></i>&nbsp; Final Report Girl</button>
...
$('#FinReportGenBoy').on('click', function(e) {
    ...
    var ClassID = '<?php echo $this->uri->segment(3); ?>';
    if (R_ID != '') {
        window.location = "<?php echo base_url('assessment/assessmentboy/final_report'); ?>/" + R_ID + "/" +
            KVID + "/" + ClassID;
    } else {
        alert("Please Select Region First.");
        return false;
...
$('#FinReportGenGirl').on('click', function(e) {
    ...
    var ClassID = '<?php echo $this->uri->segment(3); ?>';
    if (R_ID != '') {
        window.location = "<?php echo base_url('assessment/assessmentgirl/final_report'); ?>/" + R_ID + "/" +
            KVID + "/" + ClassID;
    } else {
        alert("Please Select Region First.");
        return false;
