...
class Assessmentboy_model extends CI_model {
	...
	public function report_is_exists($id) {
      ...
      public function get_firstStep_data_by_id($id,$kv_id) {
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
            $where= "WHERE `region_id` = ".$id." AND `gender` ='Male'  and `is_deleted` = '0'  ORDER BY `id` ASC";
            }
        }else
        {
            $where= "WHERE `is_deleted` = '0' AND `gender` ='Male' ORDER BY `id` ASC"; //All India
        }
        $sqlQuery="SELECT 
      ...
      public function get_page2A_data_by_id($id,$kv_id) {
        ...
        {
            $where= "WHERE `is_deleted` = '0' AND `gender` ='Male'  ORDER BY `id` ASC";
        }
        $sqlQuery="SELECT 
...
SUM(CASE WHEN is_numeracy_skills='Able to perform operations and recognize shapes and patterns' THEN 1 ELSE 0 END) 'numeric1D',  
    ...
    public function get_Midpage2A_data_by_id($id) {
        if($id!='001'){
            $where= "WHERE `region_id` = ".$id." and `is_deleted` = '0' AND `gender` ='Male' ORDER BY `id` ASC";
        }else
        {
            $where= "WHERE `is_deleted` = '0' AND `gender` ='Male' ORDER BY `id` ASC";
        }
...
SUM(CASE WHEN read_language_hindi_mid_term='स्पष्ट उच्चारण के साथ 4-5 सरल शब्दों वाले उपयुक्त अज्ञात पाठ व छोटे वाक्यों को पढ़ता है। ' THEN 1 ELSE 0 END) 'midread_hindiD',
	  ...
	  public function get_FinalNonSchooling_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND `years_of_pre-schooling`='NIL' AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
			$where= "WHERE `region_id` = ".$id." AND `years_of_pre-schooling`='NIL' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
            
        }else
        {
            $where= "WHERE `years_of_pre-schooling`='NIL' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
        }
        $sqlQuery="SELECT 
	  ...
	  public function get_FinalParent_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
				$where= "WHERE `region_id` = ".$id." AND (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
            
        }else
        {
            $where= "WHERE `father_qualification` !='Not educated' AND `mother_qualification` !='Not educated' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
        }
        $sqlQuery="SELECT 
	  ...
	  public function get_FinalHindiNonEdu_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND (`father_qualification` ='Not educated' AND `mother_qualification` ='Not educated') AND (`father_qualification` !='Not educated' OR `mother_qualification` !='Not educated') AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
				$where= "WHERE `region_id` = ".$id." AND (`father_qualification` ='Not educated'  AND `mother_qualification` ='Not educated') AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
	  ...
	  public function get_FinalDis_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND `is_differently_abled` ='Yes' AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
				$where= "WHERE `region_id` = ".$id." AND `is_differently_abled` ='Yes' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
            
        }else
        {
            $where= "WHERE `is_differently_abled` ='Yes' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
        }
        $sqlQuery="SELECT 
...
SUM(CASE WHEN read_language_hindi='सरल वाक्यों को धाराप्रवाह पढ़ सकता  है एवं  उनकी  व्याख्या  कर सकता  है ।' THEN 1 ELSE 0 END) 'read_hindinopreD',
	  ...
	  public function get_EntryEdu_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND (`father_qualification` !='Not educated' OR `mother_qualification` !='Not educated') AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
				$where= "WHERE `region_id` = ".$id." AND (`father_qualification` !='Not educated' OR `mother_qualification` !='Not educated') AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
            
        }else
        {
            $where= "WHERE `father_qualification` !='Not educated' OR `mother_qualification` !='Not educated' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
        }
        $sqlQuery="SELECT 
...
SUM(CASE WHEN read_language_hindi='सरल वाक्यों को धाराप्रवाह पढ़ सकता  है एवं  उनकी  व्याख्या  कर सकता  है ।' THEN 1 ELSE 0 END) 'read_hindi_DisD',
	 ...
	 public function get_FinalRTE_data_by_id($id,$kv_id) {
        if($id!='001'){
			if($kv_id!=null || $kv_id!='')
            {
                $where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." AND `is_rte_quota` ='Yes' AND `gender` ='Male' and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
				$where= "WHERE `region_id` = ".$id." AND `is_rte_quota` ='Yes' AND `gender` ='Male' AND `is_deleted` = '0' ORDER BY `id` ASC";
            }
