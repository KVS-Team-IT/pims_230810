            ...
            <div class="col-12">
                ...
                <?php 
                    if(isset($PerData->emp_photo) && ($PerData->emp_photo!='NA') ){
                        echo '<img class="profile-picture rounded-circle" src="'.base_url()."img/ProImage/".$PerData->emp_photo.'" width="125" height="125"/>';
                    }else{
                        echo '<img class="profile-picture rounded-circle" src="'.base_url().'img/img-icon.png" width="125" height="125">';
                    }
                ?>
                <h6 class="text-dark mt-4 mb-1">
                    <?php 
                    //show($PerData);
                    if($PerData->emp_title==1){ $title='Sh.'; } elseif ($PerData->emp_title==2) { $title='Smt.'; } elseif ($PerData->emp_title==3) { $title='Ms.'; } elseif ($PerData->emp_title==4) { $title='Dr.'; }else {  $title=''; }
    ...
    <tr>
        ...
        <td>
            ...
            if($PerData->emp_ph_category==1){
                echo 'OH';
            }else if($PerData->emp_ph_category==2){
                echo 'VH';
            }else if($PerData->emp_ph_category==3){
                echo 'HH';
            }else{
                echo 'Other';
            }?>
