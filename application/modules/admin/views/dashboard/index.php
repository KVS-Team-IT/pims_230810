...
chart.data = [
        <?php if(isset($CVC) && !empty($CVC)){
            ...
            ?>
            {
                "NAME": "<?php echo ($V['NAME'])? $V['NAME'] : '' ?>",
				"SANCTIONED"  : <?php echo ($V['SAC']>0)? $V['SAC'] : 0 ?>,
                "IN_POSITION"  : <?php echo ($V['INP']>0)? $V['INP'] : 0 ?>,
                "VACANT"  : <?php echo (($V['SAC']-$V['INP'])>0)? $V['SAC']-$V['INP'] : 0 ?>,
                "NONE" : 0,
...
createSeries("IN_POSITION", "In-Position Post");
createSeries("VACANT", "Vacant Post");
//createSeries("SANCTIONED", "Sanctioned Post");
