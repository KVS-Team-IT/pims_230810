...
input.password {
  ...
  <div class="container">
      <div class="card card-register mx-auto mt-5">
          <div class="card-header register-header">Change Password</div>
      </div>
      <div class="card-body shape-shadow">
          ...
          <div class="row">
              <div class="form-group col-md-4">
                  <label for="" class="col-sm-12 col-form-label">Default / Current Password: <span
                          class="reqd">*</span></label>
                  <div class="col-sm-12">
                      <input type="password" name="old_password" id="old_password"
                          class="form-control password validate[required]" placeholder="Old Password"
                          autocomplete="off">
              ...
              <div class="form-group col-md-4">
                  ...
                  <div class="col-sm-12">
                      <input type="password" name="new_password" id="new_password"
                          class="form-control validate[required] password" placeholder="New Password"
                          autocomplete="off">
              ...
              <div class="form-group col-md-4">
                  ...
                  <div class="col-sm-12">
                      <input type="password" name="confirm_password" id="confirm_password"
                          class="form-control validate[required,equals[new_password]] password"
