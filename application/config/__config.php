...
|
*/
//$config['base_url'] = 'http://shubhkamna/cgwebnews.in/_a_/';

$base = (isset($_SERVER['HTTPS']) && (($_SERVER['HTTPS'] == 'on') || ($_SERVER['HTTPS'] == '1'))) ? ('https://' . $_SERVER['HTTP_HOST']) : ('http://' . $_SERVER['HTTP_HOST']);
...
|
*/
$config['log_path'] = '/www/wwwroot/kvsangathan.co.in/pims/writable/log/';
...
$config['sess_save_path'] = '/www/wwwroot/kvsangathan.co.in/pims/writable/tmp';
