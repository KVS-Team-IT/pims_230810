...
$route['getcityonprofile'] = 'employee/get_city';
$route['onload_getDistrict'] = 'employee/get_city';
...
$route['transferrevert']  = 'transfer/Transfer/revertconfirm';
...
//================================ CLASSROOM T O O L S =================================//
$route['new-web-tools'] = 'webtools/Webtools/Observation';
$route['new-web-tools/(:any)'] = 'webtools/Webtools/Observation/$1';
$route['new-observed-data'] = 'webtools/Webtools/AllObservation';
$route['new-send-observed-data'] = 'webtools/Webtools/SendObservedData';
$route['new-send-observed-data/(:any)/(:any)'] = 'webtools/Webtools/SendObservedData/$1/$2';
$route['new-observed-user'] = 'webtools/Webtools/ObservedUserList';
$route['new-assign-observer'] = 'webtools/Webtools/AssignObserver';
//============================ MIS ADMIN REPORTS =============================//
$route['consolidated-unit-report'] = 'MisReport/Mis/ConsolidatedUnitData';
$route['consolidated-post-report'] = 'MisReport/Mis/ConsolidatedUnitPost';
...
//===================== NEW EMPLOYEE MANAGEMENT MODULE =======================//
$route['registered-employees-list'] = 'admin/employees/index';
$route['add-an-employee'] = 'admin/employees/add_an_employee';
$route['add-bulk-employee'] = 'admin/employees/add_bulk_employee';
...
$route['school-profile']        = 'School/School/SchoolProfile';
$route['school-class-profile']  = 'School/School/ClassStrength';
//======================= A F F I L I A T I O N  L I N K========================//
$route['affiliation']        = 'Affiliation/index';


$route['assessment/(:any)'] = 'assessment/Assessment/index/$1';
$route['recycle_bin_list'] = 'assessment/Assessment/recycle_bin';
$route['assessment_abilities']        = 'assessment/Assessment/index';
$route['filtered_kv_list'] = 'assessment/Assessment/FilteredKVList';
$route['assesment_filtered-kv'] = 'assessment/Assessment/FilteredKV';
$route['filtered-kvstu'] = 'assessment/Assessment/FilteredKVstU';
$route['kv-all-student'] = 'assessment/Assessment/KvAllStudents';
$route['kv-assessment-status'] = 'assessment/Assessment/KvAssessmentStatus';
$route['download_data_excel'] = 'assessment/Assessment/download_excel_report';
$route['kv-student-list/(:any)'] = 'assessment/Assessment/KvStudents/$1';
$route['kv-student-list-for-me'] = 'assessment/Assessment/StudentslistForTeacher';
$route['delete_duplicat'] = 'assessment/Assessment/delete_duplicat/$1';

$route['kv-student-list-two'] = 'assessmentclasstwo/Assessmentclasstwo/KvStudents';
$route['kv-student-list-for-me-two'] = 'assessmentclasstwo/Assessmentclasstwo/StudentslistForTeacher';
$route['assigned_employee_two'] = 'assessmentclasstwo/Assessmentclasstwo/assigned_employee';
$route['assign_student_to_shift_class_two'] = 'assessmentclasstwo/Assessmentclasstwo/assign_data_to_shift';

$route['kv-dup-details'] = 'assessment/Assessment/KvDupStudents';
$route['assigned_employee'] = 'assessment/Assessment/assigned_employee';
$route['assign_student_to_shift'] = 'assessment/Assessment/assign_data_to_shift';
$route['delete_duplicate'] = 'assessment/Assessment/deleteDuplicate';
$route['permanent_delete'] = 'assessment/Assessment/permanentDelete';
$route['deleted-data-list'] = 'assessment/Assessment/deleteFlnData';
$route['restore_data'] = 'assessment/Assessment/restore_data';
//===================Assessment Abilities==================//
$route['assessment_list']        = 'assessment/Assessment/index';


$route['add-student']  = 'Student/Student/AddStudent';
$route['student-list']  = 'Student/Student/ListStudent';
$route['get-students']  = 'Student/Student/getStudents';
$route['observation-dashboard'] = 'webtools/Webtools/dashboard';