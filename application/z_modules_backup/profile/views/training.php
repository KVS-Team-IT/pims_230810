    ...
    <div class="row m-1" style="background:#ffffff!important;">
        <div class="col-md-12 p-2 pt-2">
            ...
            <tr>
                ...
                <td><b><?php if($row->venuetype1=='2') echo 'Unit '; elseif($row->venuetype1=='4') echo 'ZIET '; else echo 'Region '; ?></b></td><td style="">:</td><td><?php echo $row->region1; ?></td>
            ...
            <tr>
                ...
                <td><b><?php if($row->venuetype2=='2') echo 'Unit '; elseif($row->venuetype2=='4') echo 'ZIET '; else echo 'Region '; ?></b></td><td style="">:</td><td><?php echo $row->region2; ?></td>
           ...
           <?php if(!empty($row->venuetype3)&&$row->spell==3) { ?>
            <tr>
                ...
                <td><b><?php if($row->venuetype3=='2') echo 'Unit '; elseif($row->venuetype3=='4') echo 'ZIET '; else echo 'Region '; ?></b></td><td style="">:</td><td><?php echo $row->region3; ?></td>
           ...
           <?php if(!empty($row->venuetype4)&&$row->spell==3) { ?>
            <tr>
                ...
                <td><b><?php if($row->venuetype4=='2') echo 'Unit '; elseif($row->venuetype4=='4') echo 'ZIET '; else echo 'Region '; ?></b></td><td style="">:</td><td><?php echo $row->region4; ?></td>
