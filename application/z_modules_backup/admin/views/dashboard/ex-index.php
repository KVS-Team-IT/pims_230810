...
<html lang="en">
    ...
    <div id="content-wrapper">
            ...
            <div class="row">
                <div class="col-xl-2 col-sm-6 mb-3">
                    <div class="card text-white bg-primary o-hidden h-80">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($VM->T_SAC || $VM->NT_SAC)? ($VM->T_SAC + $VM->NT_SAC): '00' ; ?></span>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-80">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($IP->T_INPOS || $IP->NT_INPOS)? ($IP->T_INPOS+$IP->NT_INPOS) : '00' ; ?></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-2 col-sm-6 mb-3">
                ...
                <div class="col-xl-2 col-sm-6 mb-3">
                    <div class="card text-white bg-secondary o-hidden h-80">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($VM->T_SAC && $IP->T_INPOS || $VM->NT_SAC && $IP->NT_INPOS)? (($VM->T_SAC + $VM->NT_SAC)-($IP->T_INPOS+$IP->NT_INPOS)): '00' ; ?></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-2 col-sm-6 mb-3">
                    <div class="card text-white bg-info o-hidden h-80">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="#">
                            <span class="float-left" style="font-size: 20px"><?php  echo ($VM->T_CON || $VM->NT_CON)? ($VM->T_CON + $VM->NT_CON): '00' ; ?></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-2 col-sm-6 mb-3">
        ...
        <div class="row">
          <div class="col-xl-12 col-sm-12 mb-12">
              <div id="VacChart" style="min-height:800px;"></div>
          </div>
        </div>
        </div>
    </div>	
