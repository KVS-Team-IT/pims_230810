...
<!--                        <select  class="form-control validate[required] region_initial" name="region_id_initial" id="c_region_initial" data-id="c">
        ...
        <div class="background_div">
            <div class="row">
                ...
                <div class="form-group col-md-3" <?php if($presentpost->present_designationid==5 || $presentpost->present_designationid==6){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>  id="subject_div_present">
                    <label for="" class="col-sm-12 col-form-label"> Subject    <span class="reqd"></span></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="col-sm-12">
                        <?php echo form_dropdown("present_status", array("" => "Select") + emp_status(), isset($presentpost->present_status) ? set_value('present_status', $presentpost->present_status) : set_value('present_status',''), 'disabled id="present_status" data-id="c" class="form-control validate[required]" autocomplete="off" '); ?>
                ...
                <div class="form-group col-md-3" >
                    ...
                    <div class="col-sm-12">
                        <?php 
                        if(empty($presentpost->present_status_date) && $presentpost->present_status==1){$StsDT=$presentpost->present_joiningdate;}else{$StsDT='';}
                        echo form_input("present_status_date", isset($presentpost->present_status_date) ? set_value('present_status_date', $presentpost->present_status_date) : set_value('present_status_date',$StsDT), 'disabled placeholder="dd-mm-yyyy"  class="datepicker-here form-control common_datepicker validate[required]" autocomplete="off"'); ?>
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-th"></span>
                        </div>
