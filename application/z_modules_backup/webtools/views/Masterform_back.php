                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="col-sm-12 col-form-label">The duration of observation of the class by the supervision: (Time/Period):<span class="reqd">*</span></label>
                            <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-sm-12">
                                ...
                                <span>(The Teacher using following ICT resources)</span>
                                <hr>
                            </div>
                            <div class="col-sm-12">
                            <div class="form-check">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                            <ul type="square">
                                <li><label style="font-weight: normal!important;margin-top: 10px!important;margin-bottom: 0px!important;">Name of the online platform(e.g. Microsoft Teams/Google Classroom/Whatsapp/Blog/etc.)</label></li>
                                <?php
                                ...
                                ?>
                                <li><label style="font-weight: normal!important;margin-top: 10px!important;margin-bottom: 0px!important;">Comments on, Links of videos assigned (Self-made/from other sources) and exercises based on the videos</label></li>
                                <?php
                                echo form_input("online_platform_txt",isset($DB['online_platform_txt']) ? set_value('online_platform_txt', $DB['online_platform_txt']) : set_value('online_platform_txt',''), 'placeholder=" " style="display:block" class="online_platform_txt validate[required] form-control" autocomplete="off"');
                                ?>
                                <li><label style="font-weight: normal!important;margin-top: 10px!important;margin-bottom: 0px!important;">Comments on, Interactive worksheets used - Quality and type</label></li>
                                <?php
                                echo form_input("online_platform_txt",isset($DB['online_platform_txt']) ? set_value('online_platform_txt', $DB['online_platform_txt']) : set_value('online_platform_txt',''), 'placeholder=" " style="display:block" class="online_platform_txt validate[required] form-control" autocomplete="off"');
                                ?>
                                <li><label style="font-weight: normal!important;margin-top: 10px!important;margin-bottom: 0px!important;">Non-interactive worksheets – Whether correction was done?</label>
                                    <label class="col-sm-12" style="font-weight: normal!important;">
                                        <?php
                                ...
                                <li>
                                    <label style="font-weight: normal!important;margin-top: 10px!important;margin-bottom: 0px!important;">Writing assignments given & collected back as image/pdf and correction done?</label>
                                    <label class="col-sm-12" style="font-weight: normal!important;">
                                        <?php
                                        foreach(opt_yes_no() as $O=>$R){
                                ...
                                <li>
                                <?php
                                echo'<input type="checkbox" name="assignment_mode[]" class="form-check-input assignment_mode" onchange="AssignmentModeTxt();" value="'.$k.'" '.$chk.'>'.$v.'<br>';
                                ?>
                                </li>
                            </ul>
                            <div class="form-check">
                            <?php
                            $assignment_mode=explode("#",$DB['assignment_mode']);
                            foreach(new_assignment_mode() as $k=>$v){
                                if (in_array($k, $assignment_mode)){$chk='checked';}else{$chk='';}
                                echo'<input type="checkbox" name="assignment_mode[]" class="form-check-input assignment_mode" onchange="AssignmentModeTxt();" value="'.$k.'" '.$chk.'>'.$v.'<br>';
                                if($k==1){
                                    if (in_array('1', $assignment_mode)){
                                    echo form_input("online_platform_txt",isset($DB['online_platform_txt']) ? set_value('online_platform_txt', $DB['online_platform_txt']) : set_value('online_platform_txt',''), 'placeholder=" " style="display:block" class="online_platform_txt validate[required] form-control" autocomplete="off"');
                                    }else{
                                    echo form_input("online_platform_txt",isset($DB['online_platform_txt']) ? set_value('online_platform_txt', '') : set_value('online_platform_txt',''), 'placeholder=" " style="display:none" class="online_platform_txt validate[required] form-control" autocomplete="off"');
                                    }
                                }
                                if($k==2){
                                    if (in_array('2', $assignment_mode)){
                                    ...
                                    echo form_input("video_link_txt",isset($DB['video_link_txt']) ? set_value('video_link_txt', '') : set_value('video_link_txt',''), 'placeholder=" " style="display:none" class="video_link_txt validate[required] form-control" autocomplete="off"');
                                    }
                                }
                                if($k==3){
                                    if (in_array('3', $assignment_mode)){
                                    ...
                                    echo form_input("int_worksheet_txt",isset($DB['int_worksheet_txt']) ? set_value('int_worksheet_txt', '') : set_value('int_worksheet_txt',''), 'placeholder=" " style="display:none" class="int_worksheet_txt validate[required] form-control" autocomplete="off"');
                                    }
                                }
                                if($k==4){
                                    
                                    if(in_array('4', $assignment_mode)&& $DB['non_int_worksheet']){
                                        echo'<div style="display:block;" class="div_non_int_worksheet">';
                                        foreach(opt_yes_no() as $O=>$R){
                                        if ($O==$DB['non_int_worksheet']){$chk='checked';}else{$chk='';}
                                        echo'<input type="radio" name="non_int_worksheet" class="form-check-input non_int_worksheet" value="'.$O.'" '.$chk.'>'.$R.'&emsp;&emsp;';
                                        }
                                        ...
                                        echo'<div style="display:none;" class="div_non_int_worksheet">';
                                        foreach(opt_yes_no() as $O=>$R){
                                        echo'<input type="radio" name="non_int_worksheet" class="form-check-input non_int_worksheet" value="'.$O.'">'.$R.'&emsp;&emsp;';
                                        }
                                        echo'</div>';
                                    }
                                }
                                if($k==5){
                                    ...
                                    if(in_array('4', $assignment_mode)&& $DB['non_int_assignment']){
                                        echo'<div style="display:block;" class="div_non_int_assignment">';
                                        foreach(opt_yes_no() as $O=>$R){
                                        if ($O==$DB['non_int_assignment']){$chk='checked';}else{$chk='';}
                                        echo'<input type="radio" name="non_int_assignment" class="form-check-input non_int_assignment" value="'.$O.'" '.$chk.'>'.$R.'&emsp;&emsp;';
                                        }
                                        ...
                                        echo'<div style="display:none;" class="div_non_int_assignment">';
                                        foreach(opt_yes_no() as $O=>$R){
                                        echo'<input type="radio" name="non_int_assignment" class="form-check-input non_int_assignment" value="'.$O.'">'.$R.'&emsp;&emsp;';
                                        }
                                        echo'</div>';
                                    }
                                }
                            ...
                            ?>
                                ...
                                <?php 
                                if (in_array('99', $assignment_mode)){
                                ...
                                echo form_input("assignment_mode_txt",isset($DB['assignment_mode_txt']) ? set_value('assignment_mode_txt', $DB['assignment_mode_txt']) : set_value('assignment_mode_txt',''), 'placeholder=" " style="display:none" class="assignment_mode_txt validate[required] form-control" autocomplete="off"');
                                }
                                ?>
                                <span class="error"><?php echo form_error('student_involve_txt'); ?></span>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-sm-12"><hr><h5>6. Findings on the competence of the children on a random sample basis (eg. utilizing written test/question-answer/verification of homework record with actual question-answer sessions/ formative assessment record with some sample checking etc.) ::</h5></div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                        <div class="col-sm-12"><hr><h5>8. Observations on maintenance of notebooks and CCE Records::</h5><hr></div>
                        <div class="col-sm-12">
                            <div class="form-check">
                            <?php
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <hr>
                                <h6>Planning:-</h6>
                                <span>(Click on the relevant check boxes with a maximum of 2  indicators which are predominantly essential . Please take due care not to select the items which you have already selected under observations S. No. 4, 5 & 11.)</span>
                                <hr>
                            </div>
                            <div class="col-sm-12">
                            <div class="form-check">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-sm-12">
                                <hr>
                                <h6>Classroom management:- </h6>
                                <span>(Click on the relevant check boxes with a maximum of 2  indicators which are predominantly essential . Please take due care not to select the items which you have already selected under observations S. No. 4, 4 & 11.)</span>
                                <hr>
                            </div>
                            <div class="col-sm-12">
                            <div class="form-check">
                        ...
                        <div class="row" style="text-align: justify; margin: 10px;">
                            <div class="col-sm-12">
                                <span class="text-danger">* Two inspections in an academic year should be done by the same HM / VP / Principal as far as possible, and they can give complete feedback and suggestions after first inspection and check the implementation of the suggestions during second inspection. In case of a different Principal during second inspection due to unavoidable circumstances, the report of first inspection should be given to the inspecting principal well in advance by the venue school Principal.</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    ...
    function AssignmentModeTxt(){
        ...
        if(amary.includes("1")) { $('.online_platform_txt').show();}    else{ $('.online_platform_txt').hide(); }
        if(amary.includes("2")) { $('.video_link_txt').show(); }        else{ $('.video_link_txt').hide(); }
        if(amary.includes("3")) { $('.int_worksheet_txt').show(); }     else{ $('.int_worksheet_txt').hide(); }
        if(amary.includes("4")) { $('.div_non_int_worksheet').show();}  else{ $('.div_non_int_worksheet').hide(); }
        if(amary.includes("5")) { $('.div_non_int_assignment').show();} else{ $('.div_non_int_assignment').hide(); }
