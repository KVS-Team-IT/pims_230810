    ...
    <div class="container-fluid">
       ...
       <div class="row" style="border: 1px dotted #8c8c8c; margin:2% 15%; border-radius:5px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right" style="float:right"> <b>Dated:   </b>&nbsp;  <span style="border-bottom: 1px dotted #ccc;"><?php echo $E->ACCEPT_UPDATE_DT; ?></span></div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-left">
                ...
                and the status of the request transfer process has been approved on  <?php
                echo ' Dated: <b>'.$E->ACCEPT_UPDATE_DT .' ('.$E->accept_period.')</b>.';
                ?>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <p><b>With Best Regards,</b>&nbsp;<br>
                ...
                elseif($E->present_place==4) 
                    echo 'Director'; 
                elseif($E->present_place==3) 
                    echo 'The Deputy Commisioner'; 
                else 
                    echo 'The Kendriya Vidyalaya Sagathan'; ?>
