...
class AssessmentModelClassWise extends CI_model {
        ...
        if($id!='001'){
            ...
            {   
                if($this->session->userdata('role_id')=='6'){ 
                    ...
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and `teacher_id` = ".$T_ID." and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                 } else{
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                }
                //$where= "WHERE `region_id` = ".$id." and `kv_id` = ".$kv_id." and `is_deleted` = '0' ORDER BY `id` ASC";
            }else{
                $where= "WHERE $tableClass2nd.`region_id` = ".$id."  and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
            }
            //$where= "WHERE `region_id` = ".$id." and `is_deleted` = '0' ORDER BY `id` ASC";
        }else
        {
            $where= "WHERE $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
        }  
       // die($where);
        $sqlQuery="SELECT 
        ...
        COUNT($tableClass2nd.id) AS Total FROM $table INNER JOIN $tableClass2nd
     ...
     public function get_Class2ndYearEndReading_data_by_id($id,$kv_id,$Class_ID) {
        ...
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            {
               ...
               // $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." and $tableClass2nd.`is_deleted` = '0' ORDER BY `id` ASC";
            }else{
            $where= "WHERE `region_id` = ".$id."  and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
            }
            //$where= "WHERE `region_id` = ".$id." and `is_deleted` = '0' ORDER BY `id` ASC";
        }else
        {
      ...
      public function get_Class2ndYearEndPreSchooling_data_by_id($id,$kv_id,$Class_ID) {
        ...
        if($id!='001'){
            ...
            {                
                if($this->session->userdata('role_id')=='6'){ 
                    $T_ID= $this->session->userdata('master_code'); 
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and `teacher_id` = ".$T_ID." AND `years_of_pre-schooling`!='NIL' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                 } else{
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." AND `years_of_pre-schooling`!='NIL' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                } 
            }else{
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
            $where= "WHERE $table.`region_id` = ".$id." AND `years_of_pre-schooling`!='NIL' AND $tableClass2nd.`is_deleted` = '0' ";
            }
            
        }else
        {
            $where= "WHERE `years_of_pre-schooling`!='NIL' AND $tableClass2nd.`is_deleted` = '0' ORDER BY $table.`id` ASC";
        }
        $sqlQuery="SELECT 
	...
	public function get_Class2ndYearEndNoPreSchooling_data_by_id($id,$kv_id,$Class_ID) {
        $table='ci_students_class_2nd_rubrics';
        $tableClass2nd='ci_students_backup_20june2022';
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            ...
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
            $where= "WHERE $tableClass2nd.`region_id` = ".$id." AND `years_of_pre-schooling`='NIL' AND $tableClass2nd.`is_deleted` = '0' ";
            }
            
        }else
        {
            $where= "WHERE `years_of_pre-schooling`='NIL' AND $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
        }
        $sqlQuery="SELECT 
        SUM(CASE WHEN $table.oral_i='1' THEN 1 ELSE 0 END) 'oral_i_L1',
        SUM(CASE WHEN $table.oral_i='2' THEN 1 ELSE 0 END) 'oral_i_L2',
  ...
  public function get_Class2ndYearEndParentEdu_data_by_id($id,$kv_id,$Class_ID) {
        $table='ci_students_class_2nd_rubrics';
        $tableClass2nd='ci_students_backup_20june2022';
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            {
                if($this->session->userdata('role_id')=='6'){ 
                    $T_ID= $this->session->userdata('master_code'); 
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and `teacher_id` = ".$T_ID." AND (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                 } else{
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." AND (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                }
                 
            }else{
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
            $where= "WHERE $tableClass2nd.`region_id` = ".$id." AND (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') AND $tableClass2nd.`is_deleted` = '0' ";
            }
            
        }else
        {
            $where= "WHERE (`father_qualification` !='Not educated' AND `mother_qualification` !='Not educated') AND $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
        }
        $sqlQuery="SELECT 
        SUM(CASE WHEN $table.oral_i='1' THEN 1 ELSE 0 END) 'oral_i_L1',
        SUM(CASE WHEN $table.oral_i='2' THEN 1 ELSE 0 END) 'oral_i_L2',
      ...
      public function get_Class2ndYearEndFirstGen_data_by_id($id,$kv_id,$Class_ID) {
        $table='ci_students_class_2nd_rubrics';
        $tableClass2nd='ci_students_backup_20june2022';
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            {
                if($this->session->userdata('role_id')=='6'){ 
                    $T_ID= $this->session->userdata('master_code'); 
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and `teacher_id` = ".$T_ID." AND `is_sibling_studying_same`='No' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                 } else{
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." AND `is_sibling_studying_same`='No' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                } 
            }else{
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
            $where= "WHERE $tableClass2nd.`region_id` = ".$id." AND `is_sibling_studying_same`='No' AND $tableClass2nd.`is_deleted` = '0' ";
            }
            
        }else
        {
            $where= "WHERE `is_sibling_studying_same`='No' AND $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
        }
        $sqlQuery="SELECT 
        SUM(CASE WHEN $table.oral_i='1' THEN 1 ELSE 0 END) 'oral_i_L1',
        SUM(CASE WHEN $table.oral_i='2' THEN 1 ELSE 0 END) 'oral_i_L2',
    ...
    public function get_Class2ndYearEndDifferently_data_by_id($id,$kv_id,$Class_ID) {
        $table='ci_students_class_2nd_rubrics';
        $tableClass2nd='ci_students_backup_20june2022';
        if($id!='001'){
            if($kv_id!=null || $kv_id!='')
            {
                if($this->session->userdata('role_id')=='6'){ 
                    $T_ID= $this->session->userdata('master_code'); 
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and `teacher_id` = ".$T_ID." AND `is_differently_abled`='Yes' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                 } else{
                    $where= "WHERE $tableClass2nd.`region_id` = ".$id." and $tableClass2nd.`kv_id` = ".$kv_id." AND `is_differently_abled`='Yes' and $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
                } 
            }else{
            //$where= "WHERE `region_id` = ".$id."  and `is_deleted` = '0' ORDER BY `id` ASC";
            $where= "WHERE $tableClass2nd.`region_id` = ".$id." AND `is_differently_abled`='Yes' AND $tableClass2nd.`is_deleted` = '0' ";
            }
            
        }else
        {
            $where= "WHERE `is_differently_abled`='Yes' AND $tableClass2nd.`is_deleted` = '0' ORDER BY $tableClass2nd.`id` ASC";
        }
        $sqlQuery="SELECT 
        SUM(CASE WHEN $table.oral_i='1' THEN 1 ELSE 0 END) 'oral_i_L1',
        SUM(CASE WHEN $table.oral_i='2' THEN 1 ELSE 0 END) 'oral_i_L2',
