                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row" id="SearchEmp">
                        <div style="width: 98%; margin: 0px auto; border: 1px solid #cecece; padding: 10px; border-radius: 5px;">
                            <div style="width:100%; color:#014A69!important; text-align: center;"><h5>CLASSROOM OBSERVATION TOOL</h5></div>
                            <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center"><h5>CLASSROOM OBSERVATION TOOL</h5><hr></div>
                    </div>
                    <?php echo form_open("", array("id" => "formID", "class" => "register", "autocomplete" => "off")); ?>
                    <div class=" background_div">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <div class="col-sm-12" style="margin-top: 12px;"><h5>1. Basic Details of The Teacher ::</h5><hr></div>
                        </div>
