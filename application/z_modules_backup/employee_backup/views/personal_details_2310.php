    ...
    <div class="card mb-3">
        ...
        <div class="row">
            ...
            <?php echo ($PerData->emp_category==1 || empty($PerData->emp_category))?'<div class="form-group col-md-4" id="cat_certificate_div" style="display:none;">':'<div class="form-group col-md-4" id="cat_certificate_div">';?>
                ...
                <div class="col-sm-12">
                    <?php echo form_input("emp_cat_details_certificate", isset($PerData->emp_cat_certificate_no) ? set_value('emp_cat_details_certificate', $PerData->emp_cat_certificate_no) : set_value('emp_cat_details_certificate'), 'maxlength="16" placeholder="Certificate No."   id="emp_cat_details_certificate" class="validate[required] form-control" autocomplete="off"'); ?>
        ...
        <div style="display:block;">
            <div class="row"> 
                ...
                <div class="form-group col-md-4" id="section_div_present" style="display:none;">
                    ...
                    <div class="col-sm-12">
                        <?php echo form_dropdown("present_section_id", array("" => "Select") + section_lists(), isset($PrePost->present_section_id) ? set_value('present_section_id', $PrePost->present_section_id) : set_value('present_section_id', $CurData->role_category), ' readonly class="form-control validate[required]"  id="c_section_present" data-id="c"  autocomplete="off"'); ?>
