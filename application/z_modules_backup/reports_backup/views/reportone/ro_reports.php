	...
	<div class="row col-md-12">
			...
			echo form_dropdown("initial_role_id",role_lists($this->session->userdata['role_id']),isset($name[3])?$name:'', 'id="role_id_initial"  class="form-control validate[required]"  '); ?>
                ...
                <div class="form-group col-md-3">
                    ...
                    <?php echo form_dropdown("initial_school_id", array("" => "Select") + school_lists($this->session->userdata['region_id']), '', 'class="form-control validate[required]"  id="c_school_initial" data-id="c" onchange="initialschcode()" '); ?>
                </div>
