            ...
            <div class="card mb-3">
                ...
                <div class="card-body shape-shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-sm-12"><hr><h6>(ii) Application of TLM & use of audio-visual aid including ICT:</h6><hr></div>
                            <div class="col-sm-12">
                            <div class="form-check">
                            <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            echo'<input type="radio" name="overall_briefing" class="form-check-input overall_briefing" value="'.$k.'" '.$chk.'>'.$v.'<br>';
                            }
                            ?>
                            </div>
                        </div>
