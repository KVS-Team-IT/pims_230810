            ...
            if ($response == 1) {
                ...
                $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, $EmpFor);
                    ...
                    foreach(new_assignment_mode() as $k=>$v){
                        ...
                        $html.='<input style="min-height:1px; font-size:12px;" type="checkbox" name="box" value="1" checked="'.$chk.'" /><span style="font-weight: normal!important;">'.$v.'</span><br>';
                            if ($k==1){
                                $html.='&emsp;&emsp;<div style="margin-bottom:10px; text-align:justify; padding-left:10px; font-size:10px; font-weight:normal!important; borded:1px solid #ccc; padding:2px;"><span style="color:#f36d1b; font-size:10px!important;">Details : </span>'.$ObsData['online_platform_txt'].'</div>';
                            }
                            if ($k==2){
                                $html.='&emsp;&emsp;<div style="margin-bottom:10px; text-align:justify; padding-left:10px; font-size:10px; font-weight:normal!important; borded:1px solid #ccc; padding:2px;"><span style="color:#f36d1b; font-size:10px!important;">Details : </span>'.$ObsData['video_link_txt'].'</div>';
                            }
                            if ($k==3){
