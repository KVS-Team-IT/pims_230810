    ...
    <h6><strong  class="font_size_dynamic">Proposal - </strong></h6>
        <div class="background_div">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <?php echo form_input("classroom", isset($section[0]->classroom) ? set_value('classroom', $section[0]->classroom) : set_value('classroom'), 'class="numericOnly validate[required] form-control" readonly autocomplete="off"'); ?>
                    <span class="error"><?php echo form_error('employment_type'); ?></span>
                </div>
                </div>
        ...
        <div class="col-sm-12">
            ...
            <div  style="float:right;"> 
                <?php echo form_submit('', 'Submit', 'class="btn btn-block btn-primary"'); ?>
            </div>
            <?php }else { ?> 
            <div class="btn btn-block btn-warning">
                You Cannot Modify the Proposal, As Proposal Has Been Escalated By Head Quarter( ACADEMIC ) to Next Level
            </div> 
            <?php } ?> 
        </div>
...
<script id="history_more_template" type="x-tmpl-mustache">
    ...
    <div class="delete_more_button" style="display:none;" id="history_more_1_{{random_exr_id}}">
        ...
        <div class="row">
            <input type="hidden" name=ids[] id="ids_{{random_exr_id}}">
            <div class="form-group col-md-4">
                <label for="" class="col-sm-12 col-form-label">Class <span class="reqd">*</span></label>
                <div class="col-sm-12">
                    <?php echo form_dropdown("class[]", array("" => "Select Class") + section_class(), isset($school->class) ? set_value('class', $school->class) : set_value('class'), 'disabled id="class_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
                    <span class="error"><?php echo form_error('class'); ?></span>
                </div>
            </div>
            <div class="form-group col-md-4">
                <label for="" class="col-sm-12 col-form-label">Enrollment As On <span class="reqd">*</span></label>
                <div class="col-sm-12">
                    <?php echo form_input("present_enroll[]", isset($school->present_enroll) ? set_value('present_enroll', $school->present_enroll) : set_value('present_enroll'), 'readonly id="present_enroll_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
            ...
            <div class="form-group col-md-4">
                <label for="" class="col-sm-12 col-form-label">Expected Enrollment During <span class="reqd">*</span></label>
                <div class="col-sm-12">
                <?php echo form_input("expected_enroll[]", isset($school->expected_enroll) ? set_value('expected_enroll', $school->expected_enroll) : set_value('expected_enroll'), 'readonly id="expected_enroll_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
                <span class="error"><?php echo form_error('expected_enroll'); ?></span>
                </div> 
            </div>
            <div class="form-group col-md-4" >
                <label for="" class="col-sm-12 col-form-label">Section Sanctioned During Previous Year <span class="reqd">*</span></label>
                <div class="col-sm-12">
            ...
            <div class="form-group col-md-4">
                <label for="" class="col-sm-12 col-form-label">Number Of Section Proposed By Principal <span class="reqd">*</span></label>
                <div class="col-sm-12">
                <?php echo form_input("proposed_section[]", isset($school->proposed_section) ? set_value('code', $school->proposed_section) : set_value('proposed_section'), 'readonly id="proposed_section_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off" onkeyup="validatesection({{random_exr_id}});"'); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("chairman_approval[]", array("" => "Select") + single_parent(), isset($school->chairman_approval) ? set_value('chairman_approval', $school->chairman_approval) : set_value('chairman_approval'), 'id="chairman_approval_{{random_exr_id}}" disabled class="validate[required] form-control" autocomplete="off"');    ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                <?php echo form_input("dc_section[]", '{{history_detail.dc_section}}', 'id="dc_section_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("dc_status[]", array("" => "Select") + section_status(), isset($school->dc_status) ? set_value('dc_status', $school->dc_status) : set_value('dc_status'), 'id="dc_status_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                <?php echo form_input("dc_remark[]", '{{history_detail.dc_remark}}', ' class="validate[required] form-control" autocomplete="off"'); ?>
            ...
            <?php if(!empty($section[0]->hq_section)) { ?>
                <div class="form-group col-md-4">
                    ...
                    <div class="col-sm-12">
                    <?php echo form_input("hq_section[]", '{{history_detail.hq_section}}', 'id="hq_section_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
                ...
                <div class="form-group col-md-4">
                    <label for="" class="col-sm-12 col-form-label">Select <span class="reqd">*</span></label>
                    <div class="col-sm-12">
                        <?php echo form_dropdown("hq_status[]", array("" => "Select") + section_status(), isset($school->hq_status) ? set_value('hq_status', $school->hq_status) : set_value('hq_status'), 'id="hq_status_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
                ...
                <div class="form-group col-md-4">
                    <label for="" class="col-sm-12 col-form-label">Remark <span class="reqd">*</span></label>
                    <div class="col-sm-12">
                    <?php echo form_input("hq_remark[]", '{{history_detail.hq_remark}}', ' class="validate[required] form-control" autocomplete="off"'); ?>
...
<script>
    ...
    if (section_details!='') {
        $.each(section_details, function (key, section_detail) {
            ...
            $("#ids_" + section_detail.id).val(section_detail.id);
