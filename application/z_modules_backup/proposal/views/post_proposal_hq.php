    ...
    <div class="delete_more_button" style="display:none;" id="history_more_1_{{random_exr_id}}">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("designation[]", array("" => "Select Designation") + designation_lists(), '', 'id="designation_{{random_exr_id}}" class="validate[required] form-control" onchange="getpost({{random_exr_id}},1);" autocomplete="off"');    ?>
            ...
            <div class="form-group col-md-4" >
                ...
                <div class="col-sm-12">
                    <?php echo form_input("previous_post[]", '', 'readonly id="previous_post_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?> 
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                <?php echo form_input("proposed_post[]", '', 'readonly id="proposed_post_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off" '); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("chairman_approval[]", array("" => "Select") + single_parent(), '', 'readonly id="chairman_approval_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
                    <span class="error"><?php echo form_error('chairman_approval'); ?></span>
                </div>
            </div>
                <div class="form-group col-md-4">
                    <label for="" class="col-sm-12 col-form-label">No Of Posts Recommended By DC <span class="reqd">*</span></label>
                    <div class="col-sm-12">
                    <?php echo form_input("dc_post[]", '{{history_detail.dc_post}}', 'readonly id="dc_post_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
                ...
                <div class="col-sm-12">
                    <?php echo form_dropdown("dc_status[]", array("" => "Select") + section_status(), isset($school->dc_status) ? set_value('dc_status', $school->dc_status) : set_value('dc_status'), 'readonly id="dc_status_{{random_exr_id}}" class="validate[required] form-control" autocomplete="off"');    ?>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    <label for="" class="col-sm-12 col-form-label">No Of Posts Recommended By HQ <span class="reqd">*</span></label>
                    <div class="col-sm-12">
                    <?php echo form_input("hq_post[]", '{{history_detail.hq_post}}', 'id="hq_post_{{random_exr_id}}" class="numericOnly validate[required] form-control" autocomplete="off"'); ?>
...
<script>
    ...
    if (post_details!='') {
        $.each(post_details, function (key, post_detail) {
            ...
            $("#ids_" + post_detail.id).val(post_detail.id);
