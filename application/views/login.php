...
<head>
    ...
    <meta name="google-site-verification" content="RUSkmLNRAr2UYSREnsfy7umI_vWHoZRSXF7v8VWZbo0" />
    ...
    <div class="container">
        ...
        <div class="card card-login mx-auto mt-5">
            <div class="card-header text-center" style="margin: 15px 15px !important;padding-bottom: 0px !important;">
                ...
                <label style=" margin-top: -2px!important; font-size: 16px; font-weight: bold; margin-top: 10px; font-family: auto; letter-spacing: 1px;">Personnel
            ...
            <div class="card-body" style="padding-top: 0px!important;">
                ...
                <div class="form-group">
                    <label><i class="fas fa-user" aria-hidden="true"></i>&nbsp;Username<span class="reqd">*</span></label>
                    <input type="text" name="username" id="username" class="form-control" autocomplete="off" value="" placeholder="Username">
                    <span class="error"><?php echo form_error('username'); ?></span>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-key" aria-hidden="true"></i>&nbsp;Password<span class="reqd">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <label style="color: #0c304a;font-size: 12px;margin-bottom: 10px;">Can't read the code?
                                &nbsp; &nbsp;<a href="javascript:void(0)" id="refresh_captcha"><img src="<?php echo base_url(); ?>img/refresh.png" title="Refresh Captcha"></a></label>
                ...
                <?php echo form_close(); ?>
                <br>
                <label class="btn btn-default btn-block">Forgot Password ? &nbsp;&nbsp;<a class="" href="<?php echo site_url('Reset-Password'); ?>">Click to Reset Password.</a></label>
            </div>
        </div>
    </div>
